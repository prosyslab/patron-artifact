...
def run_sparrow(files):
    ...
    cmd_prep = [
        'sparrow', '-unwrap_alloc', '-remove_cast', '-patron', '-extract_datalog_fact_full', '-dz',
        '-no_bo', '-io', '-taint'
    ]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--find-unanalyzed',
                        '-f',
                        type=str,
                        default='',
                        help='Find all the unanalyzed c files under the given directory')
    parser.add_argument('--analyzed-left-out',
                        '-a',
                        type=str,
                        default='',
                        help='Analyzed all the unanalyzed c files under the given directory')
