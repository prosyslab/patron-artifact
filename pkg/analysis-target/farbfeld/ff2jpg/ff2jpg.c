...
typedef struct __anonstruct_34 JQUANT_TBL;
...
typedef struct __anonstruct_35 JHUFF_TBL;
...
typedef struct __anonstruct_36 jpeg_component_info;
...
typedef struct __anonstruct_37 jpeg_scan_info;
#line 201
...
typedef enum __anonenum__38 J_COLOR_SPACE;
#line 246
enum __anonenum__39 {
    JDCT_ISLOW = 0,
    JDCT_IFAST = 1,
...
typedef enum __anonenum__39 J_DCT_METHOD;
#line 261
enum __anonenum__40 {
    JDITHER_NONE = 0,
    JDITHER_ORDERED = 1,
...
typedef enum __anonenum__40 J_DITHER_MODE;
#line 283
...
#line 17 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/ff2jpg.c"
...
#line 25 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/ff2jpg.c"
static void jpeg_setup_writer(struct jpeg_compress_struct *s , struct jpeg_error_mgr *e ,
...
{ 
  ...
  {
#line 28
  jpeg_CreateCompress(s, 80, (size_t )sizeof(struct jpeg_compress_struct ));
#line 29
...
#line 34
  s->image_height = h;
#line 35
  s->input_components = 3;
#line 36
  s->in_color_space = (J_COLOR_SPACE )2;
#line 37
  jpeg_set_defaults(s);
  }
#line 39
...
#line 48 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/ff2jpg.c"
...
#line 54 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/ff2jpg.c"
...
#line 68
      ...
      {
#line 68
      __cil_tmp27 = parse_mask((char const   *)tmp___1, (uint16_t *)mask);
      }
#line 68
      if (__cil_tmp27) {
        {
...
#line 76
      ...
      {
#line 76
      __cil_tmp30 = estrtonum((char const   *)tmp___3, (long long )0, (long long )100);
#line 76
      quality = (int )__cil_tmp30;
      }
#line 77
      goto switch_break;
...
#line 96
      ...
      {
#line 97
      __cil_tmp38 = __bswap_16(*(row + (j + 3U)));
#line 97
      a = (uint64_t )__cil_tmp38;
#line 98
      l = (uint32_t )0;
      }
      {
...
#line 98
        ...
        {
#line 100
        __cil_tmp39 = __bswap_16(*(row + (j + l)));
#line 100
        *(rowout + (k + l)) = (uint8_t )((a * (unsigned long )__cil_tmp39 + (65535UL - a) * (unsigned long )mask[l]) / 16842495UL);
        }
#line 98
        l ++;
      }
...
#line 96
    ...
    {
#line 106
    jpeg_write_scanlines(& jcomp, & rowout, (JDIMENSION )1);
    }
#line 94
    i ++;
  }
...
#line 113
  __cil_tmp41 = fshut(stdout, "<stdout>`\221\177\210\347U");
  }
#line 113
  return (__cil_tmp41);
}
