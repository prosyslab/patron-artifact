...
#line 177
  if (errstr) {
    {
#line 178
    die("strtonum \'%s\': %s\020O\0215V", numstr, errstr);
    }
  }
#line 181
  return (ll);
...
#line 15 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/png2ff.c"
...
#line 22 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/png2ff.c"
static void png_setup_reader(png_struct **s , png_info **i , uint32_t *w , uint32_t *h ) 
{ 
  png_structp __cil_tmp5 ;
  png_infop __cil_tmp6 ;
  png_uint_32 __cil_tmp7 ;
  ...
  {
#line 24
  *s = png_create_read_struct("1.6.37", (void *)0, & png_err, (png_error_ptr )((void *)0));
#line 25
...
#line 31
  png_init_io(*s, stdin);
#line 32
  __cil_tmp7 = png_get_valid(*s, *i, 16U);
  }
#line 32
  if (__cil_tmp7) {
    {
#line 33
  ...
  {
#line 35
  png_set_add_alpha(*s, (png_uint_32 )65535, 1);
#line 36
...
#line 45 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/png2ff.c"
...
#line 51 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/png2ff.c"
...
{ 
  ...
  char *__cil_tmp13[] ;
  void *__cil_tmp14 ;
  png_bytepp __cil_tmp15 ;
  png_byte __cil_tmp16 ;
...
#line 69
  rowlen = (uint32_t )((unsigned long )width * (sizeof("RGBA") - 1UL));
#line 70
  pngrows = png_get_rows(pngs, pngi);
#line 73
  ff_write_header(width, height);
#line 75
  __cil_tmp16 = png_get_bit_depth(pngs, pngi);
  }
  {
#line 76
...
#line 78
      ...
      {
#line 79
      *(row + i) = __bswap_16((__uint16_t )(257 * (int )*(*(pngrows + r) + i)));
      }
#line 78
      i ++;
    }
    ...
    {
#line 81
    efwrite(row, sizeof(uint16_t ), (size_t )rowlen, stdout);
    }
#line 77
    r ++;
  }
...
#line 85
    ...
    {
#line 86
    efwrite(*(pngrows + r), sizeof(uint16_t ), (size_t )rowlen, stdout);
    }
#line 85
    r ++;
  }
...
#line 90
  ...
  {
#line 94
  png_destroy_read_struct(& pngs, & pngi, (png_infopp )((void *)0));
#line 96
  __cil_tmp19 = fshut(stdout, "<stdout>p\001h\0215V");
  }
#line 96
  return (__cil_tmp19);
}
