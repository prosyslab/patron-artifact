...
#line 177
  if (errstr) {
    {
#line 178
    die("strtonum \'%s\': %s\300\375\345bU", numstr, errstr);
    }
  }
#line 181
  return (ll);
...
#line 15 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/ff2pam.c"
...
#line 21 "/root/patron-artifact/pkg/farbfeld_tmp/farbfeld-4/ff2pam.c"
...
#line 49
  ...
  {
#line 54
  __cil_tmp12 = fshut(stdout, "<stdout>");
  }
#line 54
  return (__cil_tmp12);
}
