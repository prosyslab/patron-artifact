...
#line 78 "/usr/include/espeak/speak_lib.h"
...
#line 88 "/usr/include/espeak/speak_lib.h"
typedef enum __anonenum__1034 espeak_EVENT_TYPE;
#line 100 "/usr/include/espeak/speak_lib.h"
union __anonunion_1036 {
   int number ;
   char const   *name ;
   char string[8] ;
};
#line 92 "/usr/include/espeak/speak_lib.h"
...
#line 105 "/usr/include/espeak/speak_lib.h"
...
#line 155 "/usr/include/espeak/speak_lib.h"
...
#line 171 "/usr/include/espeak/speak_lib.h"
...
#line 179 "/usr/include/espeak/speak_lib.h"
typedef enum __anonenum__1039 espeak_ERROR;
#line 205 "/usr/include/espeak/speak_lib.h"
...
#line 411 "/usr/include/espeak/speak_lib.h"
...
#line 417 "/usr/include/espeak/speak_lib.h"
typedef enum __anonenum__1041 espeak_PUNCT_TYPE;
#line 549 "/usr/include/espeak/speak_lib.h"
...
#line 559 "/usr/include/espeak/speak_lib.h"
...
typedef enum __anonenum__1061 TEspeakSuccess;
...
#line 342
  if (ret < 0) {
    {
#line 343
    MSG(4, "ERROR: Can\'t play track for unknown reason.X\343U");
    }
#line 344
    return (0);
  }
...
#line 380
  MSG(4, "Frames = %jd, channels = %ld\343U", sfinfo.frames, (long )sfinfo.channels);
#line 382
  MSG(4, "Samplerate = %i, items = %lld", sfinfo.samplerate, (long long )items);
#line 384
  MSG(4, "Major format = 0x%08X, subformat = 0x%08X, endian = 0x%08XdX\343U", sfinfo.format & 268369920,
...
{ 
  ...
  {
#line 32
  __cil_tmp1 = setlocale(6, "\340\220\335X\343U");
  }
#line 32
...
{ 
  ...
  {
#line 120
  __cil_tmp3 = strcmp(str, "none\343U");
  }
#line 120
  if (! __cil_tmp3) {
#line 121
...
#line 123
      ...
      {
#line 124
      __cil_tmp5 = strcmp(str, "some\343U");
      }
#line 124
      if (! __cil_tmp5) {
#line 125
...
#line 145
  ...
  {
#line 140
  str = g_strdup((gchar *)"on\025Y\343U");
  }
#line 141
  goto switch_break;
  case_0: /* CIL Label */ 
...
#line 36 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/.libs/sd_espeakS.c"
...
#line 174
          ...
          {
#line 180
          __cil_tmp15 = strcmp(cur_item, "audio_pulse_devicelY\343U");
          }
#line 180
          if (! __cil_tmp15) {
            {
...
{ 
  ...
  {
#line 202
  __cil_tmp3 = strcmp(cur_item, "log_levelhlY\343U");
  }
#line 202
  if (! __cil_tmp3) {
    {
...
#line 210
  if (enable) {
    {
#line 211
    MSG(4, "Additional logging into specific path %s requestedlY\343U", filename);
#line 213
    __cil_tmp4 = fopen(filename, "w+lY\343U");
#line 213
...
#line 518
  MSG(4, "written %ld bytesuDY\343U", (long )ret);
  }
#line 519
  return ((int )ret);
}
...
#line 527
      while (1) {
        ...
        {
#line 527
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 X\001",
                "./src/modules/module_utils.c\343U", 527);
        }
#line 527
        if (Debug > 1) {
          {
...
#line 538
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 X\001",
                "./src/modules/module_utils.c\343U", 538);
        }
#line 538
        if (Debug > 1) {
          {
...
{ 
  ...
  {
#line 549
  MSG(4, "Blocking all signals\343U");
#line 551
...
#line 466
  ...
  {
#line 469
  __cil_tmp10 = strcmp((char const   *)on, "ON\305Y\343U");
  }
#line 469
  if (! __cil_tmp10) {
    {
...
#line 188 "/usr/include/espeak/speak_lib.h"
...
#line 162
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "EspeakAudioChunkSize\343U", 1, & EspeakAudioChunkSize_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 162
    goto while_break___2;
...
#line 164
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "EspeakSoundIconFolderU", 2, & EspeakSoundIconFolder_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 164
...
#line 166
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "EspeakSoundIconVolumeU", 1, & EspeakSoundIconVolume_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 166
...
#line 168
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "EspeakMinRateU", 1, & EspeakMinRate_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 168
...
#line 170
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "EspeakMaxRateU", 1, & EspeakMaxRate_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 170
...
#line 171
    if ("@/+-_U" != (void *)0) {
      {
#line 171
      EspeakPunctuationList = g_strdup((gchar *)"@/+-_U");
      }
    } else {
#line 171
...
#line 171
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "EspeakPunctuationListU", 2, & EspeakPunctuationList_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 171
...
{ 
  ...
  {
#line 186
  MSG(4, "Espeak: Module init().1Z\343U");
#line 188
...
#line 194
  MSG(4, "Espeak: espeak Output Module version %s, espeak Engine version %sU", "0.1Z\343U",
      espeak_version);
#line 199
  MSG(4, "Espeak: Initializing engine with buffer size %d ms.", EspeakAudioChunkSize);
#line 206
...
#line 210
  if (espeak_sample_rate == -1) {
    {
#line 211
    MSG(4, "Espeak: Could not initialize engine.\220");
#line 212
    *status_info = g_strdup((gchar *)"Could not initialize engine. U");
    }
#line 213
    return (-1);
  }
  {
#line 216
  MSG(4, "Espeak: Registering callbacks.\005");
#line 217
  espeak_SetSynthCallback(& synth_callback);
#line 218
  espeak_SetUriCallback(& uri_callback);
#line 220
  MSG(4, "Setting up espeak specific configuration settings.4Z\343U");
#line 221
...
#line 222
  if (ret != 0) {
    {
#line 223
    MSG(4, "Espeak: Failed to set punctuation list.Z\343U");
    }
  }
  {
#line 225
...
#line 227
  initialized = ! 0;
#line 228
  *status_info = g_strdup((gchar *)"Espeak: Initialized successfully.U");
  }
#line 230
  return (0);
}
...
#line 242
  msg = (gchar *)((void *)0);
#line 244
  MSG(4, "Espeak: module_speak().Z\343U");
#line 246
  MSG(4, "Espeak: Requested data: |%s| %d %lu", data___0, (unsigned int )msgtype,
      (unsigned long )bytes);
  }
  {
#line 250
...
#line 256
      if ((unsigned int )msgtype == 0U) {
        {
#line 260
        MSG(4, "Espeak: mbrola voice, stripping SSML.--Z\343U");
#line 261
...
#line 290
  ...
  {
#line 292
  __cil_tmp15 = g_strdup_printf((gchar *)"<audio src=\"%s%s\">%s</audio>\343U", EspeakSoundIconFolder,
                                data___0, data___0);
#line 292
  msg___8 = __cil_tmp15;
#line 295
...
#line 305
      ...
      {
#line 310
      __cil_tmp22 = g_convert(data___0, (gssize )(- 1), (gchar *)"wchar_t", (gchar *)"utf-8U",
...
#line 315
          ...
          {
#line 317
          MSG(4, "Espeak: Failed to convert utf-8 to wchar_t, or not exactly one utf-8 character given.\v-Z\343U");
          }
          }
        }
      } else {
...
#line 348
  if ((int )result != 0) {
    {
#line 349
    MSG(4, "Espeak: Synth error %d", (int )result);
    }
  }
#line 352
  if (pause_requested) {
...
#line 357
    ...
    {
#line 359
    MSG(4, "Espeak: Leaving module_speak() normally.");
#line 360
    module_report_event_end();
    }
  }
...
#line 389
  ...
  {
#line 391
  MSG(4, "Espeak: terminating synthesis.");
#line 392
  espeak_Terminate();
#line 394
...
#line 416
  if ((int )ret != 0) {
    {
#line 417
    MSG(4, "Espeak: Error setting rate %i.", speed);
    }
  } else {
    {
#line 419
    MSG(4, "Espeak: Rate set to %i.", speed);
    }
  }
  return;
}
...
#line 429
  if ((int )ret != 0) {
    {
#line 430
    MSG(4, "Espeak: Error setting volume %i.", vol);
    }
  } else {
    {
#line 432
    MSG(4, "Espeak: Volume set to %i.", vol);
    }
  }
  return;
}
...
#line 452
  if ((int )ret != 0) {
    {
#line 453
    MSG(4, "Espeak: Error setting pitch %i.", pitchBaseline);
    }
  } else {
    {
#line 455
    MSG(4, "Espeak: Pitch set to %i.", pitchBaseline);
    }
  }
  return;
}
...
#line 477
  if ((int )ret != 0) {
    {
#line 478
    MSG(4, "Espeak: Error setting pitch range %i.", pitchRangeBaseline);
    }
  } else {
    {
#line 481
    MSG(4, "Espeak: Pitch range set to %i.", pitchRangeBaseline);
    }
  }
  return;
}
...
#line 506
  if ((int )ret != 0) {
    {
#line 507
    MSG(4, "Espeak: Failed to set punctuation mode.");
    }
  } else {
    {
#line 509
...
#line 530
  if ((int )ret != 0) {
    {
#line 531
    MSG(4, "Espeak: Failed to set capitals mode.\220");
    }
  } else {
    {
#line 533
...
{ 
  ...
  {
#line 540
  MSG(4, "Espeak: set_language_and_voice %s %d\230\001", lang, (int )voice_code);
#line 543
...
#line 574
  name = __cil_tmp6;
#line 575
  MSG(4, "Espeak: set_language_and_voice name=%s", name);
#line 576
...
#line 585
  if ((int )ret != 0) {
    {
#line 586
    MSG(4, "Espeak: Error selecting language %s", name);
    }
  } else {
    {
#line 588
    MSG(4, "Espeak: Successfully set voice to \"%s\"", name);
    }
  }
  {
#line 590
...
#line 606
  if (synthesis_voice != (void *)0) {
    {
#line 653
    __cil_tmp3 = espeak_SetVoiceByName((char const   *)synthesis_voice);
#line 653
    ret = __cil_tmp3;
    }
#line 654
    if ((int )ret != 0) {
      {
#line 655
      MSG(4, "Espeak: Failed to set synthesis voice to %s.\230\001", synthesis_voice);
      }
    } else {
      {
#line 658
      MSG(4, "Espeak: Successfully set synthesis voice to %s.", synthesis_voice);
      }
    }
  }
  return;
...
#line 690
  MSG(4, "Espeak: pushing %d samples", numsamples);
#line 691
...
#line 745
    if (EspeakIndexing) {
      {
#line 746
      MSG(4, "Espeak: Reporting mark %sU", events->id.name);
#line 747
...
#line 844
  MSG(4, "Espeak: %d voices total.\343U", numvoices);
#line 846
...
#line 860
  MSG(4, "Espeak: %d variants total.", numvariants);
#line 932
...
#line 939
    __cil_tmp38 = g_queue_is_empty(variant_list);
    }
#line 939
    if (! __cil_tmp38) {
      {
...
#line 944
        voice = (SPDVoice *)0;
#line 946
        voice->name = g_strdup_printf((gchar *)"%s+%s", vo->name, (char *)variant_list_iter->data);
#line 948
...
#line 983
  MSG(4, "Espeak: %d usable voices.", totalvoices);
  }
#line 985
  return (result);
}
