...
typedef struct __anonstruct_916 __kernel_fd_set;
...
typedef struct __anonstruct_917 __kernel_fsid_t;
...
typedef union __anonunion_930 sem_t;
#line 35 "/usr/include/x86_64-linux-gnu/bits/siginfo-consts.h"
...
#line 342
  if (ret < 0) {
    {
#line 343
    MSG(4, "ERROR: Can\'t play track for unknown reason.8aU");
    }
#line 344
    return (0);
  }
...
#line 380
  MSG(4, "Frames = %jd, channels = %ldaU", sfinfo.frames, (long )sfinfo.channels);
#line 382
  MSG(4, "Samplerate = %i, items = %lld", sfinfo.samplerate, (long long )items);
#line 384
  MSG(4, "Major format = 0x%08X, subformat = 0x%08X, endian = 0x%08XQ8aU", sfinfo.format & 268369920,
...
{ 
  ...
  {
#line 32
  __cil_tmp1 = setlocale(6, "\340`\3128aU");
  }
#line 32
...
#line 36 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/.libs/sd_ciceroS.c"
...
#line 174
          ...
          {
#line 180
          __cil_tmp15 = strcmp(cur_item, "audio_pulse_deviceY9aU");
          }
#line 180
          if (! __cil_tmp15) {
            {
...
{ 
  ...
  {
#line 202
  __cil_tmp3 = strcmp(cur_item, "log_level8Y9aU");
  }
#line 202
  if (! __cil_tmp3) {
    {
...
#line 210
  if (enable) {
    {
#line 211
    MSG(4, "Additional logging into specific path %s requestedY9aU", filename);
#line 213
    __cil_tmp4 = fopen(filename, "w+Y9aU");
#line 213
...
#line 518
  MSG(4, "written %ld bytesE19aU", (long )ret);
  }
#line 519
  return ((int )ret);
}
...
#line 527
      while (1) {
        ...
        {
#line 527
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 8\001",
                "./src/modules/module_utils.caU", 527);
        }
#line 527
        if (Debug > 1) {
          {
...
#line 538
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 8\001",
                "./src/modules/module_utils.caU", 538);
        }
#line 538
        if (Debug > 1) {
          {
...
#line 466
  ...
  {
#line 469
  __cil_tmp10 = strcmp((char const   *)on, "ON\2629aU");
  }
#line 469
  if (! __cil_tmp10) {
    {
...
extern nl_catd catopen(char const   *__cat_name , int __flag ) ;
#line 46
extern  __attribute__((__nothrow__)) char *catgets(nl_catd __catalog , int __set ,
                                                   int __number , char const   *__string ) ;
#line 50
extern  __attribute__((__nothrow__)) int catclose(nl_catd __catalog ) ;
...
#line 41 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
...
#line 43 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static int initialized  =    0;
#line 46 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
...
#line 54 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static int cicero_position  =    0;
#line 55 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static int cicero_pause_requested  =    0;
#line 56 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int cicero_volume  =    0;
#line 57 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static unsigned int CiceroMaxChunkLength  =    (unsigned int )500;
#line 60
static void cicero_set_rate(int rate ) ;
#line 62
void *_cicero_speak(void *nothing ) ;
#line 64 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int cicero_stop  =    0;
#line 70 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static char *CiceroExecutable  =    (char *)((void *)0);
#line 70 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
char const   *CiceroExecutable_cb(command_t *cmd , context_t *ctx ) 
{ 
  gchar *__cil_tmp3 ;
...
#line 71 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static char *CiceroExecutableLog  =    (char *)((void *)0);
#line 71 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
char const   *CiceroExecutableLog_cb(command_t *cmd , context_t *ctx ) 
{ 
  gchar *__cil_tmp3 ;
...
#line 76
static int fd2[2] ;
#line 82 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static long millisecondsBetween(struct timeval *from , struct timeval *to ) 
{ 


  {
#line 84
  return ((to->tv_sec - from->tv_sec) * 1000L + (to->tv_usec - from->tv_usec) / 1000L);
}
}
#line 89 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
long millisecondsSince(struct timeval *from ) 
{ 
  struct timeval now ;
  long __cil_tmp3 ;
...
#line 93
  __cil_tmp3 = millisecondsBetween(from, & now);
  }
#line 93
  return (__cil_tmp3);
}
}
#line 96 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
...
{ 
  ...
  {
#line 98
  start.tv_sec = (__time_t )0;
#line 98
  start.tv_usec = (__suseconds_t )0;
#line 100
  if (milliseconds) {
    {
#line 101
    __cil_tmp3 = millisecondsSince(& start);
    }
#line 101
    return (__cil_tmp3 >= (long )milliseconds);
  }
  {
#line 103
...
#line 107 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static void mywrite(int fd , void const   *buf , int len ) 
{ 
  char *pos ;
  int w ;
  int __cil_tmp6 ;
...
#line 114
  while (1) {
    ...
    {
#line 115
    __cil_tmp7 = write(fd, pos, (size_t )len);
#line 115
    w = (int )__cil_tmp7;
    }
#line 115
...
#line 127
  if (len) {
    {
#line 128
    fprintf(stderr, "Pipe write timed outaU");
    }
  }
  return;
}
}
#line 133 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int module_load(void) 
{ 
...
#line 137
  while (1) {
    while_continue___2: /* CIL Label */ ;
#line 137
    if ("/usr/bin/cicero" != (void *)0) {
      {
#line 137
      CiceroExecutable = g_strdup((gchar *)"/usr/bin/cicero");
      }
    } else {
#line 137
      CiceroExecutable = (char *)((void *)0);
    }
    {
#line 137
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "CiceroExecutable\251", 2, & CiceroExecutable_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 137
    goto while_break___2;
...
#line 138
    if ("/var/log/speech-dispatcher/cicero-executable.log\251" != (void *)0) {
      {
#line 138
      CiceroExecutableLog = g_strdup((gchar *)"/var/log/speech-dispatcher/cicero-executable.log\220");
      }
    } else {
#line 138
      CiceroExecutableLog = (char *)((void *)0);
    }
    {
#line 138
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "CiceroExecutableLog", 2, & CiceroExecutableLog_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 138
...
#line 143 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int module_init(char **status_info ) 
{ 
  int ret ;
  int stderr_redirect ;
...
#line 148
  MSG(4, "Module init\naU");
#line 150
  __cil_tmp4 = access((char const   *)CiceroExecutable, 1);
  }
#line 150
  if (__cil_tmp4 != 0) {
    {
#line 151
    *status_info = g_strdup_printf((gchar *)"can not reach executable %s", CiceroExecutable);
#line 152
    MSG(4, "ERROR: can not reach executable %s\b", CiceroExecutable);
    }
#line 153
    return (- 1);
  }
...
#line 158
  MSG(4, "call the pipe system call\n-:aU");
#line 159
  __cil_tmp7 = pipe((int *)fd2);
  }
  {
#line 159
  __cil_tmp6 = pipe((int *)fd1);
  }
#line 159
  if (__cil_tmp6 < 0) {
    {
    {
#line 160
    *status_info = g_strdup((gchar *)"Could not create pipeU");
    }
    {
#line 161
    MSG(4, "Error pipe()\nU");
...
#line 162
  ...
  {
#line 164
  MSG(4, "Call fork system call\n");
#line 166
  stderr_redirect = open((char const   *)CiceroExecutableLog, 577, 384);
  }
#line 168
...
#line 169
    MSG(4, "ERROR: Opening debug file for Cicero binary failed: (error=%d) %s", stderr_redirect,
        __cil_tmp11);
    }
  } else {
    {
#line 171
    MSG(4, "Cicero synthesizer logging to file %s", CiceroExecutableLog);
    }
  }
  {
#line 174
...
#line 201
  ...
  {
#line 176
  *status_info = g_strdup((gchar *)"Could not fork");
#line 177
  MSG(4, "Error fork()\n");
  }
#line 178
  ...
  {
#line 181
  __cil_tmp15 = dup2(fd1[1], 1);
  }
  {
#line 181
  __cil_tmp14 = dup2(fd2[0], 0);
  }
#line 181
  if (__cil_tmp14 < 0) {
    {
...
#line 186
  if (stderr_redirect >= 0) {
    {
#line 187
    __cil_tmp16 = dup2(stderr_redirect, 2);
    }
#line 187
    if (__cil_tmp16 < 0) {
      {
#line 188
      MSG(4, "ERROR: Couldn\'t redirect stderr, not logging for Cicero synthesizer.");
      }
    }
  }
#line 193
...
#line 196
  signal(13, (__sighandler_t )1);
#line 197
  execl((char const   *)CiceroExecutable, (char const   *)CiceroExecutable, (void *)((void *)0));
#line 198
  MSG(4, "Error execl()\n");
#line 199
  exit(1);
...
#line 205
  close(fd2[0]);
#line 206
  __cil_tmp20 = fcntl(fd1[0], 4, 2048);
  }
  {
#line 206
  __cil_tmp19 = fcntl(fd2[1], 4, 2048);
  }
#line 206
  if (__cil_tmp19 < 0) {
    {
...
#line 218
  MSG(4, "Cicero: creating new thread for cicero_tracking\n\220");
#line 219
  cicero_speaking = 0;
#line 220
  ret = spd_pthread_create(& cicero_speaking_thread, (pthread_attr_t *)((void *)0),
                           & _cicero_speak, (void *)0);
  }
#line 222
  if (ret != 0) {
    {
#line 223
    MSG(4, "Cicero: thread failed\n");
#line 224
    *status_info = g_strdup((gchar *)"The module couldn\'t initialize threads This can be either an internal problem or an architecture problem. If you are sure your architecture supports threads, please report a bug.");
    }
#line 229
    return (- 1);
  }
  {
#line 232
  *status_info = g_strdup((gchar *)"Cicero initialized successfully.\220");
#line 234
  initialized = 1;
  }
#line 236
...
#line 239 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
SPDVoice **module_list_voices(void) 
{ 
...
#line 244 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int module_speak(gchar *data___0 , size_t bytes , SPDMessageType msgtype ) 
{ 
  char *__cil_tmp4 ;
...
#line 258
  ...
  {
#line 260
  cicero_message = module_strip_ssml((char const   *)data___0);
#line 262
  cicero_message_type = (SPDMessageType )0;
  }
  {
#line 266
  while (1) {
...
#line 273
  MSG(4, "Cicero: leaving module_speak() normally\n\r\2158:aU");
  }
#line 274
  return ((int )bytes);
}
}
#line 277 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int module_stop(void) 
{ 
  unsigned char c ;
...
#line 287 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
size_t module_pause(void) 
{ 
...
#line 290
  if (cicero_speaking) {
    {
#line 291
    MSG(4, "Pause not supported by cicero\n");
#line 292
...
#line 300 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
int module_close(void) 
{ 
  int __cil_tmp1 ;
...
#line 308
  ...
  {
#line 310
  __cil_tmp1 = module_terminate_thread(cicero_speaking_thread);
  }
#line 310
  if (__cil_tmp1 != 0) {
#line 311
...
#line 321 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
void *_cicero_speak(void *nothing ) 
{ 
  char stop_code ;
  unsigned int pos ;
...
#line 331
  MSG(4, "cicero: speaking thread starting.......\n\220");
#line 333
...
#line 336
    MSG(4, "Semaphore on\n");
#line 337
    __cil_tmp13 = strlen((char const   *)cicero_message);
#line 337
    len = (unsigned int )__cil_tmp13;
#line 338
    cicero_stop = 0;
#line 339
    cicero_speaking = 1;
...
#line 345
      if (cicero_stop) {
        {
#line 346
        MSG(4, "Stop in thread, terminating");
#line 347
        cicero_speaking = 0;
#line 348
        module_report_event_stop();
...
#line 351
      if (pos >= len) {
        {
#line 352
        MSG(4, "End of text in speaking thread\n");
#line 353
        module_report_event_end();
#line 354
        cicero_speaking = 0;
...
#line 355
      ...
      {
#line 357
      MSG(4, "Call get_parts: pos=%d, msg=\"%s\" \n", pos, cicero_message);
#line 359
      bytes = module_get_message_part((char const   *)cicero_message, (char *)buf,
                                      & pos, (size_t )CiceroMaxChunkLength, ".;?!");
#line 363
      MSG(4, "Returned %d bytes from get_part\n\230\001", bytes);
      }
#line 364
      if (bytes < 0) {
        {
#line 365
        MSG(4, "ERROR: Can\'t get message part, terminating");
#line 366
        cicero_speaking = 0;
#line 367
        module_report_event_stop();
...
#line 381
        mywrite(fd2[1], (char *)l, 5);
#line 382
        mywrite(fd2[1], (char *)buf, bytes);
#line 383
        cicero_position = 0;
        }
        {
#line 384
        while (1) {
          ...
          {
#line 385
          ret = poll(& ufds, (nfds_t )1, 60);
          }
#line 386
          if (ret) {
            {
#line 387
            MSG(4, "poll() system call returned %d, events=%d\n", ret, (int )ufds.events);
            }
          }
#line 388
          if (ret < 0) {
...
#line 404
          ...
          {
#line 405
          inx = (unsigned int )(((int )b[0] << 8) | (int )b[1]);
#line 406
          MSG(4, "Tracking: index=%u, bytes=%d\n", inx, bytes);
          }
#line 408
...
#line 425
  cicero_speaking = 0;
#line 426
  MSG(4, "cicero: tracking thread ended.......\n");
#line 427
  pthread_exit((void *)0);
  }
}
}
#line 430 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/cicero.c"
static void cicero_set_rate(int rate ) 
{ 
  float const   spkRateTable[21] ;
  float expand ;
  int __cil_tmp4 ;
  unsigned char *p ;
  unsigned char l[5] ;
  ...
  {
#line 432
  spkRateTable[0] = (float )0.3333;
#line 432
  spkRateTable[1] = (float )0.372;
#line 432
  spkRateTable[2] = (float )0.415200000001;
#line 432
  spkRateTable[3] = (float )0.463500000001;
#line 432
  spkRateTable[4] = (float )0.5173;
#line 432
  spkRateTable[5] = (float )0.577400000001;
#line 432
  spkRateTable[6] = (float )0.6444;
#line 432
  spkRateTable[7] = (float )0.7192;
#line 432
  spkRateTable[8] = (float )0.8027;
#line 432
  spkRateTable[9] = (float )0.896000000001;
#line 432
  spkRateTable[10] = (float )1.;
#line 432
  spkRateTable[11] = (float )1.11610000001;
#line 432
  spkRateTable[12] = (float )1.24570000001;
#line 432
  spkRateTable[13] = (float )1.39040000001;
#line 432
  spkRateTable[14] = (float )1.55180000001;
#line 432
  spkRateTable[15] = (float )1.732;
#line 432
  spkRateTable[16] = (float )1.93320000001;
#line 432
  spkRateTable[17] = (float )2.15770000001;
#line 432
  spkRateTable[18] = (float )2.4082;
#line 432
  spkRateTable[19] = (float )2.6879;
#line 432
  spkRateTable[20] = (float )3.;
#line 456
  rate -= 100;
#line 457
  rate = abs(rate);
...
#line 466
  l[4] = *(p + 0);
#line 467
  mywrite(fd2[1], (unsigned char *)l, 5);
  }
  return;
}
}
