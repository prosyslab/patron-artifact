...
#line 342
  if (ret < 0) {
    {
#line 343
    MSG(4, "ERROR: Can\'t play track for unknown reason.v\002V");
    }
#line 344
    return (0);
  }
...
#line 380
  MSG(4, "Frames = %jd, channels = %ld\002V", sfinfo.frames, (long )sfinfo.channels);
#line 382
  MSG(4, "Samplerate = %i, items = %lld", sfinfo.samplerate, (long long )items);
#line 384
  MSG(4, "Major format = 0x%08X, subformat = 0x%08X, endian = 0x%08X\345v\002V", sfinfo.format & 268369920,
...
{ 
  ...
  {
#line 32
  __cil_tmp1 = setlocale(6, "@\a_w\002V");
  }
#line 32
...
{ 
  ...
  {
#line 120
  __cil_tmp3 = strcmp(str, "none\002V");
  }
#line 120
  if (! __cil_tmp3) {
#line 121
...
#line 123
      ...
      {
#line 124
      __cil_tmp5 = strcmp(str, "some\002V");
      }
#line 124
      if (! __cil_tmp5) {
#line 125
...
#line 145
  ...
  {
#line 140
  str = g_strdup((gchar *)"on\227w\002V");
  }
#line 141
  goto switch_break;
  case_0: /* CIL Label */ 
...
#line 36 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/.libs/sd_kaliS.c"
...
#line 60
void module_speak_sync(char const   *data , size_t bytes , SPDMessageType msgtype ) ;
#line 63
...
#line 174
          ...
          {
#line 180
          __cil_tmp15 = strcmp(cur_item, "audio_pulse_device\355w\002V");
          }
#line 180
          if (! __cil_tmp15) {
            {
...
{ 
  ...
  {
#line 202
  __cil_tmp3 = strcmp(cur_item, "log_level\315\355w\002V");
  }
#line 202
  if (! __cil_tmp3) {
    {
...
#line 210
  if (enable) {
    {
#line 211
    MSG(4, "Additional logging into specific path %s requested\356w\002V", filename);
#line 213
    __cil_tmp4 = fopen(filename, "w+\356w\002V");
#line 213
...
#line 518
  MSG(4, "written %ld bytes\326\305w\002V", (long )ret);
  }
#line 519
  return ((int )ret);
}
...
#line 527
      while (1) {
        ...
        {
#line 527
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 v\001",
                "./src/modules/module_utils.c\002V", 527);
        }
#line 527
        if (Debug > 1) {
          {
...
#line 538
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 v\001",
                "./src/modules/module_utils.c\002V", 538);
        }
#line 538
        if (Debug > 1) {
          {
...
{ 
  ...
  {
#line 549
  MSG(4, "Blocking all signals\002V");
#line 551
...
#line 466
  ...
  {
#line 469
  __cil_tmp10 = strcmp((char const   *)on, "ONGx\002V");
  }
#line 469
  if (! __cil_tmp10) {
    {
