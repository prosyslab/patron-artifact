...
#line 41 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef int Boolean;
#line 48 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef long ECIint32;
#line 67 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef char ECIsystemChar;
#line 102 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef void *ECIHand;
#line 104 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef void const   *ECIInputText;
#line 106
enum ECIParam {
    eciSynthMode = 0,
    eciInputType = 1,
...
enum ECIVoiceError {
    VoiceNoError = 0,
    VoiceSystemError = 1,
    VoiceNotRegisteredError = 2,
    VoiceInvalidFileFormatError = 3
} ;
#line 154 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
...
enum ECILanguageDialect {
    ...
    eciBritishEnglish = 65537,
    eciCastilianSpanish = 131072,
    eciMexicanSpanish = 131073,
    eciStandardFrench = 196608,
    eciCanadianFrench = 196609,
    eciStandardGerman = 262144,
    eciStandardItalian = 327680,
    eciMandarinChinese = 393216,
    eciMandarinChineseGB = 393216,
    eciMandarinChinesePinYin = 393472,
    eciMandarinChineseUCS = 395264,
    eciTaiwaneseMandarin = 393217,
    eciTaiwaneseMandarinBig5 = 393217,
    eciTaiwaneseMandarinZhuYin = 393473,
    eciTaiwaneseMandarinPinYin = 393729,
    eciTaiwaneseMandarinUCS = 395265,
    eciBrazilianPortuguese = 458752,
    eciStandardJapanese = 524288,
    eciStandardJapaneseSJIS = 524288,
    eciStandardJapaneseUCS = 526336,
    eciStandardFinnish = 589824,
    eciStandardKorean = 655360,
    eciStandardKoreanUHC = 655360,
    eciStandardKoreanUCS = 657408,
    eciStandardCantonese = 720896,
    eciStandardCantoneseGB = 720896,
    eciStandardCantoneseUCS = 722944,
    eciHongKongCantonese = 720897,
    eciHongKongCantoneseBig5 = 720897,
    eciHongKongCantoneseUCS = 722945,
    eciStandardDutch = 786432,
    eciStandardNorwegian = 851968,
    eciStandardSwedish = 917504,
    eciStandardDanish = 983040,
    eciStandardReserved = 1048576,
    eciStandardThai = 1114112,
    eciStandardThaiTIS = 1114112
} ;
#line 206
...
#line 220 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
union __anonunion_18 {
   unsigned char sz[5] ;
   unsigned short wsz[5] ;
};
#line 219 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
struct __anonstruct_17 {
   union __anonunion_18 phoneme ;
...
#line 233 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef struct __anonstruct_17 ECIMouthData;
#line 235 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
struct ECIVoiceAttrib {
   int eciSampleRate ;
   enum ECILanguageDialect languageID ;
};
#line 238 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef struct ECIVoiceAttrib ECIVoiceAttrib;
#line 244
enum ECIMessage {
    eciWaveformBuffer = 0,
    eciPhonemeBuffer = 1,
...
#line 253 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef enum ECICallbackReturn (*ECICallback)(ECIHand  , enum ECIMessage  , long  ,
                                              void * );
#line 356 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
typedef void *ECIFilterHand;
#line 360
enum ECIFilterError {
    FilterNoError = 0,
    FilterFileNotFound = 1,
    FilterOutOfMemory = 2,
    FilterInternalError = 3,
    FilterAccessError = 4
} ;
#line 48 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
enum __anonenum__19 {
    VOX_SYNTH_MODE = 0,
    VOX_INPUT_TYPE = 1,
    VOX_TEXT_MODE = 2,
    VOX_DICTIONARY = 3,
    VOX_SAMPLE_RATE = 5,
    VOX_WANT_PHONEME_INDICES = 7,
    VOX_REAL_WORLD_UNITS = 8,
    VOX_LANGUAGE_DIALECT = 9,
    VOX_NUMBER_MODE = 10,
    VOX_WANT_WORD_INDEX = 12,
    VOX_CAPITALS = 17
} ;
#line 60 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
typedef enum __anonenum__19 voxParam;
#line 62
enum __anonenum__20 {
    voxFemale = 0,
    voxMale = 1
} ;
#line 62 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
typedef enum __anonenum__20 voxGender;
#line 63
enum __anonenum__21 {
    voxAdult = 0,
    voxChild = 1,
...
#line 63 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
typedef enum __anonenum__21 voxAge;
#line 64
enum __anonenum__22 {
    voxCapitalNone = 0,
    voxCapitalSoundIcon = 1,
    voxCapitalSpell = 2,
    voxCapitalPitch = 3
} ;
#line 64 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
typedef enum __anonenum__22 voxCapitalMode;
#line 78 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
...
#line 93 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
typedef struct __anonstruct_23 vox_t;
...
struct __anonstruct_25 {
   int __count ;
   union __anonunion_26 __value ;
};
#line 21 "/usr/include/x86_64-linux-gnu/bits/types/__mbstate_t.h"
typedef struct __anonstruct_25 __mbstate_t;
...
typedef struct __anonstruct_46 SF_FORMAT_INFO;
#line 393
enum __anonenum__47 {
    SFD_DEFAULT_LEVEL = 0,
...
typedef struct __anonstruct_48 SF_DITHER_INFO;
...
typedef struct __anonstruct_49 SF_EMBED_FILE_INFO;
...
typedef struct __anonstruct_50 SF_CUE_POINT;
...
#line 437 "/usr/include/sndfile.h"
typedef struct __anonstruct_51 SF_CUES;
#line 443
enum __anonenum__52 {
    SF_LOOP_NONE = 800,
    SF_LOOP_FORWARD = 801,
...
struct __anonstruct_53 {
   ...
   char key_hi ;
   int loop_count ;
   struct __anonstruct_54 loops[16] ;
};
#line 466 "/usr/include/sndfile.h"
typedef struct __anonstruct_53 SF_INSTRUMENT;
...
typedef struct __anonstruct_55 SF_LOOP_INFO;
...
#line 515 "/usr/include/sndfile.h"
typedef struct __anonstruct_56 SF_BROADCAST_INFO;
...
#line 549 "/usr/include/sndfile.h"
typedef struct __anonstruct_57 SF_CART_INFO;
...
typedef struct __anonstruct_59 cpu_set_t;
...
typedef struct __anonstruct_70 __pthread_unwind_buf_t;
...
typedef struct __anonstruct_71 max_align_t;
...
typedef enum __anonenum__74 GUserDirectory;
#line 276
struct _GDebugKey ;
...
typedef enum __anonenum__75 GFormatSizeFlags;
...
typedef enum __anonenum__79 GThreadError;
...
typedef enum __anonenum__80 GOnceStatus;
...
union __anonunion_88 {
   struct __anonstruct_89 _addr_bnd ;
   __uint32_t _pkey ;
};
...
union __anonunion_82 {
   int _pad[28] ;
   struct __anonstruct_83 _kill ;
   struct __anonstruct_84 _timer ;
   struct __anonstruct_85 _rt ;
   struct __anonstruct_86 _sigchld ;
   struct __anonstruct_87 _sigfault ;
   struct __anonstruct_90 _sigpoll ;
   struct __anonstruct_91 _sigsys ;
};
...
struct __anonstruct_81 {
   ...
   int si_code ;
   int __pad0 ;
   union __anonunion_82 _sifields ;
};
#line 124 "/usr/include/x86_64-linux-gnu/bits/types/siginfo_t.h"
typedef struct __anonstruct_81 siginfo_t;
...
typedef struct __anonstruct_104 stack_t;
...
typedef struct __anonstruct_105 mcontext_t;
...
typedef enum __anonenum__107 GTimeType;
...
typedef enum __anonenum__108 GBookmarkFileError;
#line 78
...
typedef enum __anonenum__109 GChecksumType;
#line 65
struct _GChecksum ;
...
typedef enum __anonenum__110 GConvertError;
#line 83
struct _GIConv ;
...
typedef enum __anonenum__111 GDateDMY;
#line 62
...
typedef enum __anonenum__112 GDateWeekday;
#line 73
...
typedef enum __anonenum__113 GDateMonth;
...
typedef enum __anonenum__115 GFileError;
#line 66
...
typedef enum __anonenum__116 GFileTest;
#line 99
...
typedef enum __anonenum__117 GFileSetContentsFlags;
...
typedef enum __anonenum__118 GTraverseFlags;
#line 50
...
typedef enum __anonenum__119 GTraverseType;
...
typedef enum __anonenum__120 GHookFlagMask;
...
typedef enum __anonenum__121 GIOCondition;
#line 55
...
typedef enum __anonenum__122 GMainContextFlags;
#line 68
...
typedef enum __anonenum__123 GUnicodeType;
#line 213
...
typedef enum __anonenum__124 GUnicodeBreakType;
#line 449
...
typedef enum __anonenum__125 GUnicodeScript;
#line 930
...
typedef enum __anonenum__126 GNormalizeMode;
...
typedef enum __anonenum__127 GIOError;
#line 54
...
typedef enum __anonenum__128 GIOChannelError;
#line 69
...
typedef enum __anonenum__129 GIOStatus;
#line 77
...
typedef enum __anonenum__130 GSeekType;
#line 84
...
typedef enum __anonenum__131 GIOFlags;
...
typedef enum __anonenum__132 GKeyFileError;
#line 48
struct _GKeyFile ;
...
typedef enum __anonenum__133 GKeyFileFlags;
...
typedef enum __anonenum__134 GMarkupError;
#line 95
...
typedef enum __anonenum__135 GMarkupParseFlags;
#line 112
...
typedef enum __anonenum__136 GMarkupCollectType;
...
typedef enum __anonenum__137 GVariantClass;
#line 268
...
union __anonunion_138 {
   struct __anonstruct_139 s ;
   gsize x[16] ;
};
#line 298 "/usr/include/glib-2.0/glib/gvariant.h"
struct _GVariantBuilder {
   union __anonunion_138 u ;
};
#line 311
...
typedef enum __anonenum__140 GVariantParseError;
#line 446
...
union __anonunion_141 {
   struct __anonstruct_142 s ;
   gsize x[16] ;
};
#line 447 "/usr/include/glib-2.0/glib/gvariant.h"
struct _GVariantDict {
   union __anonunion_141 u ;
};
...
typedef enum __anonenum__143 GLogLevelFlags;
...
typedef enum __anonenum__144 GLogWriterOutput;
#line 156
struct _GLogField ;
...
typedef enum __anonenum__145 GOptionFlags;
#line 119
...
typedef enum __anonenum__146 GOptionArg;
...
typedef enum __anonenum__147 GOptionError;
...
typedef enum __anonenum__148 GRegexError;
#line 296
...
typedef enum __anonenum__149 GRegexCompileFlags;
#line 386
...
typedef enum __anonenum__150 GRegexMatchFlags;
#line 413
struct _GRegex ;
...
typedef enum __anonenum__151 GErrorType;
#line 75
...
typedef enum __anonenum__152 GTokenType;
...
typedef enum __anonenum__153 GShellError;
...
typedef enum __anonenum__154 GSliceConfig;
...
typedef enum __anonenum__155 GSpawnError;
...
typedef enum __anonenum__156 GSpawnFlags;
...
typedef enum __anonenum__157 GAsciiType;
...
typedef enum __anonenum__158 GNumberParserError;
...
typedef enum __anonenum__159 GTestTrapFlags;
#line 459
...
typedef enum __anonenum__160 GTestSubprocessFlags;
...
typedef struct __anonstruct_161 GTestConfig;
#line 601
...
typedef enum __anonenum__162 GTestResult;
#line 608
...
typedef enum __anonenum__163 GTestLogType;
...
typedef struct __anonstruct_164 GTestLogMsg;
...
typedef enum __anonenum__167 GUriFlags;
#line 205
...
typedef enum __anonenum__168 GUriHideFlags;
#line 257
...
typedef enum __anonenum__169 GUriParamsFlags;
#line 271
...
typedef enum __anonenum__170 GUriError;
...
typedef enum __anonenum__171 GThreadPriority;
...
typedef struct __anonstruct_172 GStaticMutex;
#line 156
...
#line 32 "../../include/spd_audio_plugin.h"
typedef enum __anonenum__174 AudioFormat;
...
typedef struct __anonstruct_175 AudioTrack;
#line 43
...
typedef struct __anonstruct_176 AudioID;
...
typedef enum __anonenum__177 speak_queue_entry_type;
...
typedef struct __anonstruct_178 speak_queue_audio_chunk;
...
typedef struct __anonstruct_179 speak_queue_entry;
...
typedef enum __anonenum__181 speak_queue_state_t;
#line 41
...
typedef enum __anonenum__182 speak_queue_pause_state_t;
...
typedef enum __anonenum__320 lt_dlloader_priority;
...
typedef struct __anonstruct_321 lt_dlvtable;
...
typedef struct __anonstruct_322 lt_dlsymlist;
...
typedef struct __anonstruct_323 lt_dlinfo;
#line 35 "/usr/include/x86_64-linux-gnu/bits/siginfo-consts.h"
...
#line 27 "/usr/include/x86_64-linux-gnu/bits/ss_flags.h"
enum __anonenum__372___0 {
    SS_ONSTACK___2 = 1,
    SS_DISABLE___2 = 2
} ;
#line 97 "/usr/include/dirent.h"
enum __anonenum__380___0 {
    DT_UNKNOWN___2 = 0,
    DT_FIFO___2 = 1,
    DT_CHR___2 = 2,
    DT_DIR___2 = 4,
...
typedef enum __anonenum__456 SPDPunctuation;
#line 31
...
typedef enum __anonenum__457 SPDCapitalLetters;
#line 37
...
typedef enum __anonenum__458 SPDSpelling;
#line 42
...
typedef enum __anonenum__459 SPDVoiceType;
...
typedef struct __anonstruct_460 SPDVoice;
#line 62
...
typedef enum __anonenum__461 SPDDataMode;
#line 67
...
typedef enum __anonenum__462 SPDPriority;
#line 75
...
typedef enum __anonenum__463 SPDNotification;
#line 86
...
typedef enum __anonenum__464 SPDNotificationType;
#line 95
...
typedef enum __anonenum__465 ESort;
#line 100
...
typedef enum __anonenum__466 SPDMessageType;
...
typedef struct __anonstruct_467 SPDMsgSettings;
#line 35 "/usr/include/x86_64-linux-gnu/bits/siginfo-consts.h"
...
typedef enum __anonenum__651 idtype_t;
#line 140
struct rusage ;
...
typedef struct __anonstruct_667 TModuleDoublePipe;
#line 42 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
...
#line 51 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
typedef struct __anonstruct_668 SPDVoiceDef;
#line 24 "/usr/include/x86_64-linux-gnu/bits/confname.h"
...
#line 27 "/usr/include/x86_64-linux-gnu/bits/ss_flags.h"
enum __anonenum__893 {
    SS_ONSTACK___6 = 1,
    SS_DISABLE___6 = 2
} ;
#line 97 "/usr/include/dirent.h"
enum __anonenum__901 {
    DT_UNKNOWN___5 = 0,
    DT_FIFO___5 = 1,
    DT_CHR___5 = 2,
    DT_DIR___5 = 4,
...
#line 52 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
enum __anonenum__1234 {
    MODULE_FATAL_ERROR = -1,
    MODULE_OK = 0,
    MODULE_ERROR = 1
} ;
#line 56 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
typedef enum __anonenum__1234 module_status;
#line 167 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
typedef short TEciAudioSamples;
#line 171
enum __anonenum__1235 {
    eciTextModeDefault = 0,
    eciTextModeAlphaSpell = 1,
    eciTextModeAllSpell = 2,
    eciIRCSpell = 3
} ;
#line 176 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
typedef enum __anonenum__1235 ECITextMode;
#line 257 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
struct __anonstruct_1236 {
   int gender ;
   int breathiness ;
   int head_size ;
   int pitch_baseline ;
...
#line 257 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
typedef struct __anonstruct_1236 TIbmttsVoiceParameters;
#line 260 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
struct __anonstruct_1237 {
   char *key ;
   char *newkey ;
};
#line 260 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
typedef struct __anonstruct_1237 TIbmttsKeySubstitution;
#line 98 "/usr/include/stdlib.h"
extern  __attribute__((__nothrow__)) size_t __ctype_get_mb_cur_max(void) ;
#line 102
extern  __attribute__((__nothrow__)) double atof(char const   *__nptr )  __attribute__((__gnu_inline__)) ;
#line 105
extern  __attribute__((__nothrow__)) int atoi(char const   *__nptr )  __attribute__((__gnu_inline__)) ;
#line 108
extern  __attribute__((__nothrow__)) long atol(char const   *__nptr )  __attribute__((__gnu_inline__)) ;
#line 113
extern  __attribute__((__nothrow__)) long long atoll(char const   *__nptr )  __attribute__((__gnu_inline__)) ;
#line 118
...
#line 808
extern  __attribute__((__nothrow__)) char *realpath(char const   *__name , char *__resolved )  __attribute__((__gnu_inline__,
__gnu_inline__)) ;
#line 828
...
extern  __attribute__((__nothrow__)) int mbtowc(wchar_t *__pwc , char const   *__s ,
                                                size_t __n ) ;
#line 937
extern  __attribute__((__nothrow__)) int wctomb(char *__s , wchar_t __wchar )  __attribute__((__gnu_inline__)) ;
#line 941
extern  __attribute__((__nothrow__)) size_t mbstowcs(wchar_t *__dst , char const   *__src ,
                                                     size_t __len )  __attribute__((__gnu_inline__)) ;
#line 945
extern  __attribute__((__nothrow__)) size_t wcstombs(char *__dst , wchar_t *__src ,
                                                     size_t __len )  __attribute__((__gnu_inline__)) ;
#line 956
...
#line 276 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/eci.h"
ECIHand eciNew(void) ;
#line 277
...
#line 288
Boolean eciSpeakTextEx(ECIInputText pText , Boolean bAnnotationsInTextPhrase , enum ECILanguageDialect Value ) ;
#line 289
...
#line 295
Boolean eciSetVoiceName(ECIHand hEngine , int iVoice , void const   *pBuffer ) ;
#line 296
...
#line 302
Boolean eciSynthesizeFile(ECIHand hEngine , void const   *pFilename ) ;
#line 303
...
#line 310
Boolean eciSetOutputFilename(ECIHand hEngine , void const   *pFilename ) ;
#line 311
...
#line 318
enum ECIDictError eciLoadDict(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                              ECIInputText pFilename ) ;
#line 319
enum ECIDictError eciSaveDict(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                              ECIInputText pFilename ) ;
#line 320
enum ECIDictError eciUpdateDict(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                ECIInputText pKey , ECIInputText pTranslationValue ) ;
#line 322
enum ECIDictError eciDictFindFirst(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                   ECIInputText *ppKey , ECIInputText *ppTranslationValue ) ;
#line 325
enum ECIDictError eciDictFindNext(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                  ECIInputText *ppKey , ECIInputText *ppTranslationValue ) ;
#line 328
char const   *eciDictLookup(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                            ECIInputText pKey ) ;
#line 331
enum ECIDictError eciUpdateDictA(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                 ECIInputText pKey , ECIInputText pTranslationValue ,
                                 enum ECIPartOfSpeech PartOfSpeech ) ;
#line 334
enum ECIDictError eciDictFindFirstA(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                    ECIInputText *ppKey , ECIInputText *ppTranslationValue ,
                                    enum ECIPartOfSpeech *pPartOfSpeech ) ;
#line 337
enum ECIDictError eciDictFindNextA(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                   ECIInputText *ppKey , ECIInputText *ppTranslationValue ,
                                   enum ECIPartOfSpeech *pPartOfSpeech ) ;
#line 340
enum ECIDictError eciDictLookupA(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                                 ECIInputText pKey , ECIInputText *ppTranslationValue ,
                                 enum ECIPartOfSpeech *pPartOfSpeech ) ;
#line 350
enum ECIVoiceError eciRegisterVoice(ECIHand eciHand , int voiceNumber , void *vData ,
                                    ECIVoiceAttrib *vAttrib ) ;
#line 351
enum ECIVoiceError eciUnregisterVoice(ECIHand eciHand , int voiceNumber , ECIVoiceAttrib *vAttrib ,
                                      void **vData ) ;
#line 368
...
#line 103 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin.h"
...
#line 158
int voxToString(vox_t *data___0 , char *string , size_t *size ) ;
#line 163
...
extern  __attribute__((__nothrow__)) void __assert(char const   *__assertion , char const   *__file ,
                                                   int __line ) ;
#line 23 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
ECIHand eciNew(void) 
{ 
  int tmp ;
...
#line 27 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int eciGetAvailableLanguages(enum ECILanguageDialect *aLanguages , int *nLanguages ) 
{ 
  int tmp ;
...
#line 31 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
ECIHand eciDelete(ECIHand hEngine ) 
{ 
  int tmp ;
...
#line 35 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
void eciVersion(char *pBuffer ) 
{ 
  int tmp ;
...
#line 39 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
void eciErrorMessage(ECIHand hEngine , void *buffer ) 
{ 
  int tmp ;
...
#line 43 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int eciGetParam(ECIHand hEngine , enum ECIParam Param ) 
{ 
  int tmp ;
...
#line 47 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int eciSetParam(ECIHand hEngine , enum ECIParam Param , int iValue ) 
{ 
  int tmp ;
...
#line 51 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciGetVoiceName(ECIHand hEngine , int iVoice , void *pBuffer ) 
{ 
  int tmp ;
...
#line 55 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciCopyVoice(ECIHand hEngine , int iVoiceFrom , int iVoiceTo ) 
{ 
  int tmp ;
...
#line 59 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int eciGetVoiceParam(ECIHand hEngine , int iVoice , enum ECIVoiceParam Param ) 
{ 
  int tmp ;
...
#line 63 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int eciSetVoiceParam(ECIHand hEngine , int iVoice , enum ECIVoiceParam Param , int iValue ) 
{ 
  int tmp ;
...
#line 67 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciAddText(ECIHand hEngine , ECIInputText pText ) 
{ 
  int tmp ;
...
#line 71 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciInsertIndex(ECIHand hEngine , int iIndex ) 
{ 
  int tmp ;
...
#line 75 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciSynthesize(ECIHand hEngine ) 
{ 
  int tmp ;
...
#line 79 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciStop(ECIHand hEngine ) 
{ 
  int tmp ;
...
#line 83 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciSynchronize(ECIHand hEngine ) 
{ 
  int tmp ;
...
#line 87 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
Boolean eciSetOutputBuffer(ECIHand hEngine , int iSize , short *psBuffer ) 
{ 
  int tmp ;
...
#line 91 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
void eciRegisterCallback(ECIHand hEngine , ECICallback Callback , void *pData ) 
{ 
  int tmp ;
...
#line 95 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
ECIDictHand eciNewDict(ECIHand hEngine ) 
{ 
  int tmp ;
...
#line 99 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
ECIDictHand eciGetDict(ECIHand hEngine ) 
{ 
  int tmp ;
...
#line 103 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
enum ECIDictError eciSetDict(ECIHand hEngine , ECIDictHand hDict ) 
{ 
  int tmp ;

  {
  return ((enum ECIDictError )0);
}
}
#line 107 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
ECIDictHand eciDeleteDict(ECIHand hEngine , ECIDictHand hDict ) 
{ 
  int tmp ;
...
#line 111 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
enum ECIDictError eciLoadDict(ECIHand hEngine , ECIDictHand hDict , enum ECIDictVolume DictVol ,
                              ECIInputText pFilename ) 
{ 
  int tmp ;
...
#line 115 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int voxGetVoices(vox_t *list , unsigned int *nbVoices ) 
{ 
  int tmp ;
...
#line 119 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int voxSetParam(void *handle , voxParam param , int value ) 
{ 
  int tmp ;
...
#line 123 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int voxToString(vox_t *data___0 , char *string , size_t *size ) 
{ 
  int tmp ;
...
#line 127 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/voxin_shim.c"
int voxString(vox_t *v , char *s , size_t len ) 
{ 
  int tmp ;
...
extern size_t mbstowcs(wchar_t *__dst , char const   *__src , size_t __len ) 
{ 
  int __cil_tmp4 ;
  unsigned long __cil_tmp5 ;
  int __cil_tmp6 ;
...
extern size_t wcstombs(char *__dst , wchar_t *__src , size_t __len ) 
{ 
  int __cil_tmp4 ;
  unsigned long __cil_tmp5 ;
  int __cil_tmp6 ;
...
#line 342
  if (ret < 0) {
    {
#line 343
    MSG(4, "ERROR: Can\'t play track for unknown reason.)OV");
    }
#line 344
    return (0);
  }
...
#line 380
  MSG(4, "Frames = %jd, channels = %ldOV", sfinfo.frames, (long )sfinfo.channels);
#line 382
  MSG(4, "Samplerate = %i, items = %lld", sfinfo.samplerate, (long long )items);
#line 384
  MSG(4, "Major format = 0x%08X, subformat = 0x%08X, endian = 0x%08Xn)OV", sfinfo.format & 268369920,
...
{ 
  ...
  {
#line 32
  __cil_tmp1 = setlocale(6, "\200V\350)OV");
  }
#line 32
...
#line 36 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/.libs/sd_voxinS.c"
...
#line 34 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
GHashTable *module_voice_table  =    (GHashTable *)((void *)0);
#line 36 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
static int nbvoices  =    0;
#line 37 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
...
#line 53 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
char const   *VoiceFileDependency_cb(command_t *cmd , context_t *ctx ) 
{ 
  gpointer __cil_tmp3 ;
  gchar *__cil_tmp4 ;
  ...
  {
#line 55
  __cil_tmp3 = g_realloc(dependency_paths, (unsigned long )(nbpaths + 1) * sizeof(*dependency_paths));
#line 55
  dependency_paths = (char **)__cil_tmp3;
#line 56
...
#line 61 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
char const   *AddVoice_cb(command_t *cmd , context_t *ctx ) 
{ 
  int i ;
  GRegex *regex ;
  SPDVoiceDef *voices___0 ;
  char *language ;
  char *symbolic ;
  char *voicename ;
  char *key ;
  ...
  int __cil_tmp35 ;
  gchar *__cil_tmp36 ;
  gpointer __cil_tmp37 ;
  gpointer __cil_tmp38 ;
  gchar *__cil_tmp39 ;
  gchar *__cil_tmp40 ;
  gchar *__cil_tmp41 ;
  int __cil_tmp42 ;
...
#line 63
  i = 0;
#line 66
  language = *(cmd->data.list + 0);
#line 68
  voicename = *(cmd->data.list + 2);
#line 72
  if (language == (void *)0) {
    {
#line 73
    MSG(4, "Missing language.\n");
    }
#line 74
    return ((char const   *)((void *)0));
  }
...
#line 82
  if (voicename == (void *)0) {
    {
#line 83
    MSG(4, "Missing voice name for %s\n", *(cmd->data.list + 0));
    }
#line 84
    return ((char const   *)((void *)0));
  }
#line 87
  if (module_voice_table == (void *)0) {
    {
#line 88
    MSG(4, "No voice table\n");
    }
#line 89
    return ((char const   *)((void *)0));
  }
  {
#line 92
  __cil_tmp11 = strlen((char const   *)*(cmd->data.list + 1));
#line 92
  __cil_tmp12 = g_ascii_strup(*(cmd->data.list + 1), (gssize )__cil_tmp11);
#line 92
  symbolic = (char *)__cil_tmp12;
#line 95
  voices___0 = (SPDVoiceDef *)g_hash_table_lookup(module_voice_table, language);
  }
#line 96
  if (voices___0 == (void *)0) {
    {
#line 97
    __cil_tmp14 = g_strdup(language);
#line 97
    key = (char *)__cil_tmp14;
#line 98
    __cil_tmp15 = g_malloc(sizeof(SPDVoiceDef ));
#line 98
    value = (SPDVoiceDef *)__cil_tmp15;
#line 100
...
#line 110
  ...
  {
#line 113
  regex = g_regex_new((gchar *)"[$]VOICE\251", (GRegexCompileFlags )0, (GRegexMatchFlags )0,
                      (GError **)((void *)0));
#line 114
  i = 0;
  }
...
#line 114
    ...
    {
#line 116
    __cil_tmp18 = g_regex_replace_literal(regex, *(dependency_paths + i), (gssize )(- 1),
                                          0, *(cmd->data.list + 2), (GRegexMatchFlags )0,
                                          (GError **)((void *)0));
#line 116
    new_dependency_path = __cil_tmp18;
#line 117
    __cil_tmp19 = g_file_test(new_dependency_path, (GFileTest )16);
    }
#line 117
    if (! __cil_tmp19) {
      {
#line 118
      MSG(4, "Missing dependency %s\n", new_dependency_path);
#line 119
...
#line 125
  g_regex_unref(regex);
#line 127
  __cil_tmp21 = strcmp((char const   *)symbolic, "MALE1");
  }
#line 127
  if (! __cil_tmp21) {
    {
#line 128
    voices___0->male1 = g_strdup(voicename);
    }
  } else {
    {
#line 129
    __cil_tmp23 = strcmp((char const   *)symbolic, "MALE2");
    }
#line 129
    if (! __cil_tmp23) {
      {
#line 130
      voices___0->male2 = g_strdup(voicename);
      }
    } else {
      {
#line 131
      __cil_tmp25 = strcmp((char const   *)symbolic, "MALE3");
      }
#line 131
      if (! __cil_tmp25) {
        {
#line 132
        voices___0->male3 = g_strdup(voicename);
        }
      } else {
        {
#line 133
        __cil_tmp27 = strcmp((char const   *)symbolic, "FEMALE1");
        }
#line 133
        if (! __cil_tmp27) {
          {
#line 134
          voices___0->female1 = g_strdup(voicename);
          }
        } else {
          {
#line 135
          __cil_tmp29 = strcmp((char const   *)symbolic, "FEMALE2");
          }
#line 135
          if (! __cil_tmp29) {
            {
#line 136
            voices___0->female2 = g_strdup(voicename);
            }
          } else {
            {
#line 137
            __cil_tmp31 = strcmp((char const   *)symbolic, "FEMALE3");
            }
#line 137
            if (! __cil_tmp31) {
              {
#line 138
              voices___0->female3 = g_strdup(voicename);
              }
            } else {
              {
#line 139
              __cil_tmp33 = strcmp((char const   *)symbolic, "CHILD_MALE");
              }
#line 139
              if (! __cil_tmp33) {
                {
#line 140
                voices___0->child_male = g_strdup(voicename);
                }
              } else {
                {
#line 141
                __cil_tmp35 = strcmp((char const   *)symbolic, "CHILD_FEMALE");
                }
#line 141
                if (! __cil_tmp35) {
                  {
#line 142
                  voices___0->child_female = g_strdup(voicename);
                  }
                } else {
                  {
#line 144
                  MSG(4, "Unrecognized voice name in configuration\n");
                  }
#line 145
                  return ((char const   *)((void *)0));
                }
  ...
  {
#line 148
  __cil_tmp37 = g_realloc(generic_voices, (unsigned long )(nbvoices + 1) * sizeof(SPDVoice ));
#line 148
  generic_voices = (SPDVoice *)__cil_tmp37;
#line 149
  __cil_tmp38 = g_realloc(generic_voices_list, (unsigned long )(nbvoices + 2) * sizeof(SPDVoice *));
#line 149
  generic_voices_list = (SPDVoice **)__cil_tmp38;
#line 150
...
#line 153
  ...
  {
#line 155
  *(generic_voices_list + (nbvoices + 1)) = (SPDVoice *)((void *)0);
#line 156
...
#line 161 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
char const   *DefaultVoice_cb(command_t *cmd , context_t *ctx ) 
{ 
  char *voicename ;
  char *__cil_tmp4 ;
  ...
  {
#line 163
  voicename = *(cmd->data.list + 0);
#line 164
  if (voicename == (void *)0) {
    {
#line 165
    MSG(4, "Missing default voice name\n");
    }
#line 166
    return ((char const   *)((void *)0));
  }
...
#line 170
  ...
  {
#line 171
  default_voice = strdup((char const   *)voicename);
  }
#line 173
  return ((char const   *)((void *)0));
}
}
#line 176 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
void module_register_available_voices(void) 
{ 
...
#line 178
  module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                               "VoiceFileDependency", 2, & VoiceFileDependency_cb,
                                               (void *)0, (unsigned long )0);
  }
  return;
}
}
#line 184 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
void module_register_settings_voices(void) 
{ 
...
#line 187
  module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                               "AddVoice\251", 3, & AddVoice_cb, (void *)0,
                                               (unsigned long )0);
#line 191
  module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                               "DefaultVoiceOV", 2, & DefaultVoice_cb,
                                               (void *)0, (unsigned long )0);
  }
  return;
}
}
#line 197 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
gboolean module_existsvoice(char const   *voicename ) 
{ 
  int i ;
  int __cil_tmp3 ;
...
#line 202
  while (1) {
    while_continue: /* CIL Label */ ;
#line 202
    if (! (*(generic_voices_list + i) != (void *)0)) {
#line 202
      goto while_break;
    }
    {
#line 203
    __cil_tmp3 = strcasecmp((char const   *)(generic_voices + i)->name, voicename);
    }
#line 203
    if (__cil_tmp3 == 0) {
#line 204
...
#line 209 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
SPDVoice **module_list_registered_voices(void) 
{ 
...
#line 213 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
char *module_getvoice(char const   *language , SPDVoiceType voice ) 
{ 
  SPDVoiceDef *voices___0 ;
  char *ret ;
...
#line 218
  if (module_voice_table == (void *)0) {
    {
#line 219
    MSG(4, "Can\'t get voice because voicetable is NULL\n*OV");
    }
#line 220
    return ((char *)((void *)0));
  }
...
#line 224
  if (voices___0 == (void *)0) {
    {
#line 225
    MSG(4, "There are no voices in the table for language=%s\n\302v*OV", language);
    }
#line 227
    return ((char *)((void *)0));
  }
...
#line 233
  ret = voices___0->male1;
#line 234
  goto switch_break;
  case_2: /* CIL Label */ 
#line 236
  ret = voices___0->male2;
#line 237
  goto switch_break;
  case_3: /* CIL Label */ 
#line 239
  ret = voices___0->male3;
#line 240
  goto switch_break;
  case_4: /* CIL Label */ 
#line 242
  ret = voices___0->female1;
#line 243
  goto switch_break;
  case_5: /* CIL Label */ 
#line 245
  ret = voices___0->female2;
#line 246
  goto switch_break;
  case_6: /* CIL Label */ 
#line 248
  ret = voices___0->female3;
#line 249
  goto switch_break;
  case_7: /* CIL Label */ 
#line 251
  ret = voices___0->child_male;
#line 252
  goto switch_break;
  case_8: /* CIL Label */ 
#line 254
  ret = voices___0->child_female;
#line 255
  goto switch_break;
  switch_default: /* CIL Label */ 
  {
#line 257
  fprintf(stderr, "Unknown voice %d\230\001", (int )voice);
  }
#line 258
  return ((char *)((void *)0));
  switch_break: /* CIL Label */ ;
...
#line 283 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/module_utils_addvoice.c"
char *module_getdefaultvoice(void) 
{ 
...
#line 174
          ...
          {
#line 180
          __cil_tmp15 = strcmp(cur_item, "audio_pulse_device\272*OV");
          }
#line 180
          if (! __cil_tmp15) {
            {
...
{ 
  ...
  {
#line 202
  __cil_tmp3 = strcmp(cur_item, "log_level\311\272*OV");
  }
#line 202
  if (! __cil_tmp3) {
    {
...
#line 210
  if (enable) {
    {
#line 211
    MSG(4, "Additional logging into specific path %s requested\272*OV", filename);
#line 213
    __cil_tmp4 = fopen(filename, "w+\272*OV");
#line 213
...
#line 518
  MSG(4, "written %ld bytes\322\222*OV", (long )ret);
  }
#line 519
  return ((int )ret);
}
...
#line 527
      while (1) {
        ...
        {
#line 527
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 *\001",
                "./src/modules/module_utils.cOV", 527);
        }
#line 527
        if (Debug > 1) {
          {
...
#line 538
        fprintf(stderr, "FATAL ERROR in output module [%s:%d]:\n   Unable to read data\323\001 *\001",
                "./src/modules/module_utils.cOV", 538);
        }
#line 538
        if (Debug > 1) {
          {
...
#line 466
  ...
  {
#line 469
  __cil_tmp10 = strcmp((char const   *)on, "ON\023+OV");
  }
#line 469
  if (! __cil_tmp10) {
    {
...
#line 82 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
...
#line 154 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean stop_requested  =    0;
#line 155 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean pause_requested  =    0;
#line 156 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean pause_index_sent  =    0;
#line 158 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean initialized  =    0;
#line 161 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static ECIHand eciHandle  =    (ECIHand )0;
#line 162 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static int eci_sample_rate  =    0;
#line 168
static TEciAudioSamples *audio_chunk ;
#line 179 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static GHashTable *index_mark_ht  =    (GHashTable *)((void *)0);
#line 184
static int voice_pitch_baseline ;
#line 187
static int voice_speed ;
#line 191 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *input_encoding  =    "utf-8V";
#line 197 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static SPDVoice **speechd_voice  =    (SPDVoice **)((void *)0);
#line 206
...
#line 213
static void set_pitch(int pitch ) ;
#line 214
...
#line 225
static void subst_keys_cb(gpointer data___0 , gpointer user_data ) ;
#line 226
static char *subst_keys(char *key ) ;
#line 227
static char *search_for_sound_icon(char const   *icon_name ) ;
#line 228
static gboolean add_sound_icon_to_playback_queue(char *filename ) ;
#line 229
static void load_user_dictionary(void) ;
#line 231
static enum ECICallbackReturn eciCallback(ECIHand hEngine , enum ECIMessage msg ,
                                          long lparam , void *data___0 ) ;
#line 236
static gboolean add_audio_to_playback_queue(TEciAudioSamples *audio_chunk___0 , long num_samples ) ;
#line 239
static void add_mark_to_playback_queue(long markId ) ;
#line 242
static void log_eci_error(void) ;
#line 243
static gboolean alloc_voice_list(void) ;
#line 244
static void free_voice_list(void) ;
#line 247
static void _synth(char *message , SPDMessageType message_type ) ;
#line 250
static int IbmttsUseSSML ;
#line 250 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsUseSSML_cb(command_t *cmd , context_t *ctx ) 
{ 


  {
#line 250
  IbmttsUseSSML = (int )cmd->data.value;
#line 250
  return ((char const   *)((void *)0));
}
}
#line 251
static int IbmttsUsePunctuation ;
#line 251 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsUsePunctuation_cb(command_t *cmd , context_t *ctx ) 
{ 


  {
#line 251
  IbmttsUsePunctuation = (int )cmd->data.value;
#line 251
  return ((char const   *)((void *)0));
}
}
#line 252 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *IbmttsPunctuationList  =    (char *)((void *)0);
#line 252 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsPunctuationList_cb(command_t *cmd , context_t *ctx ) 
{ 
  gchar *__cil_tmp3 ;
...
#line 252
  if (cmd->data.str != (void *)0) {
    {
#line 252
    g_free(IbmttsPunctuationList);
#line 252
    IbmttsPunctuationList = g_strdup(cmd->data.str);
    }
  }
#line 252
  return ((char const   *)((void *)0));
...
#line 253
static int IbmttsUseAbbreviation ;
#line 253 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsUseAbbreviation_cb(command_t *cmd , context_t *ctx ) 
{ 


  {
#line 253
  IbmttsUseAbbreviation = (int )cmd->data.value;
#line 253
  return ((char const   *)((void *)0));
}
}
#line 254 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *IbmttsDictionaryFolder  =    (char *)((void *)0);
#line 254 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsDictionaryFolder_cb(command_t *cmd , context_t *ctx ) 
{ 
  gchar *__cil_tmp3 ;
...
#line 254
  if (cmd->data.str != (void *)0) {
    {
#line 254
    g_free(IbmttsDictionaryFolder);
#line 254
    IbmttsDictionaryFolder = g_strdup(cmd->data.str);
    }
  }
#line 254
  return ((char const   *)((void *)0));
...
#line 255
static int IbmttsAudioChunkSize ;
#line 255 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsAudioChunkSize_cb(command_t *cmd , context_t *ctx ) 
{ 


  {
#line 255
  IbmttsAudioChunkSize = (int )cmd->data.value;
#line 255
  return ((char const   *)((void *)0));
}
}
#line 256 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *IbmttsSoundIconFolder  =    (char *)((void *)0);
#line 256 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsSoundIconFolder_cb(command_t *cmd , context_t *ctx ) 
{ 
  gchar *__cil_tmp3 ;
...
#line 256
  if (cmd->data.str != (void *)0) {
    {
#line 256
    g_free(IbmttsSoundIconFolder);
#line 256
    IbmttsSoundIconFolder = g_strdup(cmd->data.str);
    }
  }
#line 256
  return ((char const   *)((void *)0));
...
#line 257
GHashTable *IbmttsVoiceParameters ;
#line 257 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsVoiceParameters_cb(command_t *cmd , context_t *ctx ) 
{ 
  TIbmttsVoiceParameters *new_item ;
  char *new_key ;
  gpointer __cil_tmp5 ;
  gchar *__cil_tmp6 ;
  long __cil_tmp7 ;
  ...
  {
#line 257
  __cil_tmp5 = g_malloc(sizeof(TIbmttsVoiceParameters ));
#line 257
  new_item = (TIbmttsVoiceParameters *)__cil_tmp5;
  }
#line 257
...
#line 257
  __cil_tmp7 = strtol((char const   *)*(cmd->data.list + 1), (char **)((void *)0),
                      10);
#line 257
  new_item->gender = (int )__cil_tmp7;
#line 257
  __cil_tmp8 = strtol((char const   *)*(cmd->data.list + 2), (char **)((void *)0),
                      10);
#line 257
  new_item->breathiness = (int )__cil_tmp8;
#line 257
  __cil_tmp9 = strtol((char const   *)*(cmd->data.list + 3), (char **)((void *)0),
                      10);
#line 257
  new_item->head_size = (int )__cil_tmp9;
#line 257
  __cil_tmp10 = strtol((char const   *)*(cmd->data.list + 4), (char **)((void *)0),
                       10);
#line 257
  new_item->pitch_baseline = (int )__cil_tmp10;
#line 257
  __cil_tmp11 = strtol((char const   *)*(cmd->data.list + 5), (char **)((void *)0),
                       10);
#line 257
  new_item->pitch_fluctuation = (int )__cil_tmp11;
#line 257
  __cil_tmp12 = strtol((char const   *)*(cmd->data.list + 6), (char **)((void *)0),
                       10);
#line 257
  new_item->roughness = (int )__cil_tmp12;
#line 257
  __cil_tmp13 = strtol((char const   *)*(cmd->data.list + 7), (char **)((void *)0),
                       10);
#line 257
  new_item->speed = (int )__cil_tmp13;
#line 257
  g_hash_table_insert(IbmttsVoiceParameters, new_key, new_item);
  }
#line 257
  return ((char const   *)((void *)0));
}
...
#line 260
GHashTable *IbmttsKeySubstitution ;
#line 260 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
char const   *IbmttsKeySubstitution_cb(command_t *cmd , context_t *ctx ) 
{ 
  TIbmttsKeySubstitution *new_item ;
  char *new_key ;
  GList *dll ;
  gpointer __cil_tmp6 ;
  gchar *__cil_tmp7 ;
...
#line 260
  dll = (GList *)((void *)0);
#line 260
  __cil_tmp6 = g_malloc(sizeof(TIbmttsKeySubstitution ));
#line 260
  new_item = (TIbmttsKeySubstitution *)__cil_tmp6;
#line 260
  new_key = g_strdup(*(cmd->data.list + 0));
  }
#line 260
  if ((void *)0 != *(cmd->data.list + 1)) {
    {
#line 260
    new_item->key = g_strdup(*(cmd->data.list + 1));
    }
  } else {
#line 260
    new_item->key = (char *)((void *)0);
  }
#line 260
  if ((void *)0 != *(cmd->data.list + 2)) {
    {
#line 260
    new_item->newkey = g_strdup(*(cmd->data.list + 2));
    }
  } else {
#line 260
    new_item->newkey = (char *)((void *)0);
  }
  {
#line 260
  dll = (GList *)g_hash_table_lookup(IbmttsKeySubstitution, new_key);
#line 260
  dll = g_list_append(dll, new_item);
#line 260
  g_hash_table_insert(IbmttsKeySubstitution, new_key, dll);
  }
#line 260
  return ((char const   *)((void *)0));
}
...
#line 322 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *dictionary_filenames[4]  = {      "main.dct\323\001 ",      "root.dct\323\001 ",      "abbreviation.dct\323\001 ",      "extension.dct"};
#line 333 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
int module_load(void) 
{ 
  configoption_t *__cil_tmp1 ;
  configoption_t *__cil_tmp2 ;
  ...
  GHashTable *__cil_tmp12 ;
  configoption_t *__cil_tmp13 ;
  GHashTable *__cil_tmp14 ;
...
#line 339
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsUseSSML", 1, & IbmttsUseSSML_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 339
    goto while_break___2;
...
#line 340
  while (1) {
    ...
    {
#line 340
    IbmttsUsePunctuation = 1;
#line 340
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsUsePunctuation", 1, & IbmttsUsePunctuation_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 340
...
#line 341
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsUseAbbreviation", 1, & IbmttsUseAbbreviation_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 341
...
#line 342
    if ("()?" != (void *)0) {
      {
#line 342
      IbmttsPunctuationList = g_strdup((gchar *)"()?");
      }
    } else {
#line 342
      IbmttsPunctuationList = (char *)((void *)0);
    }
    {
#line 342
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsPunctuationList", 2, & IbmttsPunctuationList_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 342
...
#line 343
    if ("/var/opt/IBM/ibmtts/dict\251" != (void *)0) {
      {
#line 343
      IbmttsDictionaryFolder = g_strdup((gchar *)"/var/opt/IBM/ibmtts/dict\220");
      }
    } else {
#line 343
      IbmttsDictionaryFolder = (char *)((void *)0);
    }
    {
#line 343
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsDictionaryFolder", 2, & IbmttsDictionaryFolder_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 343
...
#line 346
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsAudioChunkSize", 1, & IbmttsAudioChunkSize_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 346
...
#line 347
    if ("/usr/share/sounds/sound-icons/" != (void *)0) {
      {
#line 347
      IbmttsSoundIconFolder = g_strdup((gchar *)"/usr/share/sounds/sound-icons/");
      }
    } else {
#line 347
      IbmttsSoundIconFolder = (char *)((void *)0);
    }
    {
#line 347
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsSoundIconFolder", 2, & IbmttsSoundIconFolder_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 347
...
#line 354
  while (1) {
    ...
    {
#line 354
    IbmttsVoiceParameters = g_hash_table_new(& g_str_hash, & g_str_equal);
#line 354
    module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                                 "IbmttsVoiceParameters", 3, & IbmttsVoiceParameters_cb,
                                                 (void *)0, (unsigned long )0);
    }
#line 354
  ...
  {
#line 357
  IbmttsKeySubstitution = g_hash_table_new(& g_str_hash, & g_str_equal);
#line 357
  module_dc_options = module_add_config_option(module_dc_options, & module_num_dc_options,
                                               "IbmttsKeySubstitution", 3, & IbmttsKeySubstitution_cb,
                                               (void *)0, (unsigned long )0);
  }
#line 359
  return (0);
...
#line 362 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
int module_init(char **status_info ) 
{ 
  char version[20] ;
  ECIHand __cil_tmp3 ;
  ...
  {
#line 366
  MSG(4, "Voxin: Module init().");
#line 368
  module_audio_set_server();
#line 370
  *status_info = (char *)((void *)0);
#line 373
  eciVersion((char *)version);
#line 374
  MSG(4, "Voxin: output module version %s, engine version %s", "0.2", (char *)version);
#line 380
  MSG(4, "Voxin: Creating an engine instance.");
#line 381
  eciHandle = eciNew();
  }
#line 382
  if ((ECIHand )0 == eciHandle) {
    {
#line 383
    MSG(4, "Voxin: Could not create an engine instance.\n\220");
#line 384
    *status_info = g_strdup((gchar *)"Could not create an engine instance. Is the TTS engine installed?");
    }
#line 386
    return (-1);
  }
...
#line 389
  update_sample_rate();
#line 392
  __cil_tmp5 = g_malloc((unsigned long )IbmttsAudioChunkSize * sizeof(TEciAudioSamples ));
#line 392
  audio_chunk = (TEciAudioSamples *)__cil_tmp5;
#line 396
  MSG(4, "Voxin: Registering ECI callback.");
#line 397
  eciRegisterCallback(eciHandle, & eciCallback, (void *)0);
#line 399
  MSG(4, "Voxin: Registering an ECI audio buffer.");
#line 400
  __cil_tmp6 = eciSetOutputBuffer(eciHandle, IbmttsAudioChunkSize, audio_chunk);
  }
#line 400
  if (! __cil_tmp6) {
    {
#line 401
    MSG(4, "Voxin: Error registering ECI audio buffer.");
#line 402
    log_eci_error();
    }
  }
  {
#line 405
  eciSetParam(eciHandle, (enum ECIParam )3, ! IbmttsUseAbbreviation);
#line 408
  eciSetParam(eciHandle, (enum ECIParam )1, 1);
  }
#line 411
  if (IbmttsUseSSML) {
    {
...
#line 420
  initialized = ! 0;
#line 422
  __cil_tmp7 = alloc_voice_list();
  }
#line 422
  if (! __cil_tmp7) {
    {
#line 423
    MSG(4, "Voxin: voice list allocation failed.\220");
#line 424
    *status_info = g_strdup((gchar *)"The module can\'t build the list of installed voices.");
    }
#line 427
    return (-1);
  }
  {
#line 430
  MSG(4, "Voxin: IbmttsAudioChunkSize = %d", IbmttsAudioChunkSize);
#line 432
  *status_info = g_strdup((gchar *)"Voxin: Initialized successfully.");
  }
#line 434
  return (0);
}
}
#line 437 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
SPDVoice **module_list_voices(void) 
{ 
  ...
  {
#line 439
  MSG(4, "Voxin: ENTER %s", "module_list_voices");
  }
#line 440
  return (speechd_voice);
}
}
#line 443 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
void module_speak_sync(gchar *data___0 , size_t bytes , SPDMessageType msgtype ) 
{ 
  char *message ;
  ...
  {
#line 449
  MSG(4, "Voxin: module_speak().");
#line 451
  MSG(4, "Voxin: Type: %d, bytes: %lu, requested data: |%s|\n", (unsigned int )msgtype,
      (unsigned long )bytes, data___0);
#line 454
  __cil_tmp6 = g_utf8_validate(data___0, (gssize )bytes, (gchar **)((void *)0));
  }
#line 454
  if (! __cil_tmp6) {
    {
#line 455
    MSG(4, "Voxin: Input is not valid utf-8.");
#line 457
    message = g_convert(data___0, (gssize )bytes, (gchar *)"utf-8V", (gchar *)"iso-8859-1",
...
#line 460
    if (message == (void *)0) {
      {
#line 461
      MSG(4, "Voxin: Fallback conversion to utf-8 failed.");
#line 462
      module_speak_error();
      }
#line 463
    ...
    {
#line 466
    message = g_strndup(data___0, bytes);
    }
  }
#line 469
...
#line 470
  if ((unsigned int )msgtype == 0U) {
#line 470
    if ((unsigned int )msg_settings.spelling_mode == 1U) {
#line 472
      message_type = (SPDMessageType )99;
    }
  }
  {
#line 475
  while (1) {
    ...
    {
#line 475
    __cil_tmp9 = strcmp((char const   *)msg_settings_old.voice.language, (char const   *)msg_settings.voice.language);
    }
#line 475
...
#line 475
        set_language(msg_settings.voice.language);
        }
      }
    } else
#line 475
...
#line 476
      set_voice_type(msg_settings.voice_type);
      }
    }
#line 476
    goto while_break___0;
...
#line 477
  while (1) {
    ...
    {
#line 477
    __cil_tmp11 = strcmp((char const   *)msg_settings_old.voice.name, (char const   *)msg_settings.voice.name);
    }
#line 477
...
#line 477
        set_synthesis_voice(msg_settings.voice.name);
        }
      }
    } else
#line 477
...
#line 486
    tmp = message;
#line 487
    message = module_strip_ssml((char const   *)message);
#line 488
    g_free(tmp);
#line 490
    tmp = g_convert_with_fallback(message, (gssize )(- 1), input_encoding, (gchar *)"utf-8",
                                  (gchar *)"?", (gsize *)((void *)0), (gsize *)((void *)0),
                                  (GError **)((void *)0));
    }
#line 494
    if (tmp != (void *)0) {
...
#line 512
  ...
  {
#line 514
  MSG(4, "Voxin: Leaving module_speak_sync() normally.\220");
  }
  return;
}
}
#line 517 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
int module_stop(void) 
{ 
...
#line 526 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
size_t module_pause(void) 
{ 
...
#line 542 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
int module_close(void) 
{ 
...
#line 548
  ...
  {
#line 550
  MSG(4, "Voxin: Stopping speech");
#line 551
  module_stop();
#line 553
  MSG(4, "Voxin: De-registering ECI callback.");
#line 554
  eciRegisterCallback(eciHandle, (ECICallback )((void *)0), (void *)0);
#line 556
  MSG(4, "Voxin: Destroying ECI instance.");
#line 557
  eciDelete(eciHandle);
#line 558
  eciHandle = (ECIHand )0;
...
#line 566
    index_mark_ht = (GHashTable *)((void *)0);
    }
  }
  {
#line 569
...
#line 578 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void update_sample_rate(void) 
{ 
  int sample_rate ;
  int __cil_tmp2 ;
  ...
  {
#line 583
  sample_rate = eciGetParam(eciHandle, (enum ECIParam )5);
  }
  {
#line 585
  if (sample_rate == 0) {
...
#line 593
  ...
  {
#line 595
  MSG(4, "Voxin: Invalid audio sample rate returned by ECI = %i", sample_rate);
  }
  switch_break: /* CIL Label */ ;
  }
  {
#line 598
  MSG(4, "Voxin: LEAVE %s, eci_sample_rate=%d", "update_sample_rate", eci_sample_rate);
  }
  return;
}
}
#line 605 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *extract_mark_name(char *mark ) 
{ 
  unsigned long __cil_tmp2 ;
  char *tail ;
  ...
  {
#line 607
  __cil_tmp2 = strlen((char const   *)mark);
  }
#line 607
  if (16UL > __cil_tmp2) {
#line 608
...
#line 609
  mark += 12;
#line 610
  __cil_tmp4 = strstr((char const   *)mark, "\"/>");
#line 610
  tail = __cil_tmp4;
  }
#line 611
...
#line 614
  ...
  {
#line 615
  __cil_tmp6 = g_strndup(mark, (gsize )(tail - mark));
  }
#line 615
  return ((char *)__cil_tmp6);
}
}
#line 626 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *next_part(char *msg , char **mark_name ) 
{ 
  char *mark_head ;
  char *__cil_tmp4 ;
  ...
  {
#line 628
  __cil_tmp4 = strstr((char const   *)msg, "<mark name=\"");
#line 628
  mark_head = __cil_tmp4;
  }
#line 629
  if ((void *)0 == mark_head) {
    {
#line 630
    mark_head = strstr((char const   *)msg, "<mark name=\'");
    }
  }
#line 631
  if ((void *)0 == mark_head) {
...
#line 635
    if ((void *)0 == *mark_name) {
      {
#line 637
      MSG(4, "Voxin: Note: ill-formed mark %s", msg);
#line 638
      __cil_tmp9 = strstr((char const   *)(msg + 12), ">");
#line 638
      tail = __cil_tmp9;
      }
#line 639
...
#line 643
      tail += __cil_tmp11;
#line 644
      __cil_tmp13 = next_part(tail, mark_name);
#line 644
      remainder = __cil_tmp13;
#line 645
      __cil_tmp15 = g_strdup_printf((gchar *)"%.*s%s", (int )(tail - msg), msg, remainder);
#line 645
      ret = __cil_tmp15;
#line 647
      g_free(remainder);
...
#line 648
      ...
      {
#line 651
      __cil_tmp16 = strlen((char const   *)*mark_name);
#line 651
      __cil_tmp17 = g_strndup(msg, (12UL + __cil_tmp16) + 3UL);
      }
#line 651
      return ((char *)__cil_tmp17);
    }
  } else {
    {
#line 656
    __cil_tmp18 = g_strndup(msg, (gsize )(mark_head - msg));
    }
#line 656
...
#line 659 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
...
#line 662
  if ((void *)0 != mark_name) {
    {
#line 664
    __cil_tmp5 = g_malloc(sizeof(int ));
#line 664
    markId = (int *)__cil_tmp5;
#line 665
    __cil_tmp6 = g_hash_table_size(index_mark_ht);
#line 665
    *markId = (int )(1U + __cil_tmp6);
#line 666
    g_hash_table_insert(index_mark_ht, markId, mark_name);
#line 667
    __cil_tmp7 = eciInsertIndex(eciHandle, *markId);
    }
#line 667
    if (! __cil_tmp7) {
      {
#line 668
      MSG(4, "Voxin: Error sending index mark to synthesizer.");
#line 669
      log_eci_error();
      }
    } else {
      {
#line 672
      MSG(4, "Voxin: Index mark |%s| (id %i) sent to synthesizer.", mark_name, *markId);
      }
    }
#line 673
    return (0);
...
#line 677
  if (part_len > 0) {
    {
#line 678
    MSG(4, "Voxin: Returned %d bytes from get_part.", part_len);
#line 679
    MSG(4, "Voxin: Text to synthesize is |%s|", part);
#line 680
    MSG(4, "Voxin: Sending text to synthesizer.");
#line 681
    __cil_tmp8 = eciAddText(eciHandle, part);
    }
#line 681
    if (! __cil_tmp8) {
      {
#line 682
      MSG(4, "Voxin: Error sending text.");
#line 683
      log_eci_error();
      }
#line 684
...
#line 686
  ...
  {
#line 690
  MSG(4, "Voxin: End of data in synthesis.");
#line 695
  eciInsertIndex(eciHandle, 0);
#line 696
  MSG(4, "Voxin: Trying to synthesize text.");
#line 697
  __cil_tmp9 = eciSynthesize(eciHandle);
  }
#line 697
  if (! __cil_tmp9) {
    {
#line 698
    MSG(4, "Voxin: Error synthesizing.");
#line 699
    log_eci_error();
    }
#line 700
  ...
  {
#line 704
  MSG(4, "Voxin: Waiting for synthesis to complete.");
#line 705
  __cil_tmp10 = eciSynchronize(eciHandle);
  }
#line 705
  if (! __cil_tmp10) {
    {
#line 706
    MSG(4, "Voxin: Error waiting for synthesis to complete.");
#line 707
    log_eci_error();
    }
#line 708
  ...
  {
#line 710
  MSG(4, "Voxin: Synthesis complete.");
  }
#line 711
  return (3);
}
}
#line 715 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void _synth(char *message , SPDMessageType message_type ) 
{ 
  char *pos ;
  char *part ;
...
#line 728
  ...
  {
#line 729
  index_mark_ht = g_hash_table_new_full(& g_int_hash, & g_int_equal, & g_free, & g_free);
#line 733
  pos = message;
#line 734
  ...
  {
#line 737
  if ((unsigned int )message_type == (unsigned int )0) {
#line 737
    goto case_0;
  }
#line 740
  if ((unsigned int )message_type == (unsigned int )1) {
#line 740
    goto case_1;
  }
#line 752
  if ((unsigned int )message_type == (unsigned int )2) {
#line 752
    goto case_2;
  }
#line 756
  if ((unsigned int )message_type == (unsigned int )3) {
#line 756
    goto case_3;
  }
#line 766
  if ((unsigned int )message_type == (unsigned int )99) {
#line 766
    goto case_99;
  }
#line 736
  ...
  {
#line 738
  eciSetParam(eciHandle, (enum ECIParam )2, 0);
  }
#line 739
  goto switch_break;
  case_1: /* CIL Label */ 
  {
#line 744
  part = search_for_sound_icon((char const   *)message);
  }
#line 745
  if ((void *)0 != part) {
    {
...
#line 751
  ...
  {
#line 753
  eciSetParam(eciHandle, (enum ECIParam )2, 2);
  }
#line 755
  goto switch_break;
  case_3: /* CIL Label */ 
  {
#line 759
  MSG(4, "Voxin: Key from Speech Dispatcher: |%s|", pos);
  }
  {
#line 760
  pos = subst_keys(pos);
#line 761
  MSG(4, "Voxin: Key to speak: |%s|", pos);
#line 762
  g_free(message);
#line 763
  message = pos;
...
#line 765
  ...
  case_99: /* CIL Label */ 
#line 767
  if (1U != (unsigned int )msg_settings.punctuation_mode) {
    {
#line 768
    eciSetParam(eciHandle, (enum ECIParam )2, 2);
    }
    ...
    {
#line 771
    eciSetParam(eciHandle, (enum ECIParam )2, 1);
    }
  }
#line 773
  goto switch_break;
...
#line 776
  if (! IbmttsUseSSML) {
    {
#line 778
    __cil_tmp12 = strlen((char const   *)pos);
#line 778
    process_text_mark(pos, (int )__cil_tmp12, (char *)((void *)0));
#line 779
    process_text_mark((char *)((void *)0), 0, (char *)((void *)0));
    }
#line 780
    return;
  }
...
#line 789
    if (stop_requested) {
      ...
      {
#line 790
      MSG(4, "Voxin: Stop in synthesis, terminating.");
      }
      }
#line 791
      goto while_break;
...
#line 791
    ...
    {
#line 803
    __cil_tmp13 = strlen("<speak>");
#line 803
    __cil_tmp14 = strncmp((char const   *)pos, "<speak>", __cil_tmp13);
    }
#line 803
    if (! __cil_tmp14) {
      {
#line 804
      MSG(4, "Voxin: Drop heading <speak>.\220");
#line 805
      __cil_tmp15 = strlen("<speak>");
      }
#line 805
      pos += __cil_tmp15;
    }
...
#line 809
    if ((void *)0 == part) {
      {
#line 810
      MSG(4, "Voxin: Error getting next part of message.");
      }
#line 812
      goto while_break;
    }
    {
#line 814
    __cil_tmp17 = strlen((char const   *)part);
#line 814
    part_len = (int )__cil_tmp17;
#line 815
    __cil_tmp19 = strlen("</speak>\220");
    }
    {
#line 815
    __cil_tmp20 = strlen("</speak>\220");
#line 815
    __cil_tmp21 = strncmp((char const   *)((part + part_len) - __cil_tmp19), "</speak>\230",
                          __cil_tmp20);
    }
    {
#line 815
    __cil_tmp18 = strlen("</speak>\220");
    }
#line 815
    if ((unsigned long )part_len >= __cil_tmp18) {
#line 815
      if (! __cil_tmp21) {
        {
#line 818
        MSG(4, "Voxin: Drop trailing </speak>.");
#line 819
        __cil_tmp22 = strlen("</speak>\220");
#line 819
        part_skip_end = (int )__cil_tmp22;
#line 820
        *(part + (part_len - part_skip_end)) = (char )0;
        }
      } else {
#line 822
        part_skip_end = 0;
...
#line 824
    pos += part_len;
#line 825
    ret = process_text_mark(part, part_len - part_skip_end, mark_name);
#line 828
    g_free(part);
#line 829
    part = (char *)((void *)0);
...
#line 831
    if (ret == 1) {
      {
#line 832
      __cil_tmp24 = strlen((char const   *)pos);
      }
#line 832
      pos += __cil_tmp24;
    } else
#line 833
    if (ret > 1) {
      {
#line 834
      MSG(4, "Voxin: Finished synthesis.");
      }
#line 835
      goto while_break;
    }
...
#line 840 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_rate(int rate ) 
{ 
  int tmp ;
  int speed ;
  ...
  {
#line 842
  MSG(4, "Voxin: ENTER %s+OV", "set_rate\312\001@");
  }
#line 849
  if (rate < 0) {
#line 851
    speed = (int )(((float )(rate + 100) * (float )voice_speed) / (float )100);
  } else {
#line 854
    speed = (int )(((float )rate * (float )(140 - voice_speed)) / (float )100 + (float )voice_speed);
  }
  {
#line 858
  __cil_tmp6 = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )6, speed);
#line 858
  ret = __cil_tmp6;
  }
#line 859
  if (-1 == ret) {
    {
#line 860
    MSG(4, "Voxin: Error setting rate %i.\270\231+OV", speed);
#line 861
    log_eci_error();
    }
  } else {
    {
#line 863
    MSG(4, "Voxin: Rate set to %i.", speed);
    }
  }
  return;
}
}
#line 866 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_volume(int volume ) 
{ 
  int tmp ;
  int vol ;
  ...
  {
#line 868
  MSG(4, "Voxin: ENTER %s+OV", "set_volume\231+OV");
  }
#line 876
  if (volume < 0) {
#line 878
    vol = (int )((((float )volume + (float )100) * (float )90) / (float )100);
  } else {
#line 881
    vol = (int )((float )(volume * 10) / (float )100 + (float )90);
  }
  {
#line 883
  __cil_tmp6 = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )7, vol);
#line 883
  ret = __cil_tmp6;
  }
#line 884
  if (-1 == ret) {
    {
#line 885
    MSG(4, "Voxin: Error setting volume %i.", vol);
#line 886
    log_eci_error();
    }
  } else {
    {
#line 888
    MSG(4, "Voxin: Volume set to %i.", vol);
    }
  }
  return;
}
}
#line 891 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_pitch(int pitch ) 
{ 
  int tmp ;
  int pitchBaseline ;
  ...
  {
#line 893
  MSG(4, "Voxin: ENTER %s", "set_pitch");
  }
#line 900
  if (pitch < 0) {
#line 902
    pitchBaseline = (int )(((float )(pitch + 100) * (float )voice_pitch_baseline) / (float )100);
  } else {
#line 907
    pitchBaseline = (int )(((float )pitch * (float )(100 - voice_pitch_baseline)) / (float )100 + (float )voice_pitch_baseline);
  }
  {
#line 912
  __cil_tmp6 = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )2, pitchBaseline);
#line 912
  ret = __cil_tmp6;
  }
#line 914
  if (-1 == ret) {
    {
#line 915
    MSG(4, "Voxin: Error setting pitch %i.", pitchBaseline);
#line 916
    log_eci_error();
    }
  } else {
    {
#line 918
    MSG(4, "Voxin: Pitch set to %i.", pitchBaseline);
    }
  }
  return;
}
}
#line 921 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_punctuation_mode(SPDPunctuation punct_mode ) 
{ 
  char const   *fmt ;
  char *msg ;
  ...
  {
#line 923
  MSG(4, "Voxin: ENTER %s", "set_punctuation_mode");
#line 924
  fmt = " `Pf%d%s ";
#line 925
  msg = (char *)((void *)0);
...
#line 953 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_capital_mode(SPDCapitalLetters cap_mode ) 
{ 
  voxCapitalMode mode ;
  ...
  {
#line 955
  MSG(4, "Voxin: ENTER %s", "set_capital_mode\312\001@");
#line 956
  mode = (voxCapitalMode )0;
  }
  {
#line 959
...
#line 961
  ...
  case_1: /* CIL Label */ 
#line 963
  mode = (voxCapitalMode )2;
#line 964
  goto switch_break;
  case_2: /* CIL Label */ 
#line 966
  mode = (voxCapitalMode )1;
#line 967
  goto switch_break;
  switch_break: /* CIL Label */ ;
  }
  {
#line 970
  voxSetParam(eciHandle, (voxParam )17, (int )mode);
  }
  return;
}
}
#line 976 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *voice_enum_to_str(SPDVoiceType voice_type ) 
{ 
  char *voicename ;
  gchar *__cil_tmp3 ;
  ...
  {
#line 978
  MSG(4, "Voxin: ENTER %s", "voice_enum_to_str");
  }
  {
#line 982
  if ((int )voice_type == 1) {
...
#line 1006
  ...
  {
#line 983
  voicename = g_strdup((gchar *)"male1");
  }
#line 984
  goto switch_break;
  case_2: /* CIL Label */ 
  {
#line 986
  voicename = g_strdup((gchar *)"male2");
  }
#line 987
  goto switch_break;
  case_3: /* CIL Label */ 
  {
#line 989
  voicename = g_strdup((gchar *)"male3");
  }
#line 990
  goto switch_break;
  case_4: /* CIL Label */ 
  {
#line 992
  voicename = g_strdup((gchar *)"female1");
  }
#line 993
  goto switch_break;
  case_5: /* CIL Label */ 
  {
#line 995
  voicename = g_strdup((gchar *)"female2");
  }
#line 996
  goto switch_break;
  case_6: /* CIL Label */ 
  {
#line 998
  voicename = g_strdup((gchar *)"female3");
  }
#line 999
  goto switch_break;
  case_7: /* CIL Label */ 
  {
#line 1001
  voicename = g_strdup((gchar *)"child_male");
  }
#line 1002
  goto switch_break;
  case_8: /* CIL Label */ 
  {
#line 1004
  voicename = g_strdup((gchar *)"child_female");
  }
#line 1005
  goto switch_break;
  switch_default: /* CIL Label */ 
  {
#line 1007
  voicename = g_strdup((gchar *)"no voice\220");
  }
#line 1008
  goto switch_break;
  switch_break: /* CIL Label */ ;
...
#line 1014 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
...
{ 
  ...
  {
#line 1016
  __cil_tmp3 = voice_enum_to_str(voice_type);
#line 1016
  voicename = __cil_tmp3;
#line 1018
  ret = - 1;
#line 1020
  __cil_tmp7 = g_hash_table_lookup(IbmttsVoiceParameters, voicename);
#line 1020
  params = __cil_tmp7;
  }
#line 1021
  if ((void *)0 == params) {
    {
#line 1022
    MSG(4, "Voxin: Setting default VoiceParameters for voice %s", voicename);
    }
    {
#line 1025
    if ((int )voice_type == 1) {
...
#line 1052
    if (-1 == ret) {
      {
#line 1053
      MSG(4, "Voxin: ERROR: Setting default voice parameters (voice %i).", eciVoice);
      }
    }
  } else {
    {
#line 1055
    MSG(4, "Voxin: Setting custom VoiceParameters for voice %s", voicename);
#line 1057
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )0, params->gender);
    }
#line 1058
    if (-1 == ret) {
      {
#line 1059
      MSG(4, "Voxin: ERROR: Setting gender %i", params->gender);
      }
    }
    {
#line 1061
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )5, params->breathiness);
    }
#line 1062
    if (-1 == ret) {
      {
#line 1063
      MSG(4, "Voxin: ERROR: Setting breathiness %i\230\001", params->breathiness);
      }
    }
    {
#line 1065
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )1, params->head_size);
    }
#line 1066
    if (-1 == ret) {
      {
#line 1067
      MSG(4, "Voxin: ERROR: Setting head size %i", params->head_size);
      }
    }
    {
#line 1069
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )2, params->pitch_baseline);
    }
#line 1070
    if (-1 == ret) {
      {
#line 1071
      MSG(4, "Voxin: ERROR: Setting pitch baseline %i", params->pitch_baseline);
      }
    }
    {
#line 1073
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )3, params->pitch_fluctuation);
    }
#line 1074
    if (-1 == ret) {
      {
#line 1075
      MSG(4, "Voxin: ERROR: Setting pitch fluctuation %i", params->pitch_fluctuation);
      }
    }
    {
#line 1077
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )4, params->roughness);
    }
#line 1078
    if (-1 == ret) {
      {
#line 1079
      MSG(4, "Voxin: ERROR: Setting roughness %i", params->roughness);
      }
    }
    {
#line 1081
    ret = eciSetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )6, params->speed);
    }
#line 1082
    if (-1 == ret) {
      {
#line 1083
      MSG(4, "Voxin: ERROR: Setting speed %i", params->speed);
      }
    }
  }
  {
...
#line 1125 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_language_and_voice(char *lang , SPDVoiceType voice_type , char *name ) 
{ 
  int ret ;
  int i ;
  ...
  {
#line 1127
  MSG(4, "Voxin: ENTER %s", "set_language_and_voice");
#line 1128
  ret = - 1;
#line 1129
  i = 0;
...
#line 1131
  ...
  {
#line 1131
  MSG(4, "Voxin: %s, lang=%s, voice_type=%d, name=%s", "set_language_and_voice", lang,
      (int )voice_type, (int )tmp);
  }
#line 1136
  if (name) {
#line 1136
...
#line 1137
        ...
        {
#line 1138
        MSG(4, "%d. name=%s", i, (*(speechd_voice + i))->name);
#line 1139
        __cil_tmp9 = strcasecmp((char const   *)(*(speechd_voice + i))->name, (char const   *)name);
        }
#line 1139
        if (! __cil_tmp9) {
#line 1140
...
#line 1146
    if (index___8 == -1) {
      {
#line 1148
      __cil_tmp13 = strchr((char const   *)lang, '-');
#line 1148
      dash = __cil_tmp13;
      }
#line 1149
      if (dash) {
        {
#line 1150
        langbase = g_strndup(lang, (gsize )((dash - lang) + 1L));
        }
      } else {
        {
#line 1152
        langbase = g_strdup_printf((gchar *)"%s-", lang);
        }
      }
#line 1154
      i = 0;
...
#line 1154
        ...
        {
#line 1155
        MSG(4, "%d. language=%s", i, (*(speechd_voice + i))->language);
#line 1156
        __cil_tmp16 = strcasecmp((char const   *)(*(speechd_voice + i))->language,
                                 (char const   *)lang);
        }
#line 1156
        if (! __cil_tmp16) {
...
#line 1161
        if (index___8 == -1) {
          {
#line 1163
          __cil_tmp17 = strlen((char const   *)langbase);
#line 1163
          __cil_tmp18 = strncasecmp((char const   *)(*(speechd_voice + i))->language,
                                    (char const   *)langbase, __cil_tmp17);
          }
#line 1163
          if (! __cil_tmp18) {
            {
...
#line 1175
  ...
  {
#line 1179
  ret = eciSetParam(eciHandle, (enum ECIParam )9, (int )(voices + index___8)->id);
  }
#line 1183
  if (ret == -1) {
    {
#line 1184
    MSG(4, "Voxin: Unable to set language");
#line 1185
    log_eci_error();
    }
#line 1186
  ...
  {
#line 1190
  MSG(4, "Voxin: select speechd_voice[%d]: id=0x%x, name=%s (ret=%d)", index___8,
      (voices + index___8)->id, (char *)(voices + index___8)->name, ret);
#line 1193
  input_encoding = (char *)(voices + index___8)->charset;
#line 1200
  update_sample_rate();
#line 1203
  set_voice_parameters(voice_type);
#line 1206
  voice_pitch_baseline = eciGetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )2);
  }
#line 1207
  if (-1 == voice_pitch_baseline) {
    {
#line 1208
    MSG(4, "Voxin: Cannot get pitch baseline of voice.");
    }
  }
  {
#line 1210
  voice_speed = eciGetVoiceParam(eciHandle, 0, (enum ECIVoiceParam )6);
  }
#line 1211
  if (-1 == voice_speed) {
    {
#line 1212
    MSG(4, "Voxin: Cannot get speed of voice.");
    }
  }
  return;
}
}
#line 1215 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_voice_type(SPDVoiceType voice_type ) 
{ 
  ...
  {
#line 1217
  MSG(4, "Voxin: ENTER %s", "set_voice_type");
  }
#line 1218
...
#line 1223 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_language(char *lang ) 
{ 
  ...
  {
#line 1225
  MSG(4, "Voxin: ENTER %s", "set_language");
#line 1226
...
#line 1234 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void set_synthesis_voice(char *synthesis_voice ) 
{ 
...
#line 1237
  ...
  {
#line 1240
  MSG(4, "Voxin: ENTER %s(%s)", "set_synthesis_voice", synthesis_voice);
#line 1242
...
#line 1245 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void log_eci_error(void) 
{ 
  char buf[100] ;
  ...
  {
#line 1247
  MSG(4, "Voxin: ENTER %s", "log_eci_error");
#line 1250
  eciErrorMessage(eciHandle, (char *)buf);
#line 1251
  MSG(4, "Voxin: ECI Error Message: %s\230\001", (char *)buf);
  }
  return;
}
}
#line 1258 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static enum ECICallbackReturn eciCallback(ECIHand hEngine , enum ECIMessage msg ,
                                          long lparam , void *data___0 ) 
{ 
...
#line 1263
  if (stop_requested) {
    ...
    {
#line 1264
    MSG(4, "Voxin: Stopped or paused, stop synthesizing.\220");
    }
    }
#line 1265
    return ((enum ECICallbackReturn )2);
  } else
#line 1263
  if (pause_requested) {
#line 1263
...
#line 1265
  ...
  {
#line 1269
  if ((unsigned int )msg == (unsigned int )0) {
#line 1269
    goto case_0;
  }
#line 1275
  if ((unsigned int )msg == (unsigned int )2) {
#line 1275
    goto case_2;
  }
#line 1283
  ...
  {
#line 1270
  MSG(4, "Voxin: %ld audio samples returned from TTS.", lparam);
  }
  {
#line 1272
...
#line 1273
  return ((enum ECICallbackReturn )1);
  case_2: /* CIL Label */ 
  {
#line 1276
  MSG(4, "Voxin: Index mark id %ld returned from TTS.", lparam);
  }
#line 1277
  if (lparam != 0L) {
    {
...
#line 1289 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean add_audio_to_playback_queue(TEciAudioSamples *audio_chunk___0 , long num_samples ) 
{ 
  AudioTrack track ;
  AudioFormat format ;
  ...
  {
#line 1291
  MSG(4, "Voxin: ENTER %s", "add_audio_to_playback_queue");
#line 1292
  track.bits = 16;
  }
#line 1292
...
#line 1292
  track.num_samples = (int )num_samples;
  {
#line 1292
  track.samples = audio_chunk___0;
#line 1302
...
#line 1310 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void add_mark_to_playback_queue(long markId ) 
{ 
  char *mark_name ;
  gpointer __cil_tmp3 ;
  ...
  {
#line 1312
  MSG(4, "Voxin: ENTER %s", "add_mark_to_playback_queue");
#line 1315
  __cil_tmp3 = g_hash_table_lookup(index_mark_ht, & markId);
#line 1315
  mark_name = __cil_tmp3;
  }
#line 1316
  if ((void *)0 == mark_name) {
    {
#line 1317
    MSG(4, "Voxin: markId %ld returned by TTS not found in lookup table.\230\001",
        markId);
    }
#line 1318
    return;
  ...
  {
#line 1320
  MSG(4, "Voxin: reporting index mark |%s|.", mark_name);
#line 1321
  module_report_index_mark((char const   *)mark_name);
#line 1322
  __cil_tmp4 = strncmp((char const   *)mark_name, "__spd_", (unsigned long )6);
  }
#line 1322
  if (pause_requested) {
#line 1322
...
#line 1323
  ...
  {
#line 1324
  MSG(4, "Voxin: index mark reported.");
  }
  return;
}
}
#line 1328 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean add_sound_icon_to_playback_queue(char *filename ) 
{ 
  ...
  {
#line 1330
  module_report_icon((char const   *)filename);
  }
#line 1331
  return (0);
}
}
#line 1336 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static int replace(char *from , char *to , GString *msg ) 
{ 
  int count ;
  int pos ;
  ...
  {
#line 1338
  MSG(4, "Voxin: ENTER %s", "replace");
#line 1339
  count = 0;
#line 1341
  __cil_tmp7 = strlen((char const   *)from);
#line 1341
  from_len = (int )__cil_tmp7;
#line 1342
  __cil_tmp9 = strlen((char const   *)to);
#line 1342
  to_len = (int )__cil_tmp9;
#line 1343
  p = msg->str;
  }
  {
#line 1344
  while (1) {
    ...
    {
#line 1344
    p = strstr((char const   *)p, (char const   *)from);
    }
#line 1344
    if (! ((void *)0 != p)) {
#line 1344
...
#line 1345
    pos = (int )(p - msg->str);
#line 1346
    g_string_erase(msg, (gssize )pos, (gssize )from_len);
#line 1347
    g_string_insert(msg, (gssize )pos, to);
#line 1348
...
#line 1354 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void subst_keys_cb(gpointer data___0 , gpointer user_data ) 
{ 
  TIbmttsKeySubstitution *key_subst ;
  GString *msg ;

  {
  {
#line 1356
  MSG(4, "Voxin: ENTER %s", "subst_keys_cb");
#line 1357
  key_subst = data___0;
#line 1358
  msg = user_data;
...
#line 1367 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *subst_keys(char *key ) 
{ 
  GString *tmp ;
  GString *__cil_tmp3 ;
  ...
  {
#line 1369
  MSG(4, "Voxin: ENTER %s", "subst_keys");
#line 1370
  __cil_tmp3 = g_string_sized_new((gsize )30);
#line 1370
  tmp = __cil_tmp3;
#line 1371
  g_string_append(tmp, key);
#line 1373
  __cil_tmp5 = g_hash_table_lookup(IbmttsKeySubstitution, msg_settings.voice.language);
#line 1373
  keyTable = __cil_tmp5;
  }
#line 1376
...
#line 1377
  ...
  {
#line 1380
  __cil_tmp6 = strcmp((char const   *)tmp->str, "-");
  }
#line 1380
  if (0 == __cil_tmp6) {
    {
#line 1381
    g_string_assign(tmp, (gchar *)"hyphen");
    }
  }
  {
#line 1383
  __cil_tmp7 = g_string_free(tmp, 0);
  }
#line 1383
  return (__cil_tmp7);
}
}
#line 1395 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static char *search_for_sound_icon(char const   *icon_name ) 
{ 
  char *fn ;
  unsigned long __cil_tmp3 ;
  ...
  {
#line 1397
  MSG(4, "Voxin: ENTER %s", "search_for_sound_icon");
#line 1398
  fn = (char *)((void *)0);
#line 1399
  __cil_tmp3 = strlen((char const   *)IbmttsSoundIconFolder);
  }
#line 1399
  if (0UL == __cil_tmp3) {
#line 1400
  ...
  {
#line 1401
  __cil_tmp5 = g_string_new(IbmttsSoundIconFolder);
#line 1401
  filename = __cil_tmp5;
#line 1402
  filename = g_string_append(filename, icon_name);
#line 1403
  __cil_tmp7 = g_file_test(filename->str, (GFileTest )16);
  }
#line 1403
  if (__cil_tmp7) {
#line 1404
  ...
  {
#line 1421
  g_string_free(filename, fn == (void *)0);
  }
#line 1422
  return (fn);
}
}
#line 1426 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
...
{ 
  ...
  {
#line 1428
  MSG(4, "Voxin: ENTER %s", "vox_to_spd_voice\312\001@");
  }
#line 1429
  if (! from) {
    {
...
#line 1429
  if ((int )from->name[sizeof(from->name) - 1UL]) {
    {
    {
    {
    {
...
#line 1429
  if ((int )from->lang[sizeof(from->lang) - 1UL]) {
    {
    {
    {
    {
...
#line 1429
  if ((int )from->variant[sizeof(from->variant) - 1UL]) {
    {
    {
    {
    {
...
#line 1442
  if ((int )*((char *)from->quality)) {
    {
#line 1442
    __cil_tmp4 = g_strdup_printf((gchar *)"%s-%s", (char *)from->name, (char *)from->quality);
#line 1442
    tmp = __cil_tmp4;
    }
  } else {
    {
#line 1442
    __cil_tmp5 = g_strdup((char *)from->name);
#line 1442
    tmp = __cil_tmp5;
    }
  }
...
#line 1450
  if (*((char *)from->variant)) {
    {
#line 1451
    __cil_tmp9 = strlen((char const   *)((char *)from->lang));
#line 1451
    len = __cil_tmp9;
#line 1453
    to->language = g_strdup_printf((gchar *)"%s-%s", (char *)from->lang, (char *)from->variant);
#line 1454
    i___0 = (int )len;
    }
    {
#line 1454
    while (1) {
      while_continue___0: /* CIL Label */ ;
#line 1454
      if (! *(to->language + i___0)) {
#line 1454
        goto while_break___0;
      }
#line 1455
      *(to->language + i___0) = (char )0;
#line 1454
      i___0 ++;
    }
    while_break___0: /* CIL Label */ ;
    ...
    {
#line 1458
    to->language = g_strdup((char *)from->lang);
    }
  }
  {
#line 1461
  to->variant = g_strdup((gchar *)"none");
#line 1464
  size = (size_t )0;
#line 1465
  __cil_tmp16 = voxToString(from, (char *)((void *)0), & size);
  }
#line 1465
  if (! __cil_tmp16) {
    {
#line 1466
    __cil_tmp18 = g_malloc0(size);
#line 1466
    str = __cil_tmp18;
#line 1467
    __cil_tmp19 = voxToString(from, str, & size);
    }
#line 1467
    if (! __cil_tmp19) {
      {
#line 1468
      MSG(4, "Voxin: from: %s", str);
      }
    }
    {
#line 1470
  ...
  {
#line 1473
  MSG(4, "Voxin: to: name=%s, variant=%s, language=%s", to->name, to->variant, to->language);
  }
#line 1474
  return (! 0);
}
}
#line 1477 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static gboolean alloc_voice_list(void) 
{ 
  int i ;
  int __cil_tmp2 ;
  ...
  {
#line 1479
  MSG(4, "Voxin: ENTER %s", "alloc_voice_list\312\001@");
#line 1480
  i = 0;
#line 1483
  number_of_voices = (unsigned int )0;
#line 1484
  __cil_tmp2 = voxGetVoices((vox_t *)((void *)0), & number_of_voices);
  }
#line 1484
  if (__cil_tmp2) {
#line 1485
...
#line 1488
  voices = (vox_t *)0;
#line 1489
  __cil_tmp3 = voxGetVoices(voices, & number_of_voices);
  }
#line 1489
  if (__cil_tmp3) {
#line 1490
...
#line 1490
  ...
  {
#line 1492
  MSG(4, "Voxin: number_of_voices=%u", number_of_voices);
#line 1495
  speechd_voice = (SPDVoice **)0;
#line 1496
  i = 0;
  }
  {
#line 1496
  while (1) {
    while_continue: /* CIL Label */ ;
#line 1496
    if (! ((unsigned int )i < number_of_voices)) {
#line 1496
      goto while_break;
    }
    {
#line 1497
    *(speechd_voice + i) = (SPDVoice *)g_malloc0(sizeof(SPDVoice ));
#line 1498
    __cil_tmp5 = vox_to_spd_voice(voices + i, *(speechd_voice + i));
    }
#line 1498
    if (! __cil_tmp5) {
#line 1499
...
#line 1501
  *(speechd_voice + number_of_voices) = (SPDVoice *)((void *)0);
#line 1503
  i = 0;
  {
#line 1503
...
#line 1504
      tmp___0 = (*(speechd_voice + i))->language;
    } else {
#line 1504
      tmp___0 = (char *)"null";
    }
...
#line 1504
      tmp___1 = (*(speechd_voice + i))->variant;
    } else {
#line 1504
      tmp___1 = (char *)"nullOV";
    }
    {
#line 1504
    MSG(4, "Voxin: speechd_voice[%d]:name=%s, language=%s, variant=%s", i, (int )tmp,
...
#line 1503
  ...
  {
#line 1511
  MSG(4, "Voxin: LEAVE %s+OV", "alloc_voice_list\312\001\300+\206\317\n");
  }
#line 1512
  return (! 0);
  exit0: 
...
#line 1568 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void free_voice_list(void) 
{ 
  int i ;
  int __cil_tmp2 ;
  ...
  {
#line 1570
  MSG(4, "Voxin: ENTER %s", "free_voice_list");
#line 1571
  i = 0;
  }
#line 1580
...
#line 1587
      (*(speechd_voice + i))->name = (char *)((void *)0);
      }
    }
#line 1589
    if ((*(speechd_voice + i))->language) {
...
#line 1591
      (*(speechd_voice + i))->language = (char *)((void *)0);
      }
    }
#line 1593
    if ((*(speechd_voice + i))->variant) {
...
#line 1595
      (*(speechd_voice + i))->variant = (char *)((void *)0);
      }
    }
    {
#line 1598
...
#line 1599
    *(speechd_voice + i) = (SPDVoice *)((void *)0);
    }
#line 1583
    i ++;
  }
...
#line 1603
  speechd_voice = (SPDVoice **)((void *)0);
  }
  return;
}
}
#line 1606 "/root/patron-artifact/pkg/i_files/speech-dispatcher-ibmtts_tmp/speech-dispatcher-contrib-0.11.1/src/modules/ibmtts.c"
static void load_user_dictionary(void) 
{ 
  GString *dirname ;
  GString *filename ;
  int i ;
  int dictionary_is_present ;
  static guint old_index ;
  guint new_index ;
  char *language ;
  char *region ;
  ECIDictHand eciDict ;
  ECIDictHand __cil_tmp10 ;
  gchar *__cil_tmp11 ;
  ECIDictHand __cil_tmp12 ;
  GString *__cil_tmp13 ;
  gboolean __cil_tmp14 ;
  ...
  enum ECIDictError __cil_tmp20 ;
  int __cil_tmp21 ;

  {
  {
#line 1608
  MSG(4, "Voxin: ENTER %s", "load_user_dictionaryOV");
#line 1609
  dirname = (GString *)((void *)0);
#line 1610
  filename = (GString *)((void *)0);
#line 1611
  i = 0;
#line 1612
  dictionary_is_present = 0;
#line 1613
  old_index = 4294967295U;
#line 1615
  language = (char *)((void *)0);
#line 1617
  region = (char *)((void *)0);
#line 1621
  __cil_tmp10 = eciGetDict(eciHandle);
#line 1621
  eciDict = __cil_tmp10;
#line 1623
  new_index = (guint )0;
...
#line 1624
  if (new_index >= number_of_voices) {
    {
#line 1625
    MSG(4, "Voxin: %s, unexpected index (0x%x)", "load_user_dictionary\363Z", new_index);
    }
#line 1627
    return;
  }
#line 1630
  if (old_index == new_index) {
    {
#line 1631
    MSG(4, "Voxin: LEAVE %s, no change", "load_user_dictionary\002");
    }
#line 1632
    return;
  }
  {
#line 1636
  language = g_strdup((char *)(voices + new_index)->lang);
#line 1637
  region = (char *)(voices + new_index)->variant;
  }
#line 1645
  if (eciDict) {
    {
#line 1646
    MSG(4, "Voxin: delete old dictionary\220");
#line 1647
...
#line 1654
    MSG(4, "Voxin: can\'t create new dictionary");
#line 1655
    g_free(language);
    }
#line 1656
  ...
  {
#line 1660
  dirname = g_string_new((gchar *)((void *)0));
#line 1662
  g_string_printf(dirname, (gchar *)"%s/%s_%s\230\001", IbmttsDictionaryFolder, language,
                  region);
#line 1664
  __cil_tmp14 = g_file_test(dirname->str, (GFileTest )4);
  }
#line 1664
  if (! __cil_tmp14) {
    {
#line 1665
    MSG(4, "Voxin: %s is not a directory\230\001", dirname->str);
#line 1667
    g_string_printf(dirname, (gchar *)"%s/%s\002", IbmttsDictionaryFolder, language);
#line 1675
    __cil_tmp15 = g_file_test(dirname->str, (GFileTest )4);
    }
#line 1675
    if (! __cil_tmp15) {
      {
#line 1676
      g_string_printf(dirname, (gchar *)"%s\001", IbmttsDictionaryFolder);
#line 1677
      __cil_tmp16 = g_file_test(dirname->str, (GFileTest )4);
      }
#line 1677
      if (! __cil_tmp16) {
        {
...
#line 1685
  g_free(language);
#line 1687
  MSG(4, "Voxin: Looking in dictionary directory %s\272\001", dirname->str);
#line 1688
  filename = g_string_new((gchar *)((void *)0));
#line 1690
  i = 0;
  }
  {
#line 1690
  while (1) {
    while_continue: /* CIL Label */ ;
#line 1690
    if (! ((unsigned long )i < sizeof(dictionary_filenames) / sizeof(dictionary_filenames[0]))) {
#line 1690
      goto while_break;
    }
    {
#line 1691
    g_string_printf(filename, (gchar *)"%s/%s", dirname->str, dictionary_filenames[i]);
#line 1693
    __cil_tmp18 = g_file_test(filename->str, (GFileTest )16);
    }
#line 1693
    if (__cil_tmp18) {
      {
#line 1694
      __cil_tmp20 = eciLoadDict(eciHandle, eciDict, (enum ECIDictVolume )i, filename->str);
#line 1694
      error = __cil_tmp20;
      }
#line 1696
...
#line 1698
        MSG(4, "Voxin: %s dictionary loaded", filename->str);
        }
      } else {
        {
#line 1701
        MSG(4, "Voxin: Can\'t load %s dictionary (%d)\230\001", filename->str, (unsigned int )error);
        }
      }
    } else {
      {
#line 1705
      MSG(4, "Voxin: No %s dictionary", filename->str);
      }
    }
#line 1690
    i ++;
