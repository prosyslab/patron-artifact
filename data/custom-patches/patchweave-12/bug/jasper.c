...
#line 10 "../original/patch/jasper.c"
struct jas_stream {
   int *fp ;
   int *dummy ;
};
#line 13 "../original/patch/jasper.c"
...
#line 15 "../original/patch/jasper.c"
...
{ 
  ...
  {
#line 16
  in->fp = (int *)fopen((char const   *)"dummy.c", (char const   *)"rb");
#line 17
  in->dummy = (int *)malloc((unsigned long )1028);
#line 18
  fread(in->dummy, (unsigned long )1028, (unsigned long )1, in->fp);
#line 19
  fclose(in->fp);
  }
  return;
...
#line 31
    ...
    {
#line 32
    __cil_tmp5 = jas_stream_getc(in);
#line 32
    buf[i] = (unsigned char )__cil_tmp5;
    }
#line 31
    i ++;
  }
...
#line 36
  magic = (((((uint_fast32_t )buf[0] << 24) | ((uint_fast32_t )buf[1] << 16)) | ((uint_fast32_t )buf[2] << 8)) | (unsigned long )buf[3]);
#line 41
  return (0);
}
}
#line 44 "../original/patch/jasper.c"
