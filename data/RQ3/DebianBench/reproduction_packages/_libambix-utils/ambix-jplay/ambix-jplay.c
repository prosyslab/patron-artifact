...
#line 127 "/usr/include/jack/thread.h"
typedef int (*jack_thread_creator_t)(pthread_t * , pthread_attr_t * , void *(*)(void * ) ,
                                     void * );
#line 23 "/usr/include/samplerate.h"
struct SRC_STATE_tag ;
#line 23 "/usr/include/samplerate.h"
typedef struct SRC_STATE_tag SRC_STATE;
#line 26 "/usr/include/samplerate.h"
...
#line 36 "/usr/include/samplerate.h"
typedef struct __anonstruct_250 SRC_DATA;
#line 47 "/usr/include/samplerate.h"
...
#line 46 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
struct player_opt {
   int buffer_frames ;
   int minimal_frames ;
...
#line 70 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
struct player {
   int buffer_bytes ;
   int buffer_samples ;
   float32_t *a_buffer ;
...
#line 130
  snprintf((char *)chunk_info.id, sizeof(chunk_info.id), "-T\346\"oU", id);
#line 131
...
#line 372
  snprintf((char *)chunk->id, sizeof(chunk->id), "-\230\346\"oU");
#line 373
...
#line 80
      ...
      {
#line 81
      printf("-\233 #oU", i, (char *)(ambix->markers + i)->name, (ambix->markers + i)->position);
      }
#line 80
      i ++;
    }
...
#line 114
  printf("-\245 #oU", ambix->adaptorbuffer);
#line 115
  printf("-\245 #oU", (int )ambix->adaptorbuffersize);
#line 116
  printf("-\243 #oU", ambix->ambisonics_order);
#line 117
  printf("-\276 #oU", ambix->num_markers);
#line 118
...
#line 129
  memset(& chunk_info, 0, sizeof(chunk_info));
#line 130
  snprintf((char *)chunk_info.id, sizeof(chunk_info.id), "-c\346#oU", id);
#line 131
  chunk_info.id_size = (unsigned int )4;
#line 133
  iterator = sf_get_chunk_iterator(file, & chunk_info);
...
#line 53 "/usr/include/jack/thread.h"
...
#line 91
int jack_client_create_thread(jack_client_t *client , jack_native_thread_t *thread ,
                              int priority , int realtime , void *(*start_routine)(void * ) ,
                              void *arg ) ;
#line 105
...
#line 55 "/usr/include/samplerate.h"
...
#line 113
char *src_get_description(int converter_type ) ;
#line 114
...
#line 177
void src_short_to_float_array(short *in , float *out , int len ) ;
#line 178
void src_float_to_short_array(float *in , short *out , int len ) ;
#line 180
void src_int_to_float_array(int *in , float *out , int len ) ;
#line 181
void src_float_to_int_array(float *in , int *out , int len ) ;
#line 59 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
static void interleave_data(float32_t *source1 , uint32_t source1channels , float32_t *source2 ,
                            uint32_t source2channels , float *destination , int64_t frames ) 
{ 
  int64_t frame ;
  uint32_t chan ;
  float *__cil_tmp9 ;
...
#line 95 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 101
    if (d->o.seek_request >= 0L) {
      {
#line 102
      __cil_tmp5 = ambix_seek(d->sound_file, (int64_t )d->o.seek_request, 0);
#line 102
      err = __cil_tmp5;
      }
#line 104
      if (err == -1L) {
        {
#line 105
        fprintf(stderr, "-", (long )d->o.seek_request);
        }
      }
#line 108
      d->o.seek_request = (int64_t )(- 1);
    }
    {
#line 113
    nbytes = (int )(((unsigned long )d->o.minimal_frames * sizeof(float )) * (unsigned long )d->channels);
#line 114
...
#line 118
    if (nbytes > d->buffer_bytes) {
      {
#line 120
      fprintf(stderr, "-", (int )nbytes, (int )d->buffer_bytes);
#line 121
...
#line 127
    nsamples = nframes * d->channels;
#line 128
    __cil_tmp11 = ambix_readf_float32(d->sound_file, d->a_buffer, d->e_buffer, (int64_t )nframes);
#line 128
    err___0 = __cil_tmp11;
    }
#line 132
...
#line 133
      if (d->o.transport_aware) {
        {
#line 134
        memset(d->a_buffer, 0, (unsigned long )(nframes * d->a_channels) * sizeof(float32_t ));
#line 135
        memset(d->e_buffer, 0, (unsigned long )(nframes * d->e_channels) * sizeof(float32_t ));
#line 136
        memset(d->d_buffer, 0, (unsigned long )nsamples * sizeof(float ));
#line 137
        err___0 = (int64_t )nframes;
        }
      } else {
#line 139
        return ((void *)0);
    ...
    {
#line 143
    interleave_data(d->a_buffer, (uint32_t )d->a_channels, d->e_buffer, (uint32_t )d->e_channels,
                    d->d_buffer, err___0);
#line 146
    jack_ringbuffer_write(d->rb, (char *)d->d_buffer, (size_t )(err___0 * (long )d->channels) * sizeof(float ));
    }
  }
  while_break: /* CIL Label */ ;
  }
...
#line 154 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 163 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 178 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 186
  if (nbytes > d->buffer_bytes) {
    {
#line 187
    fprintf(stderr, "-\006\250$oU", nbytes, d->buffer_bytes);
#line 188
    exit(1);
    }
#line 189
...
#line 195
    ...
    {
#line 196
    __cil_tmp8 = jack_port_get_buffer(*(d->output_port + i), nframes);
#line 196
    *(d->out + i) = (float *)__cil_tmp8;
    }
#line 195
    i ++;
  }
  ...
  {
#line 203
  __cil_tmp10 = jack_transport_is_rolling(d->client);
  }
#line 203
  if (d->o.transport_aware) {
#line 203
    if (! __cil_tmp10) {
      {
#line 204
      __cil_tmp11 = observe_end_of_process();
      }
#line 204
      if (__cil_tmp11) {
        {
...
#line 206
        ...
        {
#line 208
        signal_set(d->out, (int )nframes, d->channels, (float )0.);
        }
#line 209
        return (0);
      }
...
#line 213
  err = (long )0;
#line 217
  err = src_callback_read(d->src, d->o.src_ratio, (long )nframes, d->j_buffer);
  }
#line 221
  if (err == 0L) {
    {
#line 222
    __cil_tmp14 = src_error(d->src);
#line 222
    __cil_tmp15 = src_strerror(__cil_tmp14);
#line 222
    fprintf(stderr, "-", __cil_tmp15);
#line 224
    exit(1);
    }
  }
...
#line 271 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 291
  fprintf(stderr, "-", "-");
#line 294
  fprintf(stderr, "-", "-s\250$oU");
#line 297
  exit(1);
  }
}
}
#line 300 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 312
  fprintf(stderr, "-");
#line 313
  fprintf(stderr, "-w\250$oU");
#line 314
  exit(1);
  }
}
}
#line 323 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 325
  d = (struct player *)PTR;
#line 326
  nsamples = d->channels * d->o.rb_request_frames;
#line 327
  nbytes = (int )((size_t )nsamples * sizeof(float ));
#line 329
  __cil_tmp7 = jack_ringbuffer_read(d->rb, (char *)d->k_buffer, (size_t )nbytes);
#line 329
  err = (int )__cil_tmp7;
#line 332
  err /= (unsigned long )d->channels * sizeof(float );
#line 333
  *buf = d->k_buffer;
  }
#line 336
...
#line 345 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
int jackplay(char *file_name , struct player_opt o ) 
{ 
  struct player d ;
  ...
  void *__cil_tmp11 ;
  void *__cil_tmp12 ;
  jack_ringbuffer_t *__cil_tmp13 ;
  int err ;
  SRC_STATE *__cil_tmp15 ;
  char *__cil_tmp16 ;
  jack_client_t *__cil_tmp17 ;
  jack_client_t *__cil_tmp18 ;
  int osr ;
  jack_nframes_t __cil_tmp20 ;
  int isr ;
  int i ;
  int a ;
  int e ;
  jack_port_t *__cil_tmp25 ;
  int __cil_tmp26 ;
  int __cil_tmp27 ;
  jack_port_t *__cil_tmp28 ;
  int __cil_tmp29 ;
  int __cil_tmp30 ;
  int __cil_tmp31 ;
...
#line 356
  ambixinfo.fileformat = (ambix_fileformat_t )1;
#line 357
  d.sound_file = ambix_open(file_name, (ambix_filemode_t )16, & ambixinfo);
#line 359
  d.a_channels = (int )ambixinfo.ambichannels;
#line 360
  d.e_channels = (int )ambixinfo.extrachannels;
#line 362
...
#line 369
  ...
  {
#line 371
  __cil_tmp6 = xmalloc((unsigned long )d.channels * sizeof(float *));
#line 371
  d.out = (float **)__cil_tmp6;
#line 372
  __cil_tmp7 = xmalloc((unsigned long )d.channels * sizeof(jack_port_t *));
#line 372
  d.output_port = (jack_port_t **)__cil_tmp7;
#line 376
  d.buffer_samples = d.o.buffer_frames * d.channels;
#line 377
  d.buffer_bytes = (int )((unsigned long )d.buffer_samples * sizeof(float ));
#line 379
  __cil_tmp8 = xmalloc((unsigned long )(d.o.buffer_frames * d.a_channels) * sizeof(float32_t ));
#line 379
  d.a_buffer = (float32_t *)__cil_tmp8;
#line 380
  __cil_tmp9 = xmalloc((unsigned long )(d.o.buffer_frames * d.e_channels) * sizeof(float32_t ));
#line 380
  d.e_buffer = (float32_t *)__cil_tmp9;
#line 382
  __cil_tmp10 = xmalloc((size_t )d.buffer_bytes);
#line 382
  d.d_buffer = (float *)__cil_tmp10;
#line 383
  __cil_tmp11 = xmalloc((size_t )d.buffer_bytes);
#line 383
  d.j_buffer = (float *)__cil_tmp11;
#line 384
  __cil_tmp12 = xmalloc((size_t )d.buffer_bytes);
#line 384
  d.k_buffer = (float *)__cil_tmp12;
#line 386
  d.rb = jack_ringbuffer_create((size_t )d.buffer_bytes);
#line 391
  d.src = src_callback_new(& read_input_from_rb, d.o.converter, d.channels, & err,
                           & d);
  }
#line 396
  if (! d.src) {
    {
#line 397
    __cil_tmp16 = src_strerror(err);
#line 397
    fprintf(stderr, "-", __cil_tmp16);
#line 399
    exit(1);
    }
  }
...
#line 412
  if (d.o.unique_name) {
    {
#line 413
    d.client = jack_client_unique((char *)d.o.client_name);
    }
  } else {
    {
#line 415
    d.client = jack_client_open((char *)d.o.client_name, (jack_options_t )0, (jack_status_t *)((void *)0));
    }
  }
#line 417
  if (! d.client) {
    {
#line 418
    fprintf(stderr, "-\377\377\377", (char *)d.o.client_name);
#line 419
    exit(1);
    }
  }
  {
#line 425
  jack_client_create_thread(d.client, & d.disk_thread, 50, 1, & disk_proc, & d);
#line 434
  jack_set_error_function(& jack_client_minimal_error_handler);
#line 435
  jack_on_shutdown(d.client, & jack_client_minimal_shutdown_handler, (void *)0);
  }
#line 436
  if (d.o.transport_aware) {
    {
...
#line 443
  __cil_tmp20 = jack_get_sample_rate(d.client);
#line 443
  osr = (int )__cil_tmp20;
#line 444
  isr = (int )ambixinfo.samplerate;
  }
#line 445
  if (osr != isr) {
    {
#line 446
    d.o.src_ratio *= (double )(osr / isr);
#line 447
    fprintf(stderr, "-", isr, osr);
    }
  }
  {
#line 455
...
#line 457
      ...
      {
#line 458
      *(d.output_port + i) = _jack_port_register(d.client, 2, "-", a);
#line 459
      i ++;
      }
#line 457
...
#line 461
      ...
      {
#line 462
      *(d.output_port + i) = _jack_port_register(d.client, 2, "-", e + 1);
#line 463
      i ++;
      }
#line 461
...
#line 455
  ...
  {
#line 468
  __cil_tmp31 = jack_activate(d.client);
  }
#line 468
  if (__cil_tmp31) {
    {
...
#line 495
  d.sound_file = (ambix_t *)((void *)0);
#line 496
  jack_ringbuffer_free(d.rb);
#line 496
  d.rb = (jack_ringbuffer_t *)((void *)0);
#line 497
  close(d.pipe[0]);
#line 497
  d.pipe[0] = - 1;
...
#line 500
  free(d.d_buffer);
#line 500
  d.d_buffer = (float *)((void *)0);
#line 501
  free(d.a_buffer);
#line 501
  d.a_buffer = (float32_t *)((void *)0);
#line 502
  free(d.e_buffer);
#line 502
  d.e_buffer = (float32_t *)((void *)0);
#line 504
  free(d.j_buffer);
#line 504
  d.j_buffer = (float *)((void *)0);
#line 505
  free(d.k_buffer);
#line 505
  d.k_buffer = (float *)((void *)0);
#line 506
  free(d.out);
#line 506
  d.out = (float **)((void *)0);
#line 507
  free(d.output_port);
#line 507
  d.output_port = (jack_port_t **)((void *)0);
#line 509
  src_delete(d.src);
#line 509
  d.src = (SRC_STATE *)((void *)0);
  }
#line 511
  return (0);
}
}
#line 514 "/root/patron-artifact/package/smake_out/libambix-utils_tmp/libambix-0.1.1/utils/ambix-jplay.c"
...
#line 527
  o.converter = 2;
#line 529
  strncpy((char *)o.client_name, "-", (size_t )64);
  }
  {
#line 531
  while (1) {
...
#line 570
    ...
    {
#line 534
    __cil_tmp6 = strtol(optarg, (char **)((void *)0), 0);
#line 534
    o.buffer_frames = (int )__cil_tmp6;
    }
#line 535
    goto switch_break;
    case_99: /* CIL Label */ 
    {
#line 537
    __cil_tmp7 = strtol(optarg, (char **)((void *)0), 0);
#line 537
    o.converter = (int )__cil_tmp7;
    }
#line 538
    goto switch_break;
    case_104: /* CIL Label */ 
...
#line 544
    ...
    {
#line 546
    __cil_tmp8 = strtol(optarg, (char **)((void *)0), 0);
#line 546
    o.seek_request = (int64_t )__cil_tmp8;
    }
#line 547
    goto switch_break;
    case_109: /* CIL Label */ 
    {
#line 549
    __cil_tmp9 = strtoll(optarg, (char **)((void *)0), 0);
#line 549
    o.minimal_frames = (int )__cil_tmp9;
    }
#line 550
    goto switch_break;
    case_110: /* CIL Label */ 
    {
#line 552
    strncpy((char *)o.client_name, optarg, (size_t )63);
    }
    {
#line 553
    o.client_name[63] = (char )0;
#line 554
    fprintf(stderr, "-\327\250$oU", (char *)o.client_name);
    }
#line 555
    goto switch_break;
    case_113: /* CIL Label */ 
...
#line 557
    o.rb_request_frames = (int )__cil_tmp10;
    }
#line 558
    goto switch_break;
    case_114: /* CIL Label */ 
    {
#line 561
    o.src_ratio = strtod(optarg, (char **)((void *)0));
    }
#line 562
    goto switch_break;
    case_116: /* CIL Label */ 
