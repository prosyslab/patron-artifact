...
#line 86
      ...
      {
#line 87
      fprintf(fo, "-\363\036m\032V", (int )c);
      }
      }
    } else
#line 79
...
#line 399
    ...
    {
#line 401
    fprintf(stderr, "-1 m\032V", progname);
    }
    {
#line 402
    fprintf(stderr, "-");
#line 403
    fprintf(stderr, "-E\037m\032V");
#line 404
    fprintf(stderr, "-");
#line 405
    fprintf(stderr, "-C\037m\032V", "-");
    }
#line 406
    return (0);
    case_118: /* CIL Label */ 
...
#line 410
    ...
    {
#line 413
    fprintf(stderr, "-7 m\032V", progname, n);
    }
#line 415
    return (2);
    switch_break: /* CIL Label */ ;
...
#line 434
    if (__cil_tmp14 != 0) {
      {
#line 435
      fo = fopen(argv[optind], "-:\037m\032V");
      }
#line 436
      if (fo == (void *)0) {
        {
...
#line 459
  __cil_tmp17 = memcmp((char *)mh.chunktype, "-I m\032V", sizeof(mh.chunktype));
  }
#line 459
  if (__cil_tmp17 != 0) {
    {
...
#line 463
  if (verbose) {
    {
#line 464
    fprintf(stderr, "-4\037m\032V", (int )mh.format, (int )mh.ntrks, (int )mh.division);
    }
  }
  {
#line 470
...
#line 483
    __cil_tmp21 = memcmp((char *)mt.chunktype, "-)\037m\032V", sizeof(mt.chunktype));
    }
#line 483
    if (__cil_tmp21 != 0) {
      {
#line 484
      fprintf(stderr, "-\'\037m\032V", i + 1);
      }
#line 485
      return (2);
    }
