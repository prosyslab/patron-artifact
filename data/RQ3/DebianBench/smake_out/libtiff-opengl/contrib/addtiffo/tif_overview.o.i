# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
# 50 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
...
# 51 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 2
...
# 52 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 2
...
# 53 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 2
...
# 54 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 2
...
# 56 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_ovrcache.h" 1
# 44 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_ovrcache.h"
typedef struct
{
    uint32_t nXSize;
    uint32_t nYSize;
...
uint32_t TIFF_WriteOverview( TIFF *, uint32_t, uint32_t, int, int, int, int, int,
                             ...
                             int, int);
# 57 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 2
# 70 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
void TIFFBuildOverviews( TIFF *, int, int *, int, const char *,
                         int (*)(double,void*), void * );
# 82 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
...

{
    ...
    TIFFSetField( hTIFF, 256, nXSize );
    TIFFSetField( hTIFF, 257, nYSize );
    if( nSamples == 1 )
        TIFFSetField( hTIFF, 284, 1 );
    else
        TIFFSetField( hTIFF, 284, nPlanarConfig );

    TIFFSetField( hTIFF, 258, nBitsPerPixel );
    TIFFSetField( hTIFF, 277, nSamples );
    TIFFSetField( hTIFF, 259, nCompressFlag );
    TIFFSetField( hTIFF, 262, nPhotometric );
    TIFFSetField( hTIFF, 339, nSampleFormat );

    if( bTiled )
    {
        TIFFSetField( hTIFF, 322, nBlockXSize );
        TIFFSetField( hTIFF, 323, nBlockYSize );
    }
    else
        TIFFSetField( hTIFF, 278, nBlockYSize );

    TIFFSetField( hTIFF, 254, 0x1 );

    if( nPhotometric == 6 || nPhotometric == 10 )
    {
        TIFFSetField( hTIFF, 530, nHorSubsampling, nVerSubsampling);
    ...
    if( panRed != 
# 141 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
                 ((void *)0) 
# 141 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                      )
    {
        TIFFSetField( hTIFF, 320, panRed, panGreen, panBlue );
    }
                       ...
                       int nPixelOffset, int nLineOffset )
{
    ...
    for( iYOff = 0; iYOff < nYSize; iYOff++ )
    {
        for( iXOff = 0; iXOff < nXSize; iXOff++ )
        {
            ...
            if( nSampleFormat == 1 && nPixelBytes == 1 )
            {
                padfSamples[iSample++] = *pabyData;
            }
            else if( nSampleFormat == 1 && nPixelBytes == 2 )
            {
                padfSamples[iSample++] = ((uint16_t *) pabyData)[0];
            }
            else if( nSampleFormat == 1 && nPixelBytes == 4 )
            {
                padfSamples[iSample++] = ((uint32_t *) pabyData)[0];
            }
            else if( nSampleFormat == 2 && nPixelBytes == 2 )
            {
                padfSamples[iSample++] = ((int16_t *) pabyData)[0];
            }
            else if( nSampleFormat == 2 && nPixelBytes == 32 )
            {
                padfSamples[iSample++] = ((int32_t *) pabyData)[0];
            }
            else if( nSampleFormat == 3 && nPixelBytes == 4 )
            {
                padfSamples[iSample++] = ((float *) pabyData)[0];
            }
            else if( nSampleFormat == 3 && nPixelBytes == 8 )
            {
...

{
    if( nSampleFormat == 1 && nPixelBytes == 1 )
    {
        *pabyData = (unsigned char) ((0>((255<dfValue) ? 255 : dfValue)) ? 0 : ((255<dfValue) ? 255 : dfValue));
    }
    else if( nSampleFormat == 1 && nPixelBytes == 2 )
    {
        *((uint16_t *)pabyData) = (uint16_t) ((0>((65535<dfValue) ? 65535 : dfValue)) ? 0 : ((65535<dfValue) ? 65535 : dfValue));
    }
    else if( nSampleFormat == 1 && nPixelBytes == 4 )
    {
    ...
    {
        *((int16_t *)pabyData) = (int16_t) ((-32768>((32767<dfValue) ? 32767 : dfValue)) ? -32768 : ((32767<dfValue) ? 32767 : dfValue));
    }
    else if( nSampleFormat == 2 && nPixelBytes == 32 )
    {
...
# 272 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
static
...
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
   ((void) sizeof ((
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
   nBitsPerPixel >= 8
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
...
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
   "nBitsPerPixel >= 8"
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
   , "./contrib/addtiffo/tif_overview.c", 289, __extension__ __PRETTY_FUNCTION__); }))
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                               ;
    ...
    for( j = 0; j*nOMult < nBlockYSize; j++ )
    {
                 ...
                 || strncmp(pszResampling,"AVERAG",6) == 0 )
        {
            ...
            for( i = 0; i*nOMult < nBlockXSize; i++ )
            {
                ...
                nXSize = (((uint32_t)nOMult<nBlockXSize - i) ? (uint32_t)nOMult : nBlockXSize - i);
                nYSize = (((uint32_t)nOMult<nBlockYSize - j) ? (uint32_t)nOMult : nBlockYSize - j);
...
# 569 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
...
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
               ((void) sizeof ((
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
               (nBitsPerPixel % 8) == 0
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
               ) ? 1 : 0), __extension__ ({ if (
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
...
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
               "(nBitsPerPixel % 8) == 0"
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
               , "./contrib/addtiffo/tif_overview.c", 672, __extension__ __PRETTY_FUNCTION__); }))
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                                                 ;
                if( nPlanarConfig == 2 )
                {
...
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
...

{
    ...
    TIFFGetField( hTIFF, 256, &nXSize );
    TIFFGetField( hTIFF, 257, &nYSize );

    TIFFGetField( hTIFF, 258, &nBitsPerPixel );

    TIFFGetField( hTIFF, 277, &nSamples );
    TIFFGetFieldDefaulted( hTIFF, 284, &nPlanarConfig );

    TIFFGetFieldDefaulted( hTIFF, 262, &nPhotometric );
    TIFFGetFieldDefaulted( hTIFF, 259, &nCompressFlag );
    TIFFGetFieldDefaulted( hTIFF, 339, &nSampleFormat );

    if( nPhotometric == 6 || nPhotometric == 10 )
    {
        if( nBitsPerPixel != 8 || nSamples != 3 || nPlanarConfig != 1 ||
            nSampleFormat != 1)
        {
        ...
        bSubsampled = 1;
        TIFFGetField( hTIFF, 530, &nHorSubsampling, &nVerSubsampling );
    ...
    pfnWarning = TIFFSetWarningHandler( 
# 788 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
                                       ((void *)0) 
# 788 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                                            );




    if( TIFFGetField( hTIFF, 278, &(nBlockYSize) ) )
    {
        nBlockXSize = nXSize;
        bTiled = 0;
    }
    ...
    {
        TIFFGetField( hTIFF, 322, &nBlockXSize );
        TIFFGetField( hTIFF, 323, &nBlockYSize );
        bTiled = 1;
    }
    ...
    {
        panRedMap = panGreenMap = panBlueMap = 
# 828 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
                                              ((void *)0)
# 828 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                                                  ;
    }
    ...
    for( i = 0; i < nOverviews; i++ )
    {
        ...
        nOBlockXSize = ((nBlockXSize<nOXSize) ? nBlockXSize : nOXSize);
        nOBlockYSize = ((nBlockYSize<nOYSize) ? nBlockYSize : nOYSize);
    ...
    if( panRedMap != 
# 868 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
                    ((void *)0) 
# 868 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                         )
    {
        _TIFFfree( panRedMap );
    ...
    if( papoRawBIs != 
# 915 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c" 3 4
                     ((void *)0) 
# 915 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
                          )
