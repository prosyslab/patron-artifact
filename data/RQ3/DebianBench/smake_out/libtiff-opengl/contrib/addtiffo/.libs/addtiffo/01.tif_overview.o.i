...
# 141 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
    ...
    if( TIFFWriteCheck( hTIFF, bTiled, "-" ) == 0 )
        return 0;
...
void TIFF_DownSample( unsigned char *pabySrcTile,
                      ...
                      int nSampleFormat,  char * pszResampling )
...
# 289 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/addtiffo/tif_overview.c"
    ...
    for( j = 0; j*nOMult < nBlockYSize; j++ )
    {
        ...
        if( strncmp(pszResampling,"-",4) == 0
            || strncmp(pszResampling,"-",4) == 0 )
        {
        ...
        else if( strncmp(pszResampling,"-",6) == 0
                 || strncmp(pszResampling,"-",6) == 0 )
        {
            pabySrc = pabySrcTile + j*nOMult*nBlockXSize * nPixelGroupBytes;
...
void TIFFBuildOverviews( TIFF *hTIFF, int nOverviews, int * panOvList,
                         int bUseSubIFDs,  char *pszResampleMethod,
