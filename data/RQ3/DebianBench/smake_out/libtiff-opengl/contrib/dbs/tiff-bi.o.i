# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c"
# 25 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c"
...
# 26 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c" 2
...
# 27 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c" 2
...
# 29 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c" 2
...
int main(int argc, char **argv)
{
    ...
    if (argc != 2) {
        fprintf(
# 40 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c" 3 4
               stderr
# 40 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c"
                     , "Usage: %s tiff-image\n", argv[0]);
        return 0;
    }

    if ((tif = TIFFOpen(argv[1], "w")) == 
# 44 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c" 3 4
                                         ((void *)0)
# 44 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c"
                                             ) {
        fprintf(
# 45 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c" 3 4
               stderr
# 45 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-bi.c"
    ...
    scan_line = (unsigned char *) malloc(512 / 8);

    for (i = 0; i < (512 / 8) / 2; i++)
        scan_line[i] = 0;

    for (i = (512 / 8) / 2; i < (512 / 8); i++)
        scan_line[i] = 255;
