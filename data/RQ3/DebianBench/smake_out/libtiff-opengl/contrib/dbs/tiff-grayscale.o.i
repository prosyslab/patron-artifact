# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c"
# 26 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c"
...
# 27 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 2
...
# 28 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 2
...
# 29 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 2
...
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 2
...
# 32 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 2
...
int main(int argc, char **argv)
{
    ...
    if ((tif = TIFFOpen(argv[3], "w")) == 
# 85 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 3 4
                                         ((void *)0)
# 85 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c"
                                             ) {
        fprintf(
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 3 4
               stderr
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c"
                     , "can't open %s as a TIFF file\n", argv[3]);
  free(gray);
        return 0;
    }

    TIFFSetField(tif, 256, 512);
    TIFFSetField(tif, 257, 512);
    TIFFSetField(tif, 258, bits_per_pixel);
    TIFFSetField(tif, 259, 1);
    TIFFSetField(tif, 262, 1);
    TIFFSetField(tif, 277, 1);
    TIFFSetField(tif, 278, 1);
    TIFFSetField(tif, 284, 1);
    TIFFSetField(tif, 532, refblackwhite);
    TIFFSetField(tif, 301, gray);
    TIFFSetField(tif, 296, 1);

    scan_line = (unsigned char *) malloc(512 / (8 / bits_per_pixel));
...
{
    fprintf(
# 136 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c" 3 4
           stderr
# 136 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-grayscale.c"
