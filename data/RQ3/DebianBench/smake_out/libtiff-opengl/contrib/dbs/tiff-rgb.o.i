# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
# 25 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
...
# 26 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 2
...
# 27 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 2
...
# 28 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 2
...
# 29 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 2
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 2
...
{
    char * input_file = 
# 43 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 3 4
                                ((void *)0)
# 43 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
                                    ;
    ...
    for (i = 0; i < 256; i++) {
        if (i == 0)
            ...
            red[i] = (uint16_t) (((pow(i / 255.0, 1.0 / image_gamma) * 65535.0)) + 0.5);
            green[i] = (uint16_t) (((pow(i / 255.0, 1.0 / image_gamma) * 65535.0)) + 0.5);
            blue[i] = (uint16_t) (((pow(i / 255.0, 1.0 / image_gamma) * 65535.0)) + 0.5);
        }
    }
    ...
    if ((tif = TIFFOpen(input_file, "w")) == 
# 82 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 3 4
                                            ((void *)0)
# 82 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
                                                ) {
        fprintf(
# 83 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 3 4
               stderr
# 83 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
                     , "can't open %s as a TIFF file\n", input_file);
        exit(0);
    }

    TIFFSetField(tif, 256, 525);
    TIFFSetField(tif, 257, 512);
    TIFFSetField(tif, 258, 8);
    TIFFSetField(tif, 259, 1);
    TIFFSetField(tif, 262, 2);
    TIFFSetField(tif, 277, 3);
    TIFFSetField(tif, 278, 1);
    TIFFSetField(tif, 284, 1);
    TIFFSetField(tif, 296, 1);




    TIFFSetField(tif, 532, refblackwhite);
    TIFFSetField(tif, 301, red, green, blue);

    scan_line = (unsigned char *) malloc(525 * 3);
...
{
    fprintf(
# 190 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c" 3 4
           stderr
# 190 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/contrib/dbs/tiff-rgb.c"
