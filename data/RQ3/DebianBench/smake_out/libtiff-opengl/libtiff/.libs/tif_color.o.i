# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
# 37 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
...
# 38 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c" 2
...
# 39 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c" 2





# 43 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
void
 ...
 *r = ((uint32_t)((cielab->Yr2r[i])>0?((cielab->Yr2r[i])+0.5):((cielab->Yr2r[i])-0.5)));

 i = (int)((Yg - cielab->display.d_Y0G) / cielab->gstep);
 i = ((cielab->range)<(i)?(cielab->range):(i));
 *g = ((uint32_t)((cielab->Yg2g[i])>0?((cielab->Yg2g[i])+0.5):((cielab->Yg2g[i])-0.5)));

 i = (int)((Yb - cielab->display.d_Y0B) / cielab->bstep);
 i = ((cielab->range)<(i)?(cielab->range):(i));
 *b = ((uint32_t)((cielab->Yb2b[i])>0?((cielab->Yb2b[i])+0.5):((cielab->Yb2b[i])-0.5)));
...
# 180 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
void
...
# 233 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
int
TIFFYCbCrToRGBInit(TIFFYCbCrToRGB* ycbcr, float *luma, float *refBlackWhite)
{
    ...
    clamptab = (TIFFRGBValue*)(
            (uint8_t*) ycbcr + ((((uint32_t)sizeof (TIFFYCbCrToRGB) < (0xffffffff - (uint32_t)(sizeof (long)-1))) ? ((((uint32_t)(sizeof (TIFFYCbCrToRGB)))+(((uint32_t)(sizeof (long)))-1))/((uint32_t)(sizeof (long)))) : 0U)*(sizeof (long))));
 ...
 clamptab[i] = (TIFFRGBValue) i;
    ...
    { float f1 = 2-2*luma[0]; int32_t D1 = ((int32_t)((((f1)<(0.0F)?(0.0F):(f1)>(2.0F)?(2.0F):(f1))) * (1L<<16) + 0.5));
      float f2 = luma[0]*f1/luma[1]; int32_t D2 = -((int32_t)((((f2)<(0.0F)?(0.0F):(f2)>(2.0F)?(2.0F):(f2))) * (1L<<16) + 0.5));
      float f3 = 2-2*luma[2]; int32_t D3 = ((int32_t)((((f3)<(0.0F)?(0.0F):(f3)>(2.0F)?(2.0F):(f3))) * (1L<<16) + 0.5));
      float f4 = luma[2]*f3/luma[1]; int32_t D4 = -((int32_t)((((f4)<(0.0F)?(0.0F):(f4)>(2.0F)?(2.0F):(f4))) * (1L<<16) + 0.5));
      int x;
# 273 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_color.c"
      for (i = 0, x = -128; i < 256; i++, x++) {
     int32_t Cr = (int32_t)CLAMPw(((((x)-(int32_t)(refBlackWhite[4] - 128.0F))*(float)(127))/(float)(((refBlackWhite[5] - 128.0F)-(refBlackWhite[4] - 128.0F)!=0) ? ((refBlackWhite[5] - 128.0F)-(refBlackWhite[4] - 128.0F)) : 1))
                                      ,
                            -128.0F * 32, 128.0F * 32);
     int32_t Cb = (int32_t)CLAMPw(((((x)-(int32_t)(refBlackWhite[2] - 128.0F))*(float)(127))/(float)(((refBlackWhite[3] - 128.0F)-(refBlackWhite[2] - 128.0F)!=0) ? ((refBlackWhite[3] - 128.0F)-(refBlackWhite[2] - 128.0F)) : 1))
                                      ,
                            -128.0F * 32, 128.0F * 32);

     ycbcr->Cr_r_tab[i] = (int32_t)((D1 * Cr + ((int32_t)(1<<(16 -1)))) >> 16);
     ycbcr->Cb_b_tab[i] = (int32_t)((D3 * Cb + ((int32_t)(1<<(16 -1)))) >> 16);
     ycbcr->Cr_g_tab[i] = D2*Cr;
     ycbcr->Cb_g_tab[i] = D4*Cb + ((int32_t)(1<<(16 -1)));
     ycbcr->Y_tab[i] =
      (int32_t)CLAMPw(((((x + 128)-(int32_t)(refBlackWhite[0]))*(float)(255))/(float)(((refBlackWhite[1])-(refBlackWhite[0])!=0) ? ((refBlackWhite[1])-(refBlackWhite[0])) : 1)),
                                  -128.0F * 32, 128.0F * 32);
      }
    }
