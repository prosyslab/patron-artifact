# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
# 28 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
...
# 29 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c" 2
# 44 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
void
TIFFCleanup(TIFF* tif)
{
 ...
 if (tif->tif_mode != 
# 50 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c" 3 4
                     00
# 50 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
                             )
  TIFFFlush(tif);
 (*tif->tif_cleanup)(tif);
 ...
 if (tif->tif_rawdata && (tif->tif_flags&0x00200U))
  _TIFFfree(tif->tif_rawdata);
 if ((((tif)->tif_flags & 0x00800U) != 0))
  ((*(tif)->tif_unmapproc)((tif)->tif_clientdata,(tif->tif_base),((toff_t)tif->tif_size)));
...
# 122 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
void
TIFFClose(TIFF* tif)
{
     if (tif != 
# 125 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c" 3 4
               ((void *)0)
# 125 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_close.c"
                   )
     {
