# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 2
...
# 32 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 2
...
# 69 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                                                                   "u"
# 69 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                                                         "-bit samples",
        td->td_bitspersample);
    return 0;
   }
  ...
  case 3:
   if (td->td_sampleformat != 3) {
    TIFFErrorExt(tif->tif_clientdata, module,
        "Floating point \"Predictor\" not supported with %"
# 77 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                                                          "u"
# 77 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                                                " data format",
        td->td_sampleformat);
    return 0;
   }
                        if (td->td_bitspersample != 16
                            ...
                            && td->td_bitspersample != 64) {
                                TIFFErrorExt(tif->tif_clientdata, module,
                                             "Floating point \"Predictor\" not supported with %"
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                                                                                               "u"
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                                                                                     "-bit samples",
                                             td->td_bitspersample);
    return 0;
                            }
...
# 151 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
# 230 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                if (tif->tif_flags & 0x00080U) {
...
# 278 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"

static int
horAcc8(TIFF* tif, uint8_t* cp0, tmsize_t cc)
{
 tmsize_t stride = ((TIFFPredictorState*) (tif)->tif_data)->stride;
 ...
 if (cc > stride) {
  ...
  if (stride == 3) {
   ...
   cc -= stride;
   do {
    switch (stride) { default: { tmsize_t i; for (i = stride-4; i > 0; i--) { cp[stride] = (unsigned char) ((cp[stride] + *cp) & 0xff); cp++; } } case 4: cp[stride] = (unsigned char) ((cp[stride] + *cp) & 0xff); cp++; case 3: cp[stride] = (unsigned char) ((cp[stride] + *cp) & 0xff); cp++; case 2: cp[stride] = (unsigned char) ((cp[stride] + *cp) & 0xff); cp++; case 1: cp[stride] = (unsigned char) ((cp[stride] + *cp) & 0xff); cp++; case 0: ; }
...
horAcc16(TIFF* tif, uint8_t* cp0, tmsize_t cc)
{
 ...
 if (wc > stride) {
  wc -= stride;
  do {
   switch (stride) { default: { tmsize_t i; for (i = stride-4; i > 0; i--) { wp[stride] = (uint16_t)(((unsigned int)wp[stride] + (unsigned int)wp[0]) & 0xffff); wp++; } } case 4: wp[stride] = (uint16_t)(((unsigned int)wp[stride] + (unsigned int)wp[0]) & 0xffff); wp++; case 3: wp[stride] = (uint16_t)(((unsigned int)wp[stride] + (unsigned int)wp[0]) & 0xffff); wp++; case 2: wp[stride] = (uint16_t)(((unsigned int)wp[stride] + (unsigned int)wp[0]) & 0xffff); wp++; case 1: wp[stride] = (uint16_t)(((unsigned int)wp[stride] + (unsigned int)wp[0]) & 0xffff); wp++; case 0: ; }
   wc -= stride;
  } while (wc > 0);
 }
 return 1;
...
horAcc32(TIFF* tif, uint8_t* cp0, tmsize_t cc)
{
 ...
 if (wc > stride) {
  wc -= stride;
  do {
   switch (stride) { default: { tmsize_t i; for (i = stride-4; i > 0; i--) { wp[stride] += wp[0]; wp++; } } case 4: wp[stride] += wp[0]; wp++; case 3: wp[stride] += wp[0]; wp++; case 2: wp[stride] += wp[0]; wp++; case 1: wp[stride] += wp[0]; wp++; case 0: ; }
   wc -= stride;
  } while (wc > 0);
 }
 return 1;
...
fpAcc(TIFF* tif, uint8_t* cp0, tmsize_t cc)
{
 ...
 while (count > stride) {
  switch (stride) { default: { tmsize_t i; for (i = stride-4; i > 0; i--) { cp[stride] = (unsigned char) ((cp[stride] + cp[0]) & 0xff); cp++; } } case 4: cp[stride] = (unsigned char) ((cp[stride] + cp[0]) & 0xff); cp++; case 3: cp[stride] = (unsigned char) ((cp[stride] + cp[0]) & 0xff); cp++; case 2: cp[stride] = (unsigned char) ((cp[stride] + cp[0]) & 0xff); cp++; case 1: cp[stride] = (unsigned char) ((cp[stride] + cp[0]) & 0xff); cp++; case 0: ; }
...
# 461 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 461 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 
# 461 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
...
"sp != NULL"
# 461 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 461, __extension__ __PRETTY_FUNCTION__); }))
# 461 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                  ;
 
# 462 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 462 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->decoderow != 
# 462 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 462 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->decoderow != NULL"
# 462 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 462, __extension__ __PRETTY_FUNCTION__); }))
# 462 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                             ;
 
# 463 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 463 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->decodepfunc != 
# 463 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 463 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->decodepfunc != NULL"
# 463 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 463, __extension__ __PRETTY_FUNCTION__); }))
# 463 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                               ;
...
# 478 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
static int
...
# 483 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 483 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 
# 483 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 483 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != NULL"
# 483 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 483, __extension__ __PRETTY_FUNCTION__); }))
# 483 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                  ;
 
# 484 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 484 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->decodetile != 
# 484 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 484 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->decodetile != NULL"
# 484 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 484, __extension__ __PRETTY_FUNCTION__); }))
# 484 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                              ;
...
# 488 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
 ((void) sizeof ((
# 488 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
 rowsize > 0
# 488 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
...
# 488 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
 "rowsize > 0"
# 488 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
 , "./libtiff/tif_predict.c", 488, __extension__ __PRETTY_FUNCTION__); }))
# 488 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                    ;
  if((occ0%rowsize) !=0)
        {
...
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
 ((void) sizeof ((
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
 sp->decodepfunc != 
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
 "sp->decodepfunc != NULL"
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
 , "./libtiff/tif_predict.c", 495, __extension__ __PRETTY_FUNCTION__); }))
# 495 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                ;
  while (occ0 > 0) {
...
# 692 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 692 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 
# 692 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 692 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != NULL"
# 692 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 692, __extension__ __PRETTY_FUNCTION__); }))
# 692 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                  ;
 
# 693 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 693 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->encodepfunc != 
# 693 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 693 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->encodepfunc != NULL"
# 693 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 693, __extension__ __PRETTY_FUNCTION__); }))
# 693 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                               ;
 
# 694 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 694 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->encoderow != 
# 694 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 694 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->encoderow != NULL"
# 694 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 694, __extension__ __PRETTY_FUNCTION__); }))
# 694 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                             ;
...
# 712 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 712 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 
# 712 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 712 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != NULL"
# 712 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 712, __extension__ __PRETTY_FUNCTION__); }))
# 712 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                  ;
 
# 713 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 713 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->encodepfunc != 
# 713 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 713 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->encodepfunc != NULL"
# 713 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 713, __extension__ __PRETTY_FUNCTION__); }))
# 713 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                               ;
 
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->encodetile != 
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->encodetile != NULL"
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 714, __extension__ __PRETTY_FUNCTION__); }))
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                              ;
        ...
        if( working_copy == 
# 721 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                           ((void *)0) 
# 721 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                )
        {
            TIFFErrorExt(tif->tif_clientdata, module,
                         "Out of memory allocating %" 
# 724 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                                                     "l" "d" 
# 724 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                                            " byte temp buffer.",
                         (int64_t) cc0 );
            return 0;
        }
...
# 732 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 732 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
rowsize > 0
# 732 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 732 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"rowsize > 0"
# 732 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 732, __extension__ __PRETTY_FUNCTION__); }))
# 732 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                   ;
 if((cc0%rowsize)!=0)
    {
...
static const TIFFField predictFields[] = {
    { 317, 1, 1, TIFF_SHORT, 0, TIFF_SETGET_UINT16, TIFF_SETGET_UINT16, (66 +0), 0, 0, "Predictor", 
# 755 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                                                                                                                                 ((void *)0) 
# 755 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                                                                                                                                      },
};
...
# 763 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 763 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 
# 763 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 763 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != NULL"
# 763 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 763, __extension__ __PRETTY_FUNCTION__); }))
# 763 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                  ;
 
# 764 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 764 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->vsetparent != 
# 764 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 764 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->vsetparent != NULL"
# 764 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 764, __extension__ __PRETTY_FUNCTION__); }))
# 764 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                              ;

 switch (tag) {
 case 317:
  sp->predictor = (uint16_t) 
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                            __builtin_va_arg(
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                            ap
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                            ,
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
# 783 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 783 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 
# 783 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 783 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != NULL"
# 783 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 783, __extension__ __PRETTY_FUNCTION__); }))
# 783 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                  ;
 
# 784 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 784 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp->vgetparent != 
# 784 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 784 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp->vgetparent != NULL"
# 784 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 784, __extension__ __PRETTY_FUNCTION__); }))
# 784 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                              ;
 ...
 case 317:
  *
# 788 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
  __builtin_va_arg(
# 788 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
  ap
# 788 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
  ,
# 788 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
# 820 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 820 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 0
# 820 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 820 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != 0"
# 820 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 820, __extension__ __PRETTY_FUNCTION__); }))
# 820 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
               ;
 ...
 if (!_TIFFMergeFields(tif, predictFields,
         (sizeof (predictFields) / sizeof ((predictFields)[0])))) {
 ...
 sp->predictor = 1;
 sp->encodepfunc = 
# 851 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                  ((void *)0)
# 851 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                      ;
 sp->decodepfunc = 
# 852 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
                  ((void *)0)
# 852 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
                      ;
 return 1;
}
...
# 861 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
((void) sizeof ((
# 861 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
sp != 0
# 861 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 861 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
...
"sp != 0"
# 861 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c" 3 4
, "./libtiff/tif_predict.c", 861, __extension__ __PRETTY_FUNCTION__); }))
# 861 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_predict.c"
               ;
