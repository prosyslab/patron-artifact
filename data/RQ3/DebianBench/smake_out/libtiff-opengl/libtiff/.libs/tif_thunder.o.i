# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
# 25 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
...
# 26 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 27 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c" 2
# 54 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
static const int twobitdeltas[4] = { 0, 1, 0, -1 };
static const int threebitdeltas[8] = { 0, 1, 2, 3, 0, -3, -2, -1 };
# 68 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
static int
...
ThunderDecode(TIFF* tif, uint8_t* op, tmsize_t maxpixels)
{
 ...
 while (cc > 0 && npixels < maxpixels) {
  ...
  case 0x40:
   if ((delta = ((n >> 4) & 3)) != 2)
    { lastpixel = ((unsigned)((int)lastpixel + twobitdeltas[delta])) & 0xf; if ( npixels < maxpixels ) { if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (uint8_t) (lastpixel << 4); } };
   if ((delta = ((n >> 2) & 3)) != 2)
    { lastpixel = ((unsigned)((int)lastpixel + twobitdeltas[delta])) & 0xf; if ( npixels < maxpixels ) { if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (uint8_t) (lastpixel << 4); } };
   if ((delta = (n & 3)) != 2)
    { lastpixel = ((unsigned)((int)lastpixel + twobitdeltas[delta])) & 0xf; if ( npixels < maxpixels ) { if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (uint8_t) (lastpixel << 4); } };
  ...
  case 0x80:
   if ((delta = ((n >> 3) & 7)) != 4)
    { lastpixel = ((unsigned)((int)lastpixel + threebitdeltas[delta])) & 0xf; if ( npixels < maxpixels ) { if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (uint8_t) (lastpixel << 4); } };
   if ((delta = (n & 7)) != 4)
    { lastpixel = ((unsigned)((int)lastpixel + threebitdeltas[delta])) & 0xf; if ( npixels < maxpixels ) { if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (uint8_t) (lastpixel << 4); } };
   break;
  case 0xc0:
   { lastpixel = (n) & 0xf; if ( npixels < maxpixels ) { if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (uint8_t) (lastpixel << 4); } };
   break;
  }
 }
...
# 146 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c" 3 4
                                   "l" "u"
# 146 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
                                         " != %"
# 146 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c" 3 4
                                                "l" "u"
# 146 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_thunder.c"
