# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c" 2

static int NotConfigured(TIFF*, int);
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
const TIFFCodec _TIFFBuiltinCODECS[] = {
    { "None", 1, TIFFInitDumpMode },
    { "LZW", 5, TIFFInitLZW },
    { "PackBits", 32773, TIFFInitPackBits },
    { "ThunderScan", 32809,TIFFInitThunderScan },
    { "NeXT", 32766, TIFFInitNeXT },
    { "JPEG", 7, TIFFInitJPEG },
    { "Old-style JPEG", 6, TIFFInitOJPEG },
    { "CCITT RLE", 2, TIFFInitCCITTRLE },
    { "CCITT RLE/W", 32771, TIFFInitCCITTRLEW },
    { "CCITT Group 3", 3, TIFFInitCCITTFax3 },
    { "CCITT Group 4", 4, TIFFInitCCITTFax4 },
    { "ISO JBIG", 34661, TIFFInitJBIG },
    { "Deflate", 32946, TIFFInitZIP },
    { "AdobeDeflate", 8 , TIFFInitZIP },
    { "PixarLog", 32909, TIFFInitPixarLog },
    { "SGILog", 34676, TIFFInitSGILog },
    { "SGILog24", 34677, TIFFInitSGILog },
    { "LZMA", 34925, TIFFInitLZMA },
    { "ZSTD", 50000, TIFFInitZSTD },
    { "WEBP", 50001, TIFFInitWebP },
    { "LERC", 34887, NotConfigured },
    { 
# 108 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c" 3 4
     ((void *)0)
# 108 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
         , 0, 
# 108 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c" 3 4
                                               ((void *)0) 
# 108 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
...
_notConfigured(TIFF* tif)
{
 const TIFFCodec* c = TIFFFindCODEC(tif->tif_dir.td_compression);
        ...
        sprintf(compression_code, "%"
# 117 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c" 3 4
                                    "u"
# 117 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
...
# 148 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
int
TIFFIsCODECConfigured(uint16_t scheme)
{
 ...
 if(codec == 
# 153 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c" 3 4
            ((void *)0)
# 153 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
                ) {
  return 0;
 }
 if(codec->init == 
# 156 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c" 3 4
                  ((void *)0)
# 156 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_codec.c"
                      ) {
  return 0;
 }
