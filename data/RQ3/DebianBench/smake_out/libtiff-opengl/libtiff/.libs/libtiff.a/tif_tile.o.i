# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_tile.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_tile.c"
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_tile.c"
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_tile.c" 2
...
TIFFComputeTile(TIFF* tif, uint32_t x, uint32_t y, uint32_t z, uint16_t s)
{
 ...
 if (dz == (uint32_t) -1)
  dz = td->td_imagedepth;
 if (dx != 0 && dy != 0 && dz != 0) {
  uint32_t xpt = (((uint32_t)td->td_imagewidth < (0xffffffff - (uint32_t)(dx-1))) ? ((((uint32_t)(td->td_imagewidth))+(((uint32_t)(dx))-1))/((uint32_t)(dx))) : 0U);
  uint32_t ypt = (((uint32_t)td->td_imagelength < (0xffffffff - (uint32_t)(dy-1))) ? ((((uint32_t)(td->td_imagelength))+(((uint32_t)(dy))-1))/((uint32_t)(dy))) : 0U);
  uint32_t zpt = (((uint32_t)td->td_imagedepth < (0xffffffff - (uint32_t)(dz-1))) ? ((((uint32_t)(td->td_imagedepth))+(((uint32_t)(dz))-1))/((uint32_t)(dz))) : 0U);
...
TIFFNumberOfTiles(TIFF* tif)
{
 ...
 ntiles = (dx == 0 || dy == 0 || dz == 0) ? 0 :
     _TIFFMultiply32(tif, _TIFFMultiply32(tif, (((uint32_t)td->td_imagewidth < (0xffffffff - (uint32_t)(dx-1))) ? ((((uint32_t)(td->td_imagewidth))+(((uint32_t)(dx))-1))/((uint32_t)(dx))) : 0U),
     (((uint32_t)td->td_imagelength < (0xffffffff - (uint32_t)(dy-1))) ? ((((uint32_t)(td->td_imagelength))+(((uint32_t)(dy))-1))/((uint32_t)(dy))) : 0U),
     "TIFFNumberOfTiles"),
     (((uint32_t)td->td_imagedepth < (0xffffffff - (uint32_t)(dz-1))) ? ((((uint32_t)(td->td_imagedepth))+(((uint32_t)(dz))-1))/((uint32_t)(dz))) : 0U), "TIFFNumberOfTiles");
 if (td->td_planarconfig == 2)
 ...
 if (td->td_planarconfig == 1)
  ...
  rowsize = _TIFFMultiply64(tif, rowsize, td->td_samplesperpixel,
      "TIFFTileRowSize");
        ...
        tilerowsize=(((rowsize)&0x07)?((uint64_t)(rowsize)>>3)+1:(uint64_t)(rowsize)>>3);
        if (tilerowsize == 0)
        {
...
TIFFVTileSize64(TIFF* tif, uint32_t nrows)
{
 ...
 {
# 212 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_tile.c"
  ...
  samplingblocks_hor=(((uint32_t)td->td_tilewidth < (0xffffffff - (uint32_t)(ycbcrsubsampling[0]-1))) ? ((((uint32_t)(td->td_tilewidth))+(((uint32_t)(ycbcrsubsampling[0]))-1))/((uint32_t)(ycbcrsubsampling[0]))) : 0U);
...
_TIFFDefaultTileSize(TIFF* tif, uint32_t* tw, uint32_t* th)
{
 ...
 if (*tw & 0xf)
  *tw = ((((uint32_t)*tw < (0xffffffff - (uint32_t)(16 -1))) ? ((((uint32_t)(*tw))+(((uint32_t)(16))-1))/((uint32_t)(16))) : 0U)*(16));
 if (*th & 0xf)
  *th = ((((uint32_t)*th < (0xffffffff - (uint32_t)(16 -1))) ? ((((uint32_t)(*th))+(((uint32_t)(16))-1))/((uint32_t)(16))) : 0U)*(16));
}
