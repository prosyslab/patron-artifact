# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c" 2
...
TIFFNumberOfStrips(TIFF* tif)
{
 ...
 nstrips = (td->td_rowsperstrip == (uint32_t) -1 ? 1 :
               (((uint32_t)td->td_imagelength < (0xffffffff - (uint32_t)(td->td_rowsperstrip-1))) ? ((((uint32_t)(td->td_imagelength))+(((uint32_t)(td->td_rowsperstrip))-1))/((uint32_t)(td->td_rowsperstrip))) : 0U));
 if (td->td_planarconfig == 2)
...
TIFFVStripSize64(TIFF* tif, uint32_t nrows)
{
 ...
 {
# 94 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
  ...
  TIFFGetFieldDefaulted(tif,530,ycbcrsubsampling+0,
      ycbcrsubsampling+1);
  ...
  samplingblocks_hor=(((uint32_t)td->td_imagewidth < (0xffffffff - (uint32_t)(ycbcrsubsampling[0]-1))) ? ((((uint32_t)(td->td_imagewidth))+(((uint32_t)(ycbcrsubsampling[0]))-1))/((uint32_t)(ycbcrsubsampling[0]))) : 0U);
  samplingblocks_ver=(((uint32_t)nrows < (0xffffffff - (uint32_t)(ycbcrsubsampling[1]-1))) ? ((((uint32_t)(nrows))+(((uint32_t)(ycbcrsubsampling[1]))-1))/((uint32_t)(ycbcrsubsampling[1]))) : 0U);
  samplingrow_samples=_TIFFMultiply64(tif,samplingblocks_hor,samplingblock_samples,module);
  samplingrow_size=(((_TIFFMultiply64(tif,samplingrow_samples,td->td_bitspersample,module))&0x07)?((uint64_t)(_TIFFMultiply64(tif,samplingrow_samples,td->td_bitspersample,module))>>3)+1:(uint64_t)(_TIFFMultiply64(tif,samplingrow_samples,td->td_bitspersample,module))>>3);
...
TIFFRawStripSize64(TIFF* tif, uint32_t strip)
{
 ...
 if (bytecount == 0)
 {
  TIFFErrorExt(tif->tif_clientdata, module,
        "%"
# 148 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c" 3 4
          "l" "u"
# 148 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
...
# 185 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
uint64_t
...
_TIFFDefaultStripSize(TIFF* tif, uint32_t s)
{
 if ((int32_t) s < 1) {
  ...
  if (scanlinesize==0)
   scanlinesize=1;
  rows= (uint64_t)8192 / scanlinesize;
  if (rows==0)
   rows=1;
...
# 249 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_strip.c"
uint64_t
TIFFScanlineSize64(TIFF* tif)
{
 ...
 if (td->td_planarconfig==1)
 {
      ...
      (!(((tif)->tif_flags & 0x04000U) != 0)))
  {
   ...
   samplingblocks_hor = (((uint32_t)td->td_imagewidth < (0xffffffff - (uint32_t)(ycbcrsubsampling[0]-1))) ? ((((uint32_t)(td->td_imagewidth))+(((uint32_t)(ycbcrsubsampling[0]))-1))/((uint32_t)(ycbcrsubsampling[0]))) : 0U);
   samplingrow_samples = _TIFFMultiply64(tif,samplingblocks_hor,samplingblock_samples,module);
   samplingrow_size = ((((uint64_t)(_TIFFMultiply64(tif,samplingrow_samples,td->td_bitspersample,module)))+(((uint64_t)(8))-1))/((uint64_t)(8)));
  ...
  else
  {
   ...
   scanline_size=((((uint64_t)(_TIFFMultiply64(tif,scanline_samples,td->td_bitspersample,module)))+(((uint64_t)(8))-1))/((uint64_t)(8)));
  }
 }
 else
        {
  scanline_size=((((uint64_t)(_TIFFMultiply64(tif,td->td_imagewidth,td->td_bitspersample,module)))+(((uint64_t)(8))-1))/((uint64_t)(8)));
        }
        if (scanline_size == 0)
        {
...
TIFFRasterScanlineSize64(TIFF* tif)
{
 ...
 if (td->td_planarconfig == 1) {
  ...
  return ((((scanline)&0x07)?((uint64_t)(scanline)>>3)+1:(uint64_t)(scanline)>>3));
 } else
  return (_TIFFMultiply64(tif, (((scanline)&0x07)?((uint64_t)(scanline)>>3)+1:(uint64_t)(scanline)>>3),
