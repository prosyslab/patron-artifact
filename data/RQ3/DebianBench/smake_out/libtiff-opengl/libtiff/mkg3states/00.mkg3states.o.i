...
# 0 "-" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c"
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c"
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 2
# 1 "../port/libport.h" 1
# 27 "../port/libport.h"
...
# 32 "../port/libport.h" 2
# 32 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 2
...
# 34 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 2
...
# 35 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 2
...
# 36 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 2
...
# 36 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_fax3.h"
...
# 37 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_fax3.h" 2
...
# 42 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 2
...
void
WriteTable(FILE* fd,  TIFFFaxTabEnt* T, int Size,  char* name)
{
    int i;
    char* sep;
...
main(int argc, char* argv[])
{
 ...
 case '?':
     fprintf(
# 403 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 3 4
            stderr
# 403 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c"
                  ,
  "-",
  argv[0]);
     return (-1);
 }
    outputfile = optind < argc ? argv[optind] : "-";
    fd = fopen(outputfile, "-");
    if (fd == 
# 410 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 3 4
             ((void *)0)
# 410 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c"
                 ) {
 fprintf(
# 411 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c" 3 4
        stderr
# 411 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/mkg3states.c"
              , "-",
     argv[0], outputfile);
 return (-2);
    }
    FillTable(MainTable, 7, Pass, 1);
    FillTable(MainTable, 7, Horiz, 2);
    FillTable(MainTable, 7, V0, 3);
    FillTable(MainTable, 7, VR, 4);
    FillTable(MainTable, 7, VL, 5);
    FillTable(MainTable, 7, Ext, 6);
    FillTable(MainTable, 7, EOLV, 12);
    FillTable(WhiteTable, 12, MakeUpW, 9);
    FillTable(WhiteTable, 12, MakeUp, 11);
    FillTable(WhiteTable, 12, TermW, 7);
    FillTable(WhiteTable, 12, EOLH, 12);
    FillTable(BlackTable, 13, MakeUpB, 10);
    FillTable(BlackTable, 13, MakeUp, 11);
    FillTable(BlackTable, 13, TermB, 8);
    FillTable(BlackTable, 13, EOLH, 12);
    ...
    fprintf(fd, "-");
    fprintf(fd, "-");
    WriteTable(fd, MainTable, 128, "-");
    WriteTable(fd, WhiteTable, 4096, "-");
    WriteTable(fd, BlackTable, 8192, "-");
    fprintf(fd, "-"
                "-"
                "-"
                "-"
