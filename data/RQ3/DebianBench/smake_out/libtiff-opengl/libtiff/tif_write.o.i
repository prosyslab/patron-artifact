# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 2
# 43 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
TIFFWriteScanline(TIFF* tif, void* buf, uint32_t row, uint16_t sample)
{
 ...
 if (!(((tif)->tif_flags&0x00040U) || TIFFWriteCheck((tif),0,module)))
  return (-1);
 ...
 if (!((((tif)->tif_flags & 0x00010U) && tif->tif_rawdata) || TIFFWriteBufferSetup((tif), 
# 61 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
     ((void *)0)
# 61 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
     , (tmsize_t) -1)))
  return (-1);
...
static int _TIFFReserveLargeEnoughWriteBuffer(TIFF* tif, uint32_t strip_or_tile)
{
    ...
    if( td->td_stripbytecount_p[strip_or_tile] > 0 )
    {
        ...
        {
            if( !(TIFFWriteBufferSetup(tif, 
# 193 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                                           ((void *)0)
# 193 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                                               ,
                (tmsize_t)(((((uint64_t)(safe_buffer_size))+(((uint64_t)(1024))-1))/((uint64_t)(1024)))*(1024)))) )
                return 0;
        }
...
TIFFWriteEncodedStrip(TIFF* tif, uint32_t strip, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040U) || TIFFWriteCheck((tif),0,module)))
  return ((tmsize_t) -1);
# 229 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
 ...
 if (!((((tif)->tif_flags & 0x00010U) && tif->tif_rawdata) || TIFFWriteBufferSetup((tif), 
# 245 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
     ((void *)0)
# 245 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
     , (tmsize_t) -1)))
  return ((tmsize_t) -1);
...
TIFFWriteRawStrip(TIFF* tif, uint32_t strip, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040U) || TIFFWriteCheck((tif),0,module)))
  return ((tmsize_t) -1);
# 332 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
 if (strip >= td->td_nstrips) {
  if (td->td_planarconfig == 2) {
   TIFFErrorExt(tif->tif_clientdata, module,
       "Can not grow image by strips when using separate planes");
...
# 390 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
tmsize_t
TIFFWriteEncodedTile(TIFF* tif, uint32_t tile, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040U) || TIFFWriteCheck((tif),1,module)))
  return ((tmsize_t)(-1));
 td = &tif->tif_dir;
 ...
 if (!((((tif)->tif_flags & 0x00010U) && tif->tif_rawdata) || TIFFWriteBufferSetup((tif), 
# 411 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
     ((void *)0)
# 411 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
     , (tmsize_t) -1)))
  return ((tmsize_t)(-1));
...
# 502 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
tmsize_t
...
TIFFSetupStrips(TIFF* tif)
{
 ...
 td->td_nstrips = td->td_stripsperimage;
        ...
        if( td->td_nstrips >= 0x80000000U / ((tif->tif_flags&0x80000U)?0x8U:0x4U) )
        {
...
# 551 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                            ((void *)0) 
# 551 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
# 571 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
int
TIFFWriteCheck(TIFF* tif, int tiles, const char* module)
{
 if (tif->tif_mode == 
# 574 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                     00
# 574 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                             ) {
...
# 597 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
# 618 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                                     ((void *)0) 
# 618 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                                          && !TIFFSetupStrips(tif)) {
  tif->tif_dir.td_nstrips = 0;
  TIFFErrorExt(tif->tif_clientdata, module, "No space for %s arrays",
      (((tif)->tif_flags & 0x00400U) != 0) ? "tile" : "strip");
  return (0);
 }
 if ((((tif)->tif_flags & 0x00400U) != 0))
 {
...
TIFFWriteBufferSetup(TIFF* tif, void* bp, tmsize_t size)
{
 ...
 if (tif->tif_rawdata) {
  ...
  tif->tif_rawdata = 
# 666 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                    ((void *)0)
# 666 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                        ;
 }
 if (size == (tmsize_t)(-1)) {
  size = ((((tif)->tif_flags & 0x00400U) != 0) ?
      tif->tif_tilesize : TIFFStripSize(tif));


                if( size < (tmsize_t)(
# 673 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                          (18446744073709551615UL) 
# 673 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                          >> 1) - size / 10 )
                    size += size / 10;
  ...
  if (size < 8*1024)
   size = 8*1024;
  bp = 
# 680 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
      ((void *)0)
# 680 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
          ;
 }
 if (bp == 
# 682 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
          ((void *)0)
# 682 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
              ) {
  bp = _TIFFmalloc(size);
  if (bp == 
# 684 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
           ((void *)0)
# 684 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
               ) {
...
# 709 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
((void) sizeof ((
# 709 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
# 709 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
, "./libtiff/tif_write.c", 709, __extension__ __PRETTY_FUNCTION__); }))
# 709 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                                                  ;
 ...
 new_stripbytecount = (uint64_t*)_TIFFrealloc(td->td_stripbytecount_p,
  (td->td_nstrips + delta) * sizeof (uint64_t));
 if (new_stripoffset == 
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                       ((void *)0) 
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                            || new_stripbytecount == 
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                                                     ((void *)0)
# 714 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
           ((void) sizeof ((
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
           td->td_nstrips > 0
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
           ) ? 1 : 0), __extension__ ({ if (
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
...
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
           "td->td_nstrips > 0"
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
           , "./libtiff/tif_write.c", 747, __extension__ __PRETTY_FUNCTION__); }))
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                                     ;
                ...
                && td->td_stripbytecount_p[strip] >= (uint64_t) cc )
            {
                ...
                if (!_TIFFSeekOK(tif, td->td_stripoffset_p[strip])) {
                    TIFFErrorExt(tif->tif_clientdata, module,
            ...
            else
            {
                ...
                td->td_stripoffset_p[strip] = ((*(tif)->tif_seekproc)((tif)->tif_clientdata,(0),(
# 773 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c" 3 4
                                             2
# 773 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_write.c"
                                             )));
...
{
 if (tif->tif_rawcc > 0 && tif->tif_flags & 0x100000U ) {
