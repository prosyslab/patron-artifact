...
# 0 "-" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
# 25 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
# 26 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
# 1 "../port/libport.h" 1
# 27 "../port/libport.h"
...
# 32 "../port/libport.h" 2
# 27 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
...
# 29 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
...
# 30 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
...
# 31 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
...
# 31 "../libtiff/tiffiop.h"
# 1 "../libtiff/tif_config.h" 1
# 32 "../libtiff/tiffiop.h" 2
...
extern int open ( char *__file, int __oflag, ...) __attribute__ ((__nonnull__ (1)));
# 205 "/usr/include/fcntl.h" 3 4
extern int openat (int __fd,  char *__file, int __oflag, ...)
     __attribute__ ((__nonnull__ (2)));
# 227 "/usr/include/fcntl.h" 3 4
extern int creat ( char *__file, mode_t __mode) __attribute__ ((__nonnull__ (1)));
...
extern int __open_2 ( char *__path, int __oflag) __attribute__ ((__nonnull__ (1)));
extern int __open_alias ( char *__path, int __oflag, ...) __asm__ ("-" "-")
               __attribute__ ((__nonnull__ (1)));
...
extern void __open_too_many_args (void) __attribute__((__error__ ("-")))
                                                                  ;
extern void __open_missing_mode (void) __attribute__((__error__ ("-")))
                                                                            ;

extern __inline __attribute__ ((__always_inline__)) __attribute__ ((__gnu_inline__)) __attribute__ ((__artificial__)) int
open ( char *__path, int __oflag, ...)
{
...
extern int __openat_2 (int __fd,  char *__path, int __oflag)
     __attribute__ ((__nonnull__ (2)));
extern int __openat_alias (int __fd,  char *__path, int __oflag, ...) __asm__ ("-" "-")

     __attribute__ ((__nonnull__ (2)));
# 111 "/usr/include/x86_64-linux-gnu/bits/fcntl2.h" 3 4
extern void __openat_too_many_args (void) __attribute__((__error__ ("-")))
                                                                    ;
extern void __openat_missing_mode (void) __attribute__((__error__ ("-")))
                                                                             ;

extern __inline __attribute__ ((__always_inline__)) __attribute__ ((__gnu_inline__)) __attribute__ ((__artificial__)) int
openat (int __fd,  char *__path, int __oflag, ...)
{
  if (__builtin_va_arg_pack_len () > 1)
...
# 35 "../libtiff/tiffiop.h" 2
# 44 "../libtiff/tiffiop.h"
...
extern void __assert ( char *__assertion,  char *__file, int __line)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
...
# 50 "../libtiff/tiffiop.h" 2

# 1 "../libtiff/tif_dir.h" 1
# 35 "../libtiff/tif_dir.h"
typedef struct {
  TIFFField *info;
 int count;
 void *value;
} TIFFTagValue;
# 52 "../libtiff/tif_dir.h"
typedef struct {
 uint16_t tdir_tag;
 uint16_t tdir_type;
 uint64_t tdir_count;
...
extern  TIFFFieldArray* _TIFFGetFields(void);
extern  TIFFFieldArray* _TIFFGetExifFields(void);
extern  TIFFFieldArray* _TIFFGetGpsFields(void);
extern void _TIFFSetupFields(TIFF* tif,  TIFFFieldArray* infoarray);
...
extern int _TIFFMergeFields(TIFF*,  TIFFField[], uint32_t);
extern  TIFFField* _TIFFFindOrRegisterField(TIFF *, uint32_t, TIFFDataType);
...
# 52 "../libtiff/tiffiop.h" 2
# 65 "../libtiff/tiffiop.h"
...
# 294 "../libtiff/tiffiop.h"
typedef size_t TIFFIOSize_t;
# 319 "../libtiff/tiffiop.h"
extern int _TIFFgetMode( char* mode,  char* module);
...
extern void _TIFFprintAscii(FILE*,  char*);
extern void _TIFFprintAsciiTag(FILE*,  char*,  char*);
...
extern uint32_t _TIFFMultiply32(TIFF*, uint32_t, uint32_t,  char*);
extern uint64_t _TIFFMultiply64(TIFF*, uint64_t, uint64_t,  char*);
extern tmsize_t _TIFFMultiplySSize(TIFF*, tmsize_t, tmsize_t,  char*);
extern tmsize_t _TIFFCastUInt64ToSSize(TIFF*, uint64_t,  char*);
extern void* _TIFFCheckMalloc(TIFF*, tmsize_t, tmsize_t,  char*);
extern void* _TIFFCheckRealloc(TIFF*, void*, tmsize_t, tmsize_t,  char*);
...
# 37 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
# 50 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
# 1 "../libtiff/tiffio.h" 1
# 51 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2
# 63 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
static union
{
 TIFFHeaderClassic classic;
 TIFFHeaderBig big;
...
static int bigtiff;
static uint32_t maxitems = 24;

static  char bytefmt[] = "-" 
# 76 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                      "-"
# 76 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                           ;
static  char sbytefmt[] = "-" 
# 77 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                    "-"
# 77 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                         ;
static  char shortfmtd[] = "-" 
# 78 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                     "-"
# 78 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                           ;
static  char shortfmth[] = "-" 
# 79 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                      "-"
# 79 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                            ;
static  char sshortfmtd[] = "-" 
# 80 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                      "-"
# 80 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                            ;
static  char sshortfmth[] = "-" 
# 81 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                       "-"
# 81 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                             ;
static  char longfmtd[] = "-" 
# 82 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                    "-"
# 82 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                          ;
static  char longfmth[] = "-" 
# 83 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                     "-"
# 83 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                           ;
static  char slongfmtd[] = "-" 
# 84 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                     "-"
# 84 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                           ;
static  char slongfmth[] = "-" 
# 85 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                      "-"
# 85 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                            ;
static  char ifdfmt[] = "-" 
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                     "-"
# 86 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                           ;
static  char long8fmt[] = "-" 
# 87 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                    "-" "-"
# 87 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                          ;
static  char slong8fmt[] = "-" 
# 88 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                     "-" "-"
# 88 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                           ;
static  char ifd8fmt[] = "-" 
# 89 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                      "-" "-"
# 89 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                            ;
static  char rationalfmt[] = "-";
static  char srationalfmt[] = "-";
static  char floatfmt[] = "-";
...
{
 fprintf(
# 107 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
        stderr
# 107 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
              , "-");
 fprintf(
# 108 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
        stderr
# 108 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
              , "-", appname);
 exit(
# 109 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
     1
# 109 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 );
}
...
main(int argc, char* argv[])
{
 ...
 while ((c = getopt(argc, argv, "-")) != -1) {
  ...
  case 'h':
   ...
   break;
  case 'o':
   diroff = (uint64_t) strtoul(optarg, 
# 129 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                      ((void *)0)
# 129 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                          , 0);
   break;
  case 'm':
   maxitems = strtoul(optarg, 
# 132 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                             ((void *)0)
# 132 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                 , 0);
   break;
  default:
   usage();
 ...
 for (; optind < argc; optind++) {
  fd = open(argv[optind], 
# 141 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                         00
# 141 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                 |0, 0);
  if (fd < 0) {
   perror(argv[0]);
   return (
# 144 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
          1
# 144 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                      );
  }
  if (multiplefiles)
   printf("-", argv[optind]);
 ...
 return (
# 154 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
        0
# 154 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                    );
}
...
{
 unsigned i, j;
 uint64_t* visited_diroff = 
# 168 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                           ((void *)0)
# 168 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                               ;
 ...
 if (read(fd, (char*) &hdr, sizeof (TIFFHeaderCommon)) != sizeof (TIFFHeaderCommon))
  ReadError("-");
 if (hdr.common.tiff_magic != 0x4d4d
     && hdr.common.tiff_magic != 0x4949 &&




     0x5045 != hdr.common.tiff_magic
 ...
 for (i = 0; diroff != 0; i++) {
  for(j=0; j<count_visited_dir; j++)
  {
   ...
   Fatal("-");
                ...
                {
                    size_t alloc_size;
                    alloc_size=((((tmsize_t)(sizeof(uint64_t)) != (tmsize_t)0) && (((tmsize_t)((((count_visited_dir + 1))*(sizeof(uint64_t)))/(sizeof(uint64_t)))) == (tmsize_t)((count_visited_dir + 1)))) ? (tmsize_t)(((count_visited_dir + 1))*(sizeof(uint64_t))) : (tmsize_t)0)
                                                                 ;
                    if (alloc_size == 0)
                    {
                        if (visited_diroff)
...
ReadDirectory(int fd, unsigned int ix, uint64_t off)
{
 ...
 void* dirmem = 
# 302 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
               ((void *)0)
# 302 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                   ;
 ...
 if (off == 0)
  goto done;
 if (lseek(fd,(off_t)off,
# 309 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
    0
# 309 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
    ) != (off_t)off) {
  Fatal("-");
  goto done;
 }
 ...
 dirmem = _TIFFmalloc(((((tmsize_t)(direntrysize) != (tmsize_t)0) && (((tmsize_t)(((dircount)*(direntrysize))/(direntrysize))) == (tmsize_t)(dircount))) ? (tmsize_t)((dircount)*(direntrysize)) : (tmsize_t)0));
 if (dirmem == 
# 337 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
              ((void *)0)
# 337 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                  ) {
  Fatal("-");
  goto done;
 }
 ...
 if (n != dircount*direntrysize) {
  ...
  Error(
     "-" 
# 345 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                        "-" 
# 345 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                               "-" 
# 345 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                       "-" 
# 345 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
# 345 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
 ...
 printf("-" 
# 364 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                "-" "-" 
# 364 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                       "-" 
# 364 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                              "-" "-" 
# 364 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
# 364 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
 ...
 for (dp = (uint8_t*)dirmem, n = dircount; n > 0; n--) {
  ...
  if (swabflag)
   TIFFSwabShort(&type);
  PrintTag(
# 386 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
          stdout
# 386 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                , tag);
  putchar(' ');
  PrintType(
# 388 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
           stdout
# 388 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 , type);
  putchar(' ');
  if (!bigtiff)
  {
  ...
  printf("-" 
# 406 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
            "-" "-" 
# 406 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                   "-", count);
  if (type >= (sizeof (datawidth) / sizeof (datawidth[0])))
   typewidth = 0;
  else
   typewidth = datawidth[type];
  datasize = ((((tmsize_t)(typewidth) != (tmsize_t)0) && (((tmsize_t)(((count)*(typewidth))/(typewidth))) == (tmsize_t)(count))) ? (tmsize_t)((count)*(typewidth)) : (tmsize_t)0);
  ...
  if (!bigtiff)
  {
   if (datasizeoverflow || datasize>4)
   {
    ...
    datafits = 0;
    datamem = 
# 423 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
             ((void *)0)
# 423 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 ;
  ...
  else
  {
   if (datasizeoverflow || datasize>8)
   {
    datafits = 0;
    datamem = 
# 436 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
             ((void *)0)
# 436 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 ;
  ...
  if (!datafits)
  {
   ...
   if (datamem) {
    ...
    "-", tag);
     _TIFFfree(datamem);
     datamem = 
# 465 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
              ((void *)0)
# 465 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                  ;
    }
    ...
    "-", tag);
     _TIFFfree(datamem);
     datamem = 
# 472 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
              ((void *)0)
# 472 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                  ;
    }
   } else
    Error("-",tag);
  ...
  if (datamem)
  {
   ...
   PrintData(
# 510 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
            stdout
# 510 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                  , type, (uint32_t)count, datamem);
   if (datatruncated)
    printf("-");
   if (!datafits)
                                {
                                        _TIFFfree(datamem);
                                        datamem = 
# 516 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                                 ((void *)0)
# 516 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                                                     ;
                                }
  }
  printf("-");
...
PrintTag(FILE* fd, uint16_t tag)
{
 ...
 for (tp = tagnames; tp < &tagnames[(sizeof (tagnames) / sizeof (tagnames[0]))]; tp++)
  if (tp->tag == tag) {
   fprintf(fd, "-", tp->name, tag);
   return;
  }
 fprintf(fd, "-", tag, tag);
}
...
PrintType(FILE* fd, uint16_t type)
{
 ...
 if (type < (sizeof (typenames) / sizeof (typenames[0])))
  fprintf(fd, "-", typenames[type], type);
 else
...
# 672 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 2


# 673 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
static void
PrintASCII(FILE* fd, uint32_t cc,  unsigned char* cp)
{
 for (; cc > 0; cc--, cp++) {
   char* tp;

  if (
# 679 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 679 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
     *cp
# 679 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
...
PrintData(FILE* fd, uint16_t type, uint32_t count, unsigned char* data)
{
 ...
 case TIFF_RATIONAL: {
  ...
  while (count-- > 0) {
   if (lp[1] == 0)
    fprintf(fd, "-"
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                         "-"
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                               "-"
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                   "-"
# 768 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
 ...
 case TIFF_SRATIONAL: {
  ...
  while (count-- > 0) {
   if (lp[1] == 0)
    fprintf(fd, "-"
# 782 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                         "-"
# 782 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                               "-"
# 782 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
                                   "-"
# 782 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
static void
vError(FILE* fd,  char* fmt, va_list ap)
{
 fprintf(fd, "-", curfile);
 vfprintf(fd, fmt, ap);
 fprintf(fd, "-");
...
# 844 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
__builtin_va_start(
# 844 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
ap
# 844 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
,
# 844 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
# 844 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 ;
 vError(
# 845 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
       stderr
# 845 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
             , fmt, ap);
 
# 846 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
__builtin_va_end(
# 846 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
ap
# 846 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
)
# 846 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
# 853 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
__builtin_va_start(
# 853 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
ap
# 853 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
,
# 853 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
...
# 853 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 ;
 vError(
# 854 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
       stderr
# 854 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
             , fmt, ap);
 
# 855 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
__builtin_va_end(
# 855 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
ap
# 855 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
)
# 855 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
          ;
 exit(
# 856 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c" 3 4
     1
# 856 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffdump.c"
                 );
}
