...
static int TIFFGrowStrips(TIFF* tif, uint32_t delta,  char* module);
...
int
TIFFWriteCheck(TIFF* tif, int tiles,  char* module)
{
 if (tif->tif_mode == 
...
static int
TIFFGrowStrips(TIFF* tif, uint32_t delta,  char* module)
{
 TIFFDirectory *td = &tif->tif_dir;
