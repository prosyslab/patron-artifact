...
# 0 "-" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
# 28 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
...
# 29 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c" 2

int
TIFFFlush(TIFF* tif)
{
    if( tif->tif_mode == 
# 33 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c" 3 4
                        00 
# 33 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
                                 )
        return 1;
    ...
    if( (tif->tif_flags & 0x200000U)
        && !(tif->tif_flags & 0x00008U)
        && tif->tif_mode == 
# 46 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c" 3 4
                           02 
# 46 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
                                  )
    {
    ...
    if ((tif->tif_flags & (0x00008U|0x200000U))
        && !TIFFRewriteDirectory(tif))
        return (0);

    return (1);
}
# 78 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
int TIFFForceStrileArrayWriting(TIFF* tif)
{
    ...
    if (tif->tif_mode == 
# 83 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c" 3 4
                        00
# 83 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
                                )
    {
    ...
    if( !(tif->tif_flags & 0x200000U) )
    {
        ...
        if (tif->tif_dir.td_stripoffset_p == 
# 120 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c" 3 4
                                            ((void *)0) 
# 120 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
                                                 && !TIFFSetupStrips(tif))
            return 0;
    }
...
# 154 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_flush.c"
int
TIFFFlushData(TIFF* tif)
{
 if ((tif->tif_flags & 0x00040U) == 0)
  return (1);
