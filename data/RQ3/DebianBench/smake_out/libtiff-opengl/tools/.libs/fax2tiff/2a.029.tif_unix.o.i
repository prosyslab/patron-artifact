...
extern int stat ( char *__restrict __file,
...
extern int fstatat (int __fd,  char *__restrict __file,
      struct stat *__restrict __buf, int __flag)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (2, 3)));
# 313 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3 4
extern int lstat ( char *__restrict __file,
    struct stat *__restrict __buf) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
...
extern int lchmod ( char *__file, __mode_t __mode)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
...
extern int fchmodat (int __fd,  char *__file, __mode_t __mode,
       int __flag)
...
extern int mkdirat (int __fd,  char *__path, __mode_t __mode)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (2)));
...
extern int mknodat (int __fd,  char *__path, __mode_t __mode,
...
extern int mkfifoat (int __fd,  char *__path, __mode_t __mode)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (2)));
...
extern int utimensat (int __fd,  char *__path,
         struct timespec __times[2],
        int __flags)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (2)));
# 452 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3 4
extern int futimens (int __fd,  struct timespec __times[2]) __attribute__ ((__nothrow__ , __leaf__));
...
# 103 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_unix.c"
 ...
 fdh.h = fd;
        ...
        {
                 char *buf_offset = (char *) buf+bytes_written;
...
extern int mlock ( void *__addr, size_t __len) __attribute__ ((__nothrow__ , __leaf__));


extern int munlock ( void *__addr, size_t __len) __attribute__ ((__nothrow__ , __leaf__));
...
# 240 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_unix.c"
   ...
   TIFFErrorExt(0, module, "-", name, strerror(
...
void
_TIFFmemcpy(void* d,  void* s, tmsize_t c)
{
 memcpy(d, s, (size_t) c);
}

int
_TIFFmemcmp( void* p1,  void* p2, tmsize_t c)
{
 return (memcmp(p1, p2, (size_t) c));
}

static void
unixWarningHandler( char* module,  char* fmt, va_list ap)
{
 if (module != 
...
static void
unixErrorHandler( char* module,  char* fmt, va_list ap)
{
 if (module != 
