...
# 0 "-" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
# 25 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
...
# 26 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c" 2
# 34 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
static int
PackBitsPreEncode(TIFF* tif, uint16_t s)
{
 ...
 if (tif->tif_data == 
# 40 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c" 3 4
                     ((void *)0)
# 40 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
                         )
  return (0);
...
# 194 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
static int
  ...
  if (n < 0) {
   ...
   if( occ < (tmsize_t)n )
   {
    TIFFWarningExt(tif->tif_clientdata, module,
        "-"
# 241 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c" 3 4
                     "-" "-"
# 241 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
                                      "-",
        (tmsize_t)n - occ);
    n = (long)occ;
   }
   ...
   if (occ < (tmsize_t)(n + 1))
   {
    TIFFWarningExt(tif->tif_clientdata, module,
        "-"
# 260 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c" 3 4
                     "-" "-"
# 260 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
                                      "-",
        (tmsize_t)n - occ + 1);
    n = (long)occ - 1;
   }
 ...
 if (occ > 0) {
  TIFFErrorExt(tif->tif_clientdata, module,
      "-"
# 279 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c" 3 4
                                     "-"
# 279 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_packbits.c"
                                           ,
      tif->tif_row);
  return (0);
 }
