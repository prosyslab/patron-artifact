...
# 248 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/fax2ps.c"
    ...
    printf("-", points/xres*scale, -points/yres*scale);
    printf("-");
...
# 414 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/fax2ps.c"
 ...
 tif = TIFFFdOpen(fileno(fd), "-", "-");

 if (tif) {
     fax2ps(tif, npages, pages, "-");
     TIFFClose(tif);
 } else
     fprintf(
