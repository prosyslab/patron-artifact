...
static void leof( char*, uint32_t, int);
...
tiffcmp(TIFF* tif1, TIFF* tif2)
{
 ...
 if (!CheckShortTag(tif1, tif2, 258, "-"))
  return (0);
 if (!CheckShortTag(tif1, tif2, 277, "-"))
  return (0);
 if (!CheckLongTag(tif1, tif2, 256, "-"))
  return (0);
...
cmptags(TIFF* tif1, TIFF* tif2)
{
 ...
 if (!CheckLongTag(tif1, tif2, 254, "-") && stoponfirsttag) return (0);
 if (!CheckLongTag(tif1, tif2, 256, "-") && stoponfirsttag) return (0);
 if (!CheckLongTag(tif1, tif2, 257, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 258, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 259, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 317, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 262, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 263, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 266, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 274, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 277, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 280, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 281, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 339, "-") && stoponfirsttag) return (0);
 if (!CheckFloatTag(tif1, tif2, 282, "-") && stoponfirsttag) return (0);
 if (!CheckFloatTag(tif1, tif2, 283, "-") && stoponfirsttag) return (0);
 if( TIFFGetField(tif1, 259, &compression1) &&
  compression1 == 3 &&
  TIFFGetField(tif2, 259, &compression2) &&
  compression2 == 3 )
 {
  if (!CheckLongTag(tif1, tif2, 292, "-") && stoponfirsttag) return (0);
 }
 if( TIFFGetField(tif1, 259, &compression1) &&
  compression1 == 4 &&
  TIFFGetField(tif2, 259, &compression2) &&
  compression2 == 4 )
 {
  if (!CheckLongTag(tif1, tif2, 293, "-") && stoponfirsttag) return (0);
 }
 if (!CheckShortTag(tif1, tif2, 296, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 284, "-") && stoponfirsttag) return (0);
 if (!CheckLongTag(tif1, tif2, 278, "-") && stoponfirsttag) return (0);
 if (!CheckFloatTag(tif1, tif2, 286, "-") && stoponfirsttag) return (0);
 if (!CheckFloatTag(tif1, tif2, 287, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 290, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 300, "-") && stoponfirsttag) return (0);
# 319 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffcmp.c"
 if (!CheckShort2Tag(tif1, tif2, 297, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 315, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 270, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 271, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 272, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 305, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 306, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 316, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 285, "-") && stoponfirsttag) return (0);
 if (!CheckStringTag(tif1, tif2, 269, "-") && stoponfirsttag) return (0);
 if (!CheckShortTag(tif1, tif2, 32995, "-") && stoponfirsttag) return (0);
 if (!CheckShortArrayTag(tif1, tif2, 338, "-") && stoponfirsttag) return (0);
 return (1);
}
...
{
 uint16_t v1, v2;
 { switch (checkTag(tif1,tif2,tag,name,&v1,&v2)) { case 1: if (v1 == v2) case -1: return (1); printf("-"
...
{
 float v1, v2;
 { switch (checkTag(tif1,tif2,tag,name,&v1,&v2)) { case 1: if (v1 == v2) case -1: return (1); printf("-", name, v1, v2); } return (0); };
}
...
{
 char *v1, *v2;
 { switch (checkTag(tif1,tif2,tag,name,&v1,&v2)) { case 1: if (strcmp(v1, v2) == 0) case -1: return (1); printf("-", name, v1, v2); } return (0); };
}

static void
leof( char* name, uint32_t row, int s)
{
