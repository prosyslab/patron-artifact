...
{
  TIFFCodec *c = TIFFFindCODEC((uint16_t) scheme);
...
TIFFCodec*
TIFFRegisterCODEC(uint16_t scheme,  char* name, TIFFInitMethod init)
{
 codec_t* cd = (codec_t*)
...
# 276 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/libtiff/tif_compress.c"
   ...
   codecs = new_codecs;
   _TIFFmemcpy(codecs + i - 1, ( void*)c, sizeof(TIFFCodec));
   i++;
  }
 }
