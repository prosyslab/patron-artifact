# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
...
# 250 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
               , "MemoryLimitError: allocation of %" 
# 250 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c" 3 4
                                                     "l" "d" 
# 250 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
                                                                       " bytes is forbidden. Limit is %" 
# 250 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c" 3 4
                                                                                                         "l" "d" 
# 250 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
                                                                                                                           ".\n",
...
# 549 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
 ...
 default:
  TIFFError(filename,
      "Can not handle image with PhotometricInterpretation=%"
...
# 580 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
 ...
 case 16:
  break;
 default:
  TIFFError(filename, "Can not handle %"
...
static const char RGBcolorimage[] = "/bwproc {\n    rgbproc\n    dup length 3 idiv string 0 3 0\n    5 -1 roll {\n	add 2 1 roll 1 sub dup 0 eq {\n	    pop 3 idiv\n	    3 -1 roll\n	    dup 4 -1 roll\n	    dup 3 1 roll\n	    5 -1 roll put\n	    1 add 3 0\n	} { 2 1 roll } ifelse\n    } forall\n    pop pop pop\n} def\n/colorimage where {pop} {\n    /colorimage {pop pop /rgbproc exch def {bwproc} image} bind def\n} ifelse\n";
  ...
  switch (rotation)
    ...
    case 180: if ((splitheight > 0) || (splitwidth > 0))
               ...
               if (pgwidth != 0 || pgheight != 0)
                ...
                fprintf (fd, "%%%%PageBoundingBox: 0 0 %"
...
PS_Lvl2page(FILE* fd, TIFF* tif, uint32_t w, uint32_t h)
{
 ...
 if (!buf_data) {
  TIFFError(filename, "Can't alloc %"
...
# 2231 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiff2ps.c"
 ...
 for (chunk_no = 0; chunk_no < num_chunks; chunk_no++) {
  ...
  if (byte_count < 0) {
   TIFFError(filename, "Can't read %s %"
...
PSDataColorContig(FILE* fd, TIFF* tif, uint32_t w, uint32_t h, int nc)
{
 ...
 (void) w;
        if( es < 0 )
        {
            TIFFError(filename, "Inconsistent value of es: %d (samplesperpixel=%"
