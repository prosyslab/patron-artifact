# 0 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
# 41 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
...
# 42 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 2
# 1 "../port/libport.h" 1
# 27 "../port/libport.h"
...
# 32 "../port/libport.h" 2
# 43 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 2
...
# 45 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 2
...
# 46 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 2
...
# 47 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 2
...
# 53 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 2
# 77 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
...
static uint16_t rm[256], gm[256], bm[256];
static int num_colors;
static uint32_t histogram[(1L<<5)][(1L<<5)][(1L<<5)];
 ...
 while ((c = getopt(argc, argv, "c:C:r:fh")) != -1)
  ...
  case 'c':
   if (!processCompressOptions(optarg))
    usage(
# 138 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 138 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );
   break;
  case 'C':
   ...
   if (num_colors > 256) {
    fprintf(
# 143 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
           stderr
# 143 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                 ,
       "-c: colormap too big, max %d\n",
       256);
    usage(
# 146 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 146 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );
   }
   break;
  case 'f':
  ...
  case 'h':
   usage(
# 156 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
        0
# 156 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                    );

                        break;
  case '?':
   usage(
# 160 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
        1
# 160 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                    );
 ...
 if (argc - optind != 2)
  usage(
# 165 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
       1
# 165 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                   );
 in = TIFFOpen(argv[optind], "r");
 if (in == 
# 167 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
          ((void *)0)
# 167 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
              )
  return (
# 168 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 168 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );
 ...
 if (bitspersample != 8 && bitspersample != 16) {
  fprintf(
# 174 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         stderr
# 174 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
               , "%s: Image must have at least 8-bits/sample\n",
      argv[optind]);
  return (
# 176 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 176 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );
 }
 if (!TIFFGetField(in, 262, &photometric) ||
     photometric != 2 || samplesperpixel < 3) {
  fprintf(
# 180 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         stderr
# 180 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
               , "%s: Image must have RGB data\n", argv[optind]);
  return (
# 181 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 181 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );
 }
 TIFFGetField(in, 284, &config);
 if (config != 1) {
  fprintf(
# 185 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         stderr
# 185 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
               , "%s: Can only handle contiguous data packing\n",
      argv[optind]);
  return (
# 187 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 187 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );
 }
 ...
 usedboxes = 
# 193 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
            ((void *)0)
# 193 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                ;
 box_list = freeboxes = (Colorbox *)_TIFFmalloc(num_colors*sizeof (Colorbox));
 freeboxes[0].next = &freeboxes[1];
 freeboxes[0].prev = 
# 196 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                    ((void *)0)
# 196 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                        ;
 for (i = 1; i < num_colors-1; ++i) {
  freeboxes[i].next = &freeboxes[i+1];
  freeboxes[i].prev = &freeboxes[i-1];
 }
 freeboxes[num_colors-1].next = 
# 201 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                               ((void *)0)
# 201 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                                   ;
 ...
 if (freeboxes)
  freeboxes->prev = 
# 210 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                   ((void *)0)
# 210 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                       ;
 ptr->next = usedboxes;
 usedboxes = ptr;
 if (ptr->next)
 ...
 while (freeboxes != 
# 221 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                    ((void *)0)
# 221 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                        ) {
  ptr = largest_box();
  if (ptr != 
# 223 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
            ((void *)0)
# 223 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                )
   splitbox(ptr);
  else
   freeboxes = 
# 226 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
              ((void *)0)
# 226 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                  ;
 }
 ...
 for (i = 0, ptr = usedboxes; ptr != 
# 232 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                                    ((void *)0)
# 232 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                                        ; ++i, ptr = ptr->next) {
 ...
 _TIFFfree(box_list);
 freeboxes = usedboxes = 
# 240 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                        ((void *)0)
# 240 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                            ;
 ...
 if (out == 
# 256 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
           ((void *)0)
# 256 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
               )
  return (
# 257 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         1
# 257 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     );

 if (TIFFGetField(in, 254, &longv)) TIFFSetField(out, 254, longv);
 if (TIFFGetField(in, 256, &longv)) TIFFSetField(out, 256, longv);
 ...
 (void) TIFFClose(out);
 return (
# 302 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
        0
# 302 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                    );
}
...
{
 FILE * out = (code == 
# 358 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                      0
# 358 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                                  ) ? 
# 358 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                                      stdout 
# 358 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
...
get_histogram(TIFF* in, Colorbox* box)
{
 ...
 if (inputline == 
# 374 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                 ((void *)0)
# 374 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                     ) {
  fprintf(
# 375 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
         stderr
# 375 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
               , "No space for scanline buffer\n");
  exit(
# 376 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
      1
# 376 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                  );
 }
 ...
 for (i = 0; i < imagelength; i++) {
  ...
  for (j = imagewidth; j-- > 0;) {
   red = (*inptr++) & 0xff >> (8 -5);
   green = (*inptr++) & 0xff >> (8 -5);
   blue = (*inptr++) & 0xff >> (8 -5);
                        if ((red | green | blue) >= (1L<<5)) {
                                fprintf(
# 395 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                                       stderr
# 395 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                                             ,
                                        "Logic error. "
                                        "Histogram array overflow!\n");
                                exit(
# 398 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                                    1
# 398 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                                                );
                        }
   if (red < box->rmin)
    box->rmin = red;
...
largest_box(void)
{
 ...
 b = 
# 424 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
    ((void *)0)
# 424 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
        ;
 size = 0;
 for (p = usedboxes; p != 
# 426 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                         ((void *)0)
# 426 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                             ; p = p->next)
...
splitbox(Colorbox* ptr)
{
 ...
 if (freeboxes)
  freeboxes->prev = 
# 517 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
                   ((void *)0)
# 517 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                       ;
 if (usedboxes)
  usedboxes->prev = new;
 new->next = usedboxes;
 ...
 *(ColorCells + ir*(1L<<2)*(1L<<2) + ig*(1L<<2) + ib) = ptr;
 ...
 for (i = 0; i < num_colors; ++i) {
  ...
  dist = 0;
         if ((tmp = red - rm[i]) > 0 ||
      (tmp = rm[i] - (red + 256/(1L<<2)-1)) > 0 )
   dist += tmp*tmp;
         if ((tmp = green - gm[i]) > 0 ||
      (tmp = gm[i] - (green + 256/(1L<<2)-1)) > 0 )
   dist += tmp*tmp;
         if ((tmp = blue - bm[i]) > 0 ||
      (tmp = bm[i] - (blue + 256/(1L<<2)-1)) > 0 )
   dist += tmp*tmp;
         if (dist < mindist) {
   ptr->entries[ptr->num_ents][0] = i;
  ...
  for (ig = 0; ig < (1L<<5); ++ig)
   for (ib = 0; ib < (1L<<5); ++ib, histp++) {
    ...
    cell = *(ColorCells +
        ...
        (ib>>(5 -2))));
    if (cell == 
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
               ((void *)0) 
# 747 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                    )
...
# 828 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
static void
quant_fsdither(TIFF* in, TIFF* out)
{
 ...
 do { if (TIFFReadScanline(in, inputline, 0, 0) <= 0) goto bad; inptr = inputline; nextptr = nextline; for (j = 0; j < imagewidth; ++j) { *nextptr++ = *inptr++; *nextptr++ = *inptr++; *nextptr++ = *inptr++; } } while (0);;
 for (i = 1; i <= imagelength; ++i) {
  { short * p; p = thisline; thisline = nextline; nextline = p; };
  lastline = (i >= imax);
  if (i <= imax)
   do { if (TIFFReadScanline(in, inputline, i, 0) <= 0) break; inptr = inputline; nextptr = nextline; for (j = 0; j < imagewidth; ++j) { *nextptr++ = *inptr++; *nextptr++ = *inptr++; *nextptr++ = *inptr++; } } while (0);;
  thisptr = thisline;
  nextptr = nextline;
  outptr = outline;
  for (j = 0; j < imagewidth; ++j) {
   ...
   lastpixel = (j == jmax);
   do { r2 = *thisptr++; if (r2 < 0) r2 = 0; else if (r2 >= 256) r2 = 256 -1; red = r2; r2 >>= (8 -5); } while (0);;
   do { g2 = *thisptr++; if (g2 < 0) g2 = 0; else if (g2 >= 256) g2 = 256 -1; green = g2; g2 >>= (8 -5); } while (0);;
   do { b2 = *thisptr++; if (b2 < 0) b2 = 0; else if (b2 >= 256) b2 = 256 -1; blue = b2; b2 >>= (8 -5); } while (0);;
   ...
   if (oval == -1) {
    ...
    cell = *(ColorCells +
        ...
        (b2>>(5 -2))));
    if (cell == 
# 873 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c" 3 4
               ((void *)0)
# 873 "/root/patron-artifact-new/data/RQ3/DebianBench/smake_out/libtiff-opengl_tmp/tiff-4.3.0/tools/tiffmedian.c"
                   )
