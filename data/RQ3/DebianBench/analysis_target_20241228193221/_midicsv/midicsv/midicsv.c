...
#line 399
    ...
    {
#line 401
    fprintf(stderr, "-ANn~U", progname);
    }
    {
#line 402
    fprintf(stderr, "-");
#line 403
    fprintf(stderr, "-UMn~U");
#line 404
    fprintf(stderr, "-");
#line 405
    fprintf(stderr, "-SMn~U", "-");
    }
#line 406
    return (0);
    case_118: /* CIL Label */ 
...
#line 410
    ...
    {
#line 413
    fprintf(stderr, "-GNn~U", progname, n);
    }
#line 415
    return (2);
    switch_break: /* CIL Label */ ;
...
#line 459
  __cil_tmp17 = memcmp((char *)mh.chunktype, "-YNn~U", sizeof(mh.chunktype));
  }
#line 459
  if (__cil_tmp17 != 0) {
    {
...
#line 463
  if (verbose) {
    {
#line 464
    fprintf(stderr, "-DMn~U", (int )mh.format, (int )mh.ntrks, (int )mh.division);
    }
  }
  {
#line 470
...
#line 483
    __cil_tmp21 = memcmp((char *)mt.chunktype, "-9Mn~U", sizeof(mt.chunktype));
    }
#line 483
    if (__cil_tmp21 != 0) {
      {
#line 484
      fprintf(stderr, "-7Mn~U", i + 1);
      }
#line 485
      return (2);
    }
