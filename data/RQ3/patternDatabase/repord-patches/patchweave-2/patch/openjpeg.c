...
#line 11 "../original/patch/openjpeg.c"
...
extern int opj_event_msg(int  , char const   *  , ...) ;
...
#line 43 "../original/patch/openjpeg.c"
...
#line 46
  image = j2k->image;
#line 48
  __cil_tmp4 = cio_read(cio, 4);
#line 48
  image->x1 = (int )__cil_tmp4;
#line 49
  __cil_tmp5 = cio_read(cio, 4);
#line 49
  image->y1 = (int )__cil_tmp5;
#line 50
  __cil_tmp6 = cio_read(cio, 4);
#line 50
  image->x0 = (int )__cil_tmp6;
#line 51
  __cil_tmp7 = cio_read(cio, 4);
#line 51
  image->y0 = (int )__cil_tmp7;
#line 53
  __cil_tmp8 = cio_read(cio, 1);
#line 53
  image->comps.dx = (int )__cil_tmp8;
#line 54
  __cil_tmp9 = cio_read(cio, 1);
#line 54
  image->comps.dy = (int )__cil_tmp9;
  }
#line 56
  if (! (image->comps.dx * image->comps.dy)) {
    {
#line 57
    opj_event_msg(1, (char const   *)"JPWL: invalid component size (dx: %d, dy: %d)\n",
...
#line 61
  w = (((image->x1 - image->x0) + image->comps.dx) - 1) / image->comps.dx;
#line 62
  h = (((image->y1 - image->y0) + image->comps.dy) - 1) / image->comps.dy;
  return;
}
}
#line 65 "../original/patch/openjpeg.c"
