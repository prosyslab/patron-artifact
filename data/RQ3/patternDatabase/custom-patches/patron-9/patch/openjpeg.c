...
#line 4 "../original/patch/openjpeg.c"
struct opj_pi_comp_t {
   unsigned int dx ;
   unsigned int dy ;
   unsigned int numresolutions ;
};
#line 8 "../original/patch/openjpeg.c"
typedef struct opj_pi_comp_t opj_pi_comp_t;
#line 10 "../original/patch/openjpeg.c"
struct opj_pi_iterator_t {
   opj_pi_comp_t *comps ;
   unsigned int tx0 ;
   unsigned int resno ;
};
#line 14 "../original/patch/openjpeg.c"
...
#line 16 "../original/patch/openjpeg.c"
...
{ 
  ...
  {
#line 18
  __cil_tmp4 = fopen((char const   *)"test.txt", (char const   *)"r");
#line 18
  file = __cil_tmp4;
#line 19
  fread(& comp.dx, (unsigned long )1, (unsigned long )100, file);
#line 20
  fread(& comp.dy, (unsigned long )1, (unsigned long )100, file);
#line 21
  fread(& comp.numresolutions, (unsigned long )1, (unsigned long )100, file);
#line 22
  pi->comps = & comp;
#line 23
  fread(& pi->tx0, (unsigned long )1, (unsigned long )100, file);
#line 24
  fread(& pi->resno, (unsigned long )1, (unsigned long )100, file);
#line 25
  fclose(file);
  }
  return;
...
#line 29 "../original/patch/openjpeg.c"
...
#line 38
  trx0 = (int )(((pi->tx0 + (comp.dx << levelno)) - 1U) / (comp.dx << levelno));
#line 39
  return (trx0);
}
}
