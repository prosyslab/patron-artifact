...
#line 17 "original/patch/openjpeg.c"
typedef struct opj_cio opj_cio_t;
#line 21 "original/patch/openjpeg.c"
struct __anonstruct_3 {
   int dx ;
   int dy ;
};
#line 19 "original/patch/openjpeg.c"
struct opj_image {
   int x0 ;
   int y0 ;
   int x1 ;
...
#line 24 "original/patch/openjpeg.c"
typedef struct opj_image opj_image_t;
#line 26 "original/patch/openjpeg.c"
struct opj_j2k {
   struct opj_cio *cio ;
...
#line 31 "original/patch/openjpeg.c"
...
#line 35
  fp = __cil_tmp3;
#line 36
  j2k->cio = (struct opj_cio *)malloc(sizeof(opj_cio_t ));
#line 37
  j2k->image = (struct opj_image *)malloc(sizeof(opj_image_t ));
#line 38
  j2k->cp = (struct opj_cp *)malloc(sizeof(opj_cp_t ));
#line 39
  (j2k->cio)->bp = (unsigned char *)malloc((unsigned long )1028);
#line 40
...
#line 45 "original/patch/openjpeg.c"
...
#line 49 "original/patch/openjpeg.c"
...
#line 60 "original/patch/openjpeg.c"
...
#line 66
  image->x1 = (int )__cil_tmp5;
#line 67
  __cil_tmp6 = cio_read(cio, 4);
#line 67
  image->y1 = (int )__cil_tmp6;
#line 69
  __cil_tmp7 = cio_read(cio, 4);
#line 69
  cp->tdx = (int )__cil_tmp7;
#line 70
  __cil_tmp8 = cio_read(cio, 4);
#line 70
  cp->tdy = (int )__cil_tmp8;
#line 71
  __cil_tmp9 = cio_read(cio, 4);
#line 71
  cp->tx0 = (int )__cil_tmp9;
#line 72
  __cil_tmp10 = cio_read(cio, 4);
#line 72
  cp->ty0 = (int )__cil_tmp10;
#line 74
...
#line 77
  if (cp->tw == 0) {
    ...
    {
#line 78
    opj_event_msg(j2k->cinfo, 1, (char const   *)"Invalid number of tiles : %u x %u (maximum fixed by jpeg2000 norm is 65535 tiles)\n",
                  cp->tw, cp->th);
    }
    }
    }
...
#line 81
  ...
  {
#line 84
  __cil_tmp11 = calloc((unsigned long )(cp->tw * cp->th), sizeof(opj_tcp_t ));
#line 84
  cp->tcps = (opj_tcp_t *)__cil_tmp11;
  }
  return;
}
}
#line 87 "original/patch/openjpeg.c"
