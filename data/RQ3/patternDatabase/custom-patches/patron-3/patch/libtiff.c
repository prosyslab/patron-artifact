...
#line 9 "../original/patch/libtiff.c"
struct image_data {
   unsigned short spp ;
   unsigned int combined_width ;
};
#line 12 "../original/patch/libtiff.c"
typedef struct image_data image_data;
#line 14 "../original/patch/libtiff.c"
struct TIFF {
   FILE *file ;
};
#line 16 "../original/patch/libtiff.c"
...
#line 18 "../original/patch/libtiff.c"
int writeBufferToSeparateStrips(TIFF *out , unsigned int width , unsigned short spp ) 
{ 
...
#line 25
  if (width == 0U) {
    ...
    {
#line 26
    __cil_tmp6 = TIFFFileName(out);
    }
    }
    {
    {
#line 26
    TIFFError(__cil_tmp6, "Error, uint32 overflow when computing (bps * spp * width) + 7");
    }
    }
    }
#line 28
...
#line 25
  if ((long )((unsigned int )bps * (unsigned int )spp) > 4294967294L / (long )width) {
    {
    {
    {
#line 26
...
#line 25
  if ((long )((unsigned int )((int )bps * (int )spp) * width) > 4294967287L) {
    {
    {
    {
#line 26
...
#line 31
  rowsize = ((unsigned int )((int )bps * (int )spp) * width + 7U) / 8U;
  return (0);
}
}
#line 35 "../original/patch/libtiff.c"
int writeCroppedImage(TIFF *out , struct image_data *image , unsigned int width ) 
{ 
  int spp ;
...
#line 36
  spp = (int )image->spp;
#line 37
  writeBufferToSeparateStrips(out, width, (unsigned short )spp);
  }
#line 38
  return (0);
}
}
#line 41 "../original/patch/libtiff.c"
...
{ 
  ...
  {
#line 42
  fread(*read_buff, (unsigned long )1, (unsigned long )100, in->file);
  }
  return;
}
}
#line 45 "../original/patch/libtiff.c"
...
{ 
  ...
  {
#line 46
  fread(image->combined_width, 1, 100, 0);
#line 47
  fread(image->spp, 1, 100, 0);
  }
  return;
}
}
#line 50 "../original/patch/libtiff.c"
FILE *TIFFOpen(char const   *filename , char const   *mode ) 
{ 
  FILE *file ;
  FILE *__cil_tmp4 ;
  TIFF *tiff ;
  ...
  {
#line 51
  __cil_tmp4 = fopen(filename, mode);
#line 51
  file = __cil_tmp4;
#line 52
  __cil_tmp6 = malloc(sizeof(TIFF ));
#line 52
  tiff = __cil_tmp6;
#line 53
  tiff->file = file;
...
#line 57 "../original/patch/libtiff.c"
...
#line 63
  in = (TIFF *)TIFFOpen((char const   *)argv[1], (char const   *)"r");
#line 64
  out = (TIFF *)TIFFOpen((char const   *)argv[2], (char const   *)"w");
#line 66
