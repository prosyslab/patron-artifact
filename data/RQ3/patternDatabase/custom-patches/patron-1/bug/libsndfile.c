...
#line 74 "/usr/include/clang/13.0.1/include/stddef.h"
typedef int wchar_t;
...
#line 5 "../original/patch/libsndfile.c"
typedef int FILE;
#line 7 "../original/patch/libsndfile.c"
struct SF_PRIVATE {
   FILE *file ;
   int dataoffset ;
   int dataend ;
...
#line 19 "../original/patch/libsndfile.c"
...
#line 21 "../original/patch/libsndfile.c"
...
#line 25
  psf->datalength = tmp;
#line 28
  tmp = psf->datalength / psf->blockwidth;
#line 28
  psf->frames = tmp;
#line 30
  return (0);
...
#line 33 "../original/patch/libsndfile.c"
...
{ 
  ...
  {
#line 34
  fread(& psf->channels, (unsigned long )1, (unsigned long )1, psf->file);
#line 35
  fread(& psf->samplerate, (unsigned long )1, (unsigned long )1, psf->file);
#line 36
  fread(& psf->format, (unsigned long )1, (unsigned long )1, psf->file);
#line 37
  fread(& psf->frames, (unsigned long )1, (unsigned long )1, psf->file);
#line 38
  fread(& psf->filelength, (unsigned long )1, (unsigned long )1, psf->file);
#line 39
  fread(& psf->dataoffset, (unsigned long )1, (unsigned long )1, psf->file);
#line 40
  fread(& psf->dataend, (unsigned long )1, (unsigned long )1, psf->file);
#line 41
  fread(& psf->bytewidth, (unsigned long )1, (unsigned long )1, psf->file);
  }
#line 42
  return (0);
}
}
#line 46 "../original/patch/libsndfile.c"
...
#line 52 "../original/patch/libsndfile.c"
...
{ 
  ...
  {
#line 53
  __cil_tmp3 = w64_open(psf);
  }
#line 53
  return (__cil_tmp3);
}
}
#line 56 "../original/patch/libsndfile.c"
...
#line 60
  psf->frames = 1;
#line 61
  psf->file = fopen((char const   *)path, (char const   *)"rb");
#line 62
  psf->dataoffset = 0;
#line 63
  psf->dataend = 0;
...
#line 71 "../original/patch/libsndfile.c"
...
{ 
  ...
  {
#line 73
  __cil_tmp4 = malloc(sizeof(SF_PRIVATE ));
#line 73
  psf = (SF_PRIVATE *)__cil_tmp4;
#line 74
  psf_init_files(psf, (char *)path);
#line 75
  __cil_tmp5 = psf_open_file(psf, mode);
  }
#line 75
  return (__cil_tmp5);
}
}
#line 78 "../original/patch/libsndfile.c"
...
#line 88 "../original/patch/libsndfile.c"
