...
#line 49
  image->y1 = (int )__cil_tmp4;
#line 51
  __cil_tmp5 = cio_read(cio, 4);
#line 51
  image->y0 = (int )__cil_tmp5;
  }
#line 53
  if (image->y0 < 0) {
    {
    {
#line 54
    opj_event_msg(0, 1, "%s: invalid image size (y0:%d, y1:%d)\n", image->y0, image->y1);
    }
    }
#line 57
    return;
...
#line 68 "../original/patch/openjpeg.c"
