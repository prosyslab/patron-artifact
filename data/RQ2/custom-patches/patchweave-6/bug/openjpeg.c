...
#line 5 "../original/patch/openjpeg.c"
struct opj_tcp {
   int tw ;
   int th ;
   int tdx ;
...
#line 7 "../original/patch/openjpeg.c"
typedef struct opj_tcp opj_tcp_t;
#line 9 "../original/patch/openjpeg.c"
struct opj_cp {
   int tx0 ;
   int ty0 ;
   int tdx ;
...
#line 13 "../original/patch/openjpeg.c"
typedef struct opj_cp opj_cp_t;
#line 15 "../original/patch/openjpeg.c"
struct opj_cio {
   unsigned char *bp ;
   unsigned char *end ;
};
#line 18 "../original/patch/openjpeg.c"
typedef struct opj_cio opj_cio_t;
#line 22 "../original/patch/openjpeg.c"
struct __anonstruct_3 {
   int dx ;
   int dy ;
};
#line 20 "../original/patch/openjpeg.c"
struct opj_image {
   int x0 ;
   int y0 ;
   int x1 ;
   int y1 ;
   struct __anonstruct_3 comps ;
};
#line 25 "../original/patch/openjpeg.c"
typedef struct opj_image opj_image_t;
#line 27 "../original/patch/openjpeg.c"
struct opj_j2k {
   struct opj_cio *cio ;
...
#line 32 "../original/patch/openjpeg.c"
typedef struct opj_j2k opj_j2k_t;
#line 34 "../original/patch/openjpeg.c"
struct opj_jp2_box {
   unsigned int length ;
   unsigned int type ;
};
#line 37 "../original/patch/openjpeg.c"
typedef struct opj_jp2_box opj_jp2_box_t;
#line 39 "../original/patch/openjpeg.c"
struct opj_jp2 {
   struct opj_cio *cio ;
   void *cinfo ;
};
#line 42 "../original/patch/openjpeg.c"
...
#line 44 "../original/patch/openjpeg.c"
...
{ 
  ...
  {
#line 45
  __cil_tmp3 = fopen((char const   *)"dummy.c", (char const   *)"rb");
#line 45
  fp = __cil_tmp3;
#line 46
  offset = 0;
#line 47
  read(fp, & offset, 4);
#line 48
  jp2->cio = (struct opj_cio *)malloc(sizeof(opj_cio_t ));
#line 49
  (jp2->cio)->bp = (unsigned char *)malloc((unsigned long )offset);
#line 50
...
#line 57 "../original/patch/openjpeg.c"
int opj_event_msg(void *cinfo , int event , char const   *fmt  , ...) 
{ 
...
#line 61 "../original/patch/openjpeg.c"
...
#line 72 "../original/patch/openjpeg.c"
...
#line 74
  if (box->length == 0U) {
#line 79
    box->length = (unsigned int )((cio->end - cio->bp) + 8L);
  }
#line 81
  return (0);
}
}
#line 84 "../original/patch/openjpeg.c"
...
#line 94 "../original/patch/openjpeg.c"
