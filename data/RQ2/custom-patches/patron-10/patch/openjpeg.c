...
struct opj_cp_t {
   unsigned int ppm_len ;
   unsigned char *ppm_data ;
};
#line 10 "../original/patch/openjpeg.c"
typedef struct opj_cp_t opj_cp_t;
#line 12 "../original/patch/openjpeg.c"
struct opj_j2k_t {
...
void init_source(unsigned char *header_data ) 
{ 
  FILE *file ;
  FILE *__cil_tmp3 ;
  ...
  {
#line 17
  __cil_tmp3 = fopen((char const   *)"test.txt", (char const   *)"r");
#line 17
  file = __cil_tmp3;
#line 18
  fread(header_data, (unsigned long )1, (unsigned long )100, file);
#line 19
  fclose(file);
  }
  return;
...
void opj_read_bytes(unsigned char *p_header_data , unsigned int *p_value , unsigned int p_size ) 
{ 
  unsigned int i ;
...
#line 25
    *p_value = (*p_value << 8) + (unsigned int )*(p_header_data + i);
#line 24
    i ++;
  }
...
int j2k_read_ppm_v3(opj_j2k_t *p_j2k , unsigned char *p_header_data ) 
{ 
  unsigned char *new_ppm_data ;
  opj_cp_t *l_cp ;
  unsigned int l_N_ppm ;
  void *__cil_tmp6 ;
  void *__cil_tmp7 ;
...
#line 32
  l_cp = & p_j2k->m_cp;
#line 33
  l_N_ppm = (unsigned int )0;
#line 35
  opj_read_bytes(p_header_data, & l_N_ppm, (unsigned int )4);
#line 36
  l_cp->ppm_len = l_N_ppm;
#line 37
  l_cp->ppm_data = (unsigned char *)calloc((unsigned long )1, (unsigned long )l_cp->ppm_len);
#line 39
  opj_read_bytes(p_header_data, & l_N_ppm, (unsigned int )4);
  }
#line 41
...
#line 44
  ...
  {
#line 46
  __cil_tmp7 = realloc(l_cp->ppm_data, (unsigned long )(l_cp->ppm_len + l_N_ppm));
#line 46
  new_ppm_data = (unsigned char *)__cil_tmp7;
  }
  return (0);
}
}
#line 50 "../original/patch/openjpeg.c"
...
{ 
  ...
  {
#line 52
  __cil_tmp5 = malloc(100UL * sizeof(unsigned char ));
#line 52
  header_data = __cil_tmp5;
#line 53
