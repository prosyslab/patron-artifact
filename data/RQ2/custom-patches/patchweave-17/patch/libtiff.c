...
#line 3 "../original/patch/libtiff.c"
struct BMPInfoHeader {
   unsigned int iWidth ;
   unsigned int iHeight ;
   unsigned int iBitCount ;
};
#line 7 "../original/patch/libtiff.c"
...
#line 10 "../original/patch/libtiff.c"
...
#line 19
  read(fd, & iShort, 2);
#line 20
  info_hdr.iWidth = (unsigned int )iShort;
#line 21
  width = info_hdr.iWidth;
#line 24
  size = width * info_hdr.iBitCount + 31U;
  }
#line 25
  if (! width) {
    {
    ...
    {
#line 28
    TIFFError(infilename, "Wrong image parameters; can\'t allocate space for scanline buffer");
    }
    }
    }
#line 31
...
#line 25
  if ((size - 31U) / info_hdr.iBitCount != width) {
    {
    {
    {
#line 28
...
#line 31
  ...
  {
#line 33
  size = (size & 4294967264U) / 8U;
#line 34
  __cil_tmp11 = malloc((unsigned long )size);
#line 34
  scanbuf = (char *)__cil_tmp11;
  }
  return (0);
}
}
